...
const BASE_JOBS = [
  { path: 'emprendimiento/proyecto/cuaderno/imprimir/alumno',   out: 'emprendimiento-cuaderno-alumno' },
  { path: 'emprendimiento/proyecto/cuaderno/imprimir/profesor', out: 'emprendimiento-cuaderno-profesor' },
];
const LOCALES = [
  { prefix: '', suffix: '' },
  { prefix: 'ca/', suffix: '.ca' },
