#!/usr/bin/env node
/**
 * Build the dual-edition «Cuaderno del equipo» PDFs for «De cero a empresa»
 ...
 * writes emprendimiento-cuaderno-alumno.pdf and …-profesor.pdf.
 *
 * Usage:
 *   node scripts/build-cuaderno-pdf.mjs            # copy to public/downloads/
 *   node scripts/build-cuaderno-pdf.mjs --in-dist  # only write to dist/downloads/
 */
...
const JOBS = [
  { path: 'emprendimiento/proyecto/cuaderno/imprimir/alumno',   out: 'emprendimiento-cuaderno-alumno.pdf' },
  { path: 'emprendimiento/proyecto/cuaderno/imprimir/profesor', out: 'emprendimiento-cuaderno-profesor.pdf' },
];
const PORT = 4337;
...
server.close();
console.log(`\n✓ Cuadernos (alumno + profesor) listos.`);
