...
const recursos = defineCollection({
  ...
  schema: z.object({
     ...
     */
    componente: z
      .enum(['PuntoMuerto', 'VANTIR', 'Ratios', 'ADASSimulator', 'InteresCompuesto', 'NominaESO', 'Presupuesto503020', 'BuscadorItinerarios', 'GeneradorCVEuropass', 'DCF', 'RatiosBenchmark', 'Elasticidad', 'MultiplicadorGasto', 'IRPFDeclaracion', 'CocheVsAlternativa', 'RIASEC', 'PresupuestoUni', 'Productividad', 'EquilibrioMercado', 'DAFO', 'CanvasBM', 'BCG', 'TasasEPA', 'MatrizDecision', 'FPP', 'Externalidad', 'MultiplicadorBancario', 'VentajaComparativa'])
      .optional(),
