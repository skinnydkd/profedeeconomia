...
title: "Informe de prospectiva: el futuro de tu sector y sus yacimientos de empleo"
descripcion: "Proyecto en dos sesiones en el que cada equipo elabora un informe de prospectiva ocupacional de la familia profesional propia: radiografía actual del sector con datos del SEPE, identificación de tres yacimientos de empleo emergentes vinculados a la transición digital y ecológica, y una recomendación de posicionamiento profesional, presentado al grupo como una consultora."
tipo: proyecto
...
materiales:
  ...
  - "Plantilla de presentación (5 diapositivas máximo) o cartel A3"
  - "Rúbrica de evaluación impresa para profesor y coevaluación"
estado: publicado
---
...
4. **Redacción del informe y la recomendación (25 min).** Montan el informe siguiendo el guion y formulan una recomendación de posicionamiento: qué competencias debería reforzar quien sale ahora del ciclo para situarse en los yacimientos detectados.
5. **Presentaciones (25 min, ~5 min por equipo).** Cada consultora presenta su informe. El resto actúa como cliente y plantea una pregunta crítica.
6. **Cierre (5 min).** El profesor sintetiza los yacimientos coincidentes entre equipos y los contrasta con datos reales del SEPE.

## Guion del informe de prospectiva (fotocopiable)

```
═══════════════════════════════════════════════
   INFORME DE PROSPECTIVA · Sector: __________
...
| --- | --- | --- |
| Datos reales y citados | Usa fuentes oficiales y las referencia correctamente | 25 % |
| Lectura del sector | Interpreta los datos, no solo los copia | 20 % |
| Yacimientos emergentes | Identifica tres yacimientos verosímiles y justificados | 25 % |
| Recomendación | Propone un posicionamiento coherente con el análisis | 15 % |
| Comunicación | Presenta con claridad y responde a la pregunta del cliente | 15 % |
