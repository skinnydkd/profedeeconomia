...
title: "Mi inventario RIASEC y mi mapa de competencias con evidencias"
descripcion: "Dinámica de autoconocimiento profesional en la que cada alumno determina su perfil RIASEC de Holland, elabora un inventario de competencias técnicas y transversales respaldadas por evidencias concretas, y lo contrasta con un compañero para detectar puntos ciegos."
tipo: dinamica
...
materiales:
  ...
  - "Bolígrafos de dos colores (uno para uno mismo, otro para el contraste)"
  - "Cronómetro visible"
estado: publicado
---
...
```
═══════════════════════════════════════════════
   MI INVENTARIO RIASEC + COMPETENCIAS
═══════════════════════════════════════════════
...
| --- | --- | --- |
| Código RIASEC bien obtenido | Calcula su código y lo traduce a familias profesionales coherentes | 20 % |
| Evidencias reales | Cada competencia anotada tiene una evidencia concreta y verificable, no genérica | 35 % |
| Distinción de conceptos | No confunde interés con competencia ni aptitud con actitud | 15 % |
| Motivación y ancla | Identifica con honestidad qué le mueve y su ancla provisional | 15 % |
| Calidad del contraste | Aporta una observación útil al compañero y acepta una sobre sí mismo | 15 % |
