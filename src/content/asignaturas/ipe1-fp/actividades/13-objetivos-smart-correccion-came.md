...
title: "Repara estos objetivos: del deseo vago al objetivo SMART y a la estrategia CAME"
descripcion: "Ejercicio práctico en parejas para diagnosticar por qué fallan una serie de objetivos profesionales mal formulados, reescribirlos con criterios SMART y conectarlos con la estrategia CAME correcta a partir de un DAFO dado. Entrena la formulación rigurosa de metas, una de las debilidades más frecuentes al planificar la inserción."
tipo: ejercicio
...
materiales:
  ...
  - "Plantilla de reescritura SMART + CAME (incluida abajo)"
...
| --- | --- | --- |
| Diagnóstico SMART | Identifica con precisión qué criterio falla en cada caso | 25 % |
| Reescritura | Los objetivos reescritos cumplen los cinco criterios y son realistas | 35 % |
| Conexión con CAME | Asigna correctamente la estrategia según el DAFO | 25 % |
| Clasificación por plazo | Ordena bien corto, medio y largo plazo | 15 % |
