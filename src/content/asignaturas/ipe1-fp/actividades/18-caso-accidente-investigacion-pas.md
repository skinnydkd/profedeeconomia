...
title: "Caso: investiga el accidente y aplica el protocolo PAS"
descripcion: "Estudio de caso en grupos pequeños sobre un accidente laboral real (descrito y anonimizado). El alumnado reconstruye la cadena de fallos preventivos, distingue accidente de trabajo de enfermedad profesional, propone medidas según la jerarquía protección colectiva-individual y ordena correctamente el protocolo PAS de primeros auxilios ante la emergencia."
tipo: caso
...
materiales:
  ...
  - "Plantilla de informe de investigación (incluida abajo)"
  - "Tarjetas desordenadas de los pasos de actuación ante la emergencia (incluidas abajo)"
estado: publicado
---
...
| --- | --- | --- |
| Detección de factores de riesgo | Identifica los fallos materiales, organizativos y de formación | 25 % |
| Cadena causal | Reconstruye el orden de los fallos con lógica | 20 % |
| Clasificación del daño | Distingue accidente de enfermedad profesional con criterio | 10 % |
| Medidas preventivas | Propone medidas y respeta la jerarquía colectiva > individual | 25 % |
| Protocolo PAS | Ordena bien la actuación y detecta el error de socorro | 20 % |
