...
title: "Descifra una nómina real: del bruto al neto, línea por línea"
descripcion: "Ejercicio práctico en parejas para leer una nómina oficial completa, identificar cada partícula (devengos y deducciones), calcular el paso de salario bruto a neto, comprobar las cotizaciones a la Seguridad Social y la retención de IRPF, y comparar el contrato ofrecido con la jerarquía normativa ley-convenio-contrato."
tipo: ejercicio
...
| --- | --- | --- |
| Identificación de contrato y relación | Reconoce la modalidad, valida el periodo de prueba y la jerarquía normativa aplicable | 20 % |
| Separación devengos / deducciones | Clasifica correctamente cada línea de la nómina | 20 % |
| Cálculo bruto a neto | Calcula el líquido a percibir correctamente | 25 % |
| Comprobación de cotizaciones e IRPF | Verifica que los tipos aplicados son los vigentes | 20 % |
| Detección del error en la nómina B | Encuentra y explica el error (tipo de desempleo y paga extra) | 15 % |
