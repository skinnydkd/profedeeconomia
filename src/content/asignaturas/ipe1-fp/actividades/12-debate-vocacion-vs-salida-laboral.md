...
title: "Debate: ¿elegir por vocación o por salida laboral? Motivación e identidad profesional"
descripcion: "Debate estructurado sobre el dilema entre elegir una profesión por motivación intrínseca (vocación, valores, intereses) o por motivación extrínseca (salario y empleabilidad). A partir de casos reales, los equipos defienden posturas con el modelo RIASEC y los conceptos de valores laborales y ancla de carrera, y cierran matizando un falso dilema."
tipo: debate
...
materiales:
  ...
  - "Resumen del modelo RIASEC, motivación intrínseca/extrínseca y anclas de carrera proyectado"
  - "Pizarra para las conclusiones finales"
estado: publicado
---
...
═══════════════════════════════════════════════
 Argumento TÉCNICO (RIASEC / motivación / ancla):
   .........................................
...
| --- | --- | --- |
| Solidez de los argumentos | Usa RIASEC, los tipos de motivación y las anclas, no solo opiniones | 30 % |
| Realismo de empleabilidad | Incorpora datos del mercado a la postura | 20 % |
| Escucha y réplica | Responde al rival con criterio, sin descalificar | 20 % |
| Manejo conceptual | Aplica bien motivación intrínseca/extrínseca y valores laborales | 15 % |
| Aportación a la conclusión | Contribuye a superar el falso dilema con una idea clara | 15 % |
