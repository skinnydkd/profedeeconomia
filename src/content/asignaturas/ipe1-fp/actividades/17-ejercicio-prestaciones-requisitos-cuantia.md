...
title: "Ejercicio: ¿tengo derecho y cuánto cobro? Prestaciones e indemnizaciones paso a paso"
descripcion: "Ejercicio de cálculo en parejas sobre el sistema de Seguridad Social. A partir de varios supuestos, el alumnado comprueba si cada persona reúne los requisitos para una prestación (desempleo, incapacidad temporal), estima su duración y cuantía, y calcula la indemnización que corresponde según el tipo de extinción del contrato."
tipo: ejercicio
...
| --- | --- | --- |
| Comprobación de requisitos | Decide bien si hay derecho y por qué | 25 % |
| Duración y cuantía del paro | Aplica la tabla y calcula correctamente | 25 % |
| Incapacidad temporal | Valida requisitos y tramos de pago | 20 % |
| Cálculo de indemnización | Clasifica el despido y calcula los días por año | 30 % |
