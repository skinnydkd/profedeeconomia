...
title: "Caso: ¿firmo o no firmo? Detecta las trampas de cuatro ofertas de contrato"
descripcion: "Estudio de caso en grupos pequeños sobre cuatro ofertas de empleo y contratos con cláusulas problemáticas: falso autónomo, periodo de prueba abusivo, contrato temporal en fraude de ley y salario por debajo de convenio. El alumnado actúa como asesor laboral, detecta la irregularidad de cada oferta, la justifica con la norma y recomienda qué hacer."
tipo: caso
...
materiales:
  ...
  - "Plantilla de dictamen del asesor (incluida abajo)"
  - "Acceso a internet para consultar el SMI y modalidades vigentes (opcional)"
estado: publicado
---
...
| --- | --- | --- |
| Detección de la trampa | Identifica correctamente la irregularidad de cada oferta | 30 % |
| Fundamento normativo | Cita la norma o principio que se incumple | 30 % |
| Análisis del riesgo | Explica qué pierde el trabajador si firma | 20 % |
| Recomendación | Propone una salida realista y razonada | 20 % |
