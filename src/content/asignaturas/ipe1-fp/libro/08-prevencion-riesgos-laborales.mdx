...
- 🛠️ **Reglamento de los Servicios de Prevención (RD 39/1997) y Anexo IV** — *BOE* ([boe.es/eli/es/rd/1997/01/17/39](https://www.boe.es/eli/es/rd/1997/01/17/39)). Por qué encaja: define el programa formativo del nivel básico y las modalidades de organización preventiva.
- ❤️ **Guía de primeros auxilios y RCP** — *Consejo Español de RCP / Cruz Roja* ([cruzroja.es](https://www.cruzroja.es)). Por qué encaja: explica el protocolo PAS y el soporte vital básico con material divulgativo fiable.
