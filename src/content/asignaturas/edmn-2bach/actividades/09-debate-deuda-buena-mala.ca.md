...
lang: ca
estado: publicado
slug: "asignaturas/edmn-2bach/actividades/09-debate-deuda-buena-mala.ca"
---
...
1. **Assignació d'equips (5 min).** Dos equips a l'atzar: **Pro-palanquejament** i **Pro-autofinançament**.
2. **Preparació (15 min).** Cada equip busca tres arguments, un exemple real i prepara la refutació de l'argument més fort del rival.
3. **Debat (25 min).** Obertura (3 min) → rèpliques (2 min) → preguntes creuades (8 min) → conclusió (2 min).
4. **Vot i tancament (5 min).** El jurat vota; cada alumne escriu en quina situació seria prudent endeutar-se i en quina no.
...
> 1. Cada argument es vincula a una situació concreta (tipus, estabilitat de vendes, sector).
