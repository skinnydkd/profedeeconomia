...
title: "Política de precios: elasticidad y decisión de rebajar o subir"
descripcion: "Ejercicio de cálculo de la elasticidad-precio de la demanda a partir de datos de ventas y decisión razonada sobre la política de precios óptima."
tipo: ejercicio
...
1. **Cálculo individual (25 min).** Cada alumno calcula:
...
3. **Discusión guiada (10 min).** El profesor pregunta: si el objetivo fuera maximizar *beneficio* en vez de ingresos, ¿cambiaría la respuesta? ¿Qué dato faltaría (los costes)?
