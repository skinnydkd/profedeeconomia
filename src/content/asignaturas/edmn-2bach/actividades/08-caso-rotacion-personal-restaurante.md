...
title: "Caso: por qué se va la gente — la rotación en una cadena de restaurantes"
descripcion: "Caso de análisis de la alta rotación de personal en hostelería: calcular el coste de rotación y proponer un plan de retención basado en la motivación."
tipo: caso
...
| --- | --- | --- |
| Cálculo de rotación y coste | Las tres cifras correctas | 30 % |
| Diagnóstico motivacional | Aplica Maslow/Herzberg correctamente | 25 % |
| Plan de retención | Medidas concretas y priorizadas | 30 % |
