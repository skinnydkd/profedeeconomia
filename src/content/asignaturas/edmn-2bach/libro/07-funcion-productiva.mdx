...
- tipo: concept
  eyebrow: El caso
  title: Las mismas máquinas, la mitad de esfuerzo
  body: "A finales de los años setenta, los fabricantes estadounidenses descubrieron que Toyota producía coches con menos del 50 % del esfuerzo humano, un tercio del espacio, una sexta parte del inventario y la mitad de defectos por vehículo. Las fábricas eran comparables y la tecnología, similar. La diferencia estaba en cómo se organizaba el trabajo: el TPS, bautizado en Occidente como Lean en 1990."
...
- tipo: section
  ...
  subtitle: Tres palabras que se usan como sinónimos y no lo son. Separarlas es lo que evita empresas absurdas por dentro.
- tipo: terms
...
- tipo: table
  ...
  caption: "CT = CF + CVu · Q. Al repartir los fijos entre más unidades el coste medio baja: son las economías de escala."
- tipo: section
...
- tipo: concept
  ...
  pull: "Margen de seguridad = (Demanda − Q*) / Demanda. Por debajo del 10 % el negocio es vulnerable; por encima del 30 %, razonablemente estable."
- tipo: diagram
...
- tipo: exercise
  ...
  enunciado: "Una textil compara dos plantas para fabricar mascarillas que vende a 0,50 € a las farmacias. Plan A, semiautomático: CF = 12.000 €/mes y CVu = 0,30 €. Plan B, automático: CF = 28.000 €/mes y CVu = 0,10 €. ¿Cuál es el punto muerto de cada plan y a partir de qué volumen mensual conviene cambiar al B?"
  pasos:
...
- tipo: list
  ...
  items:
    ...
    - "Fuera de la fábrica: el hospital Virginia Mason redujo un 50 % los errores médicos con metodología Lean."
- tipo: figure
  ...
  caption: "La vio en los mataderos de Chicago, que despiezaban reses en línea desde 1870. Ford invirtió la lógica: en vez de despiezar, ensamblar."
  credit: "Foto: Library of Congress, dominio público vía Wikimedia Commons"
- tipo: data
  numero: "18,5 %"
  label: de margen operativo (EBIT)
  title: "Lean aplicado a la moda: Inditex en 2025"
  detalle: "41.420 M€ de ventas y 7.643 M€ de EBIT, frente al 5-8 % que se considera bueno en el sector. De la idea al colgador pasan 2-3 semanas en las colecciones más reactivas, frente a los 6-9 meses del modelo tradicional."
- tipo: terms
...
- tipo: quiz
  ...
  correcta: 0
  explicacion: Produce mucho —es productiva— de algo que no se vende, así que no es eficaz. En Lean eso es sobreproducción, el peor muda porque arrastra a todos los demás.
- tipo: concept
  eyebrow: Vuelve al caso
  title: El TPS no fue una técnica, fue una cultura
  body: "Toyota tardó tres décadas (1948-1980) y una cadena de ingenieros —Toyoda, Ohno, Shingo— que observaban el flujo del trabajo cada día y eliminaban un desperdicio cada vez. Lo que en otras fábricas eran incidentes a olvidar, allí eran datos a investigar. Por eso el sistema no se compra: se construye deteniéndose a preguntar por qué algo va lento."
  pull: "Dibuja el flujo de tu actividad antes de empezar: la empresa que se ahoga en complejidad operativa empieza a hacerlo el día de su fundación."
```
