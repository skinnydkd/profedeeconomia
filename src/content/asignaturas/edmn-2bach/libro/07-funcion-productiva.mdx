...
- tipo: concept
  title: "Q* = CF / (P − CVu)"
  body: "El denominador P − CVu es el margen de contribución unitario: lo que cada unidad aporta para cubrir los costes fijos. Una panadería con CF = 3.000 €/mes que vende la barra a 1,50 € con un CVu de 0,50 € tiene un margen de 1 € y un punto muerto de 3.000 barras al mes. Desde la barra 3.001, cada venta es beneficio."
  pull: "Margen de seguridad (%) = (Demanda − Q*) / Demanda × 100. Por debajo del 10 % el negocio es vulnerable; por encima del 30 %, estable."
- tipo: diagram
