...
<Diagram caption="Las cinco actividades primarias por las que pasa el producto y las cuatro de apoyo que las atraviesan. El margen no es una actividad más: es lo que queda cuando el valor creado supera lo que cuestan todas ellas.">
  <CadenaValor />
</Diagram>
...
<RecursoDestacado href="/edmn-2bach/recursos/calculadora-punto-muerto/" kicker="Herramienta" title="Calculadora de punto muerto" descripcion="Costes fijos, precio y coste variable unitario, y a la salida el umbral de rentabilidad, el margen de seguridad y el beneficio previsto." colorVar="--color-edmn" />
...
<VocesDesacuerdo
  tema="Justo a tiempo o colchón de existencias"
  postura_a={{
    etiqueta: 'Producir justo a tiempo',
    tesis: 'El stock es dinero parado que además esconde los problemas: si hay piezas de sobra, nadie arregla la avería que las consume. Reducir inventario obliga a que el proceso funcione de verdad.',
  }}
  postura_b={{
    etiqueta: 'Mantener un colchón',
    tesis: 'Una cadena sin holgura se rompe entera cuando falla un eslabón. El stock cuesta dinero, sí, pero es un seguro: el ahorro de años se pierde en una sola semana de parada.',
  }}
>
Durante treinta años ganó la primera postura sin discusión. Las interrupciones de suministro de la década de 2020 —pandemia, el bloqueo del canal de Suez, la escasez de semiconductores— devolvieron la segunda al debate, y muchas empresas han pasado del *just in time* puro al *just in case* para las piezas críticas. **La síntesis que se está imponiendo no es volver al almacén lleno, sino distinguir**: inventario mínimo en lo que se repone rápido y hay varios proveedores, colchón deliberado en lo que tiene un único origen o un plazo largo.
</VocesDesacuerdo>
...
- tipo: diagram
  ...
  caption: "Dónde se añade valor, actividad por actividad"
- tipo: section
