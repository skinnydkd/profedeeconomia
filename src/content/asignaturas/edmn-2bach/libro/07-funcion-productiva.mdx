...
Esta unidad es la más numérica del libro hasta ahora. El **punto muerto** y los **costes** son herramientas que el alumnado utilizará después en el plan financiero (Unidad 9) y en el análisis de viabilidad de un plan de empresa (Unidad 12). Conviene asegurar bien los conceptos antes de avanzar.
...
- tipo: concept
  ...
  pull: "Dibuja el proceso antes de tener el problema: el desperdicio se elimina observando el flujo, no comprando un sistema."
- tipo: recap
  eyebrow: "Repasa"
