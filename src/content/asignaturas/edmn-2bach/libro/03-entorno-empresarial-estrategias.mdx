...
- tipo: curriculum
  ...
  saberes:
    - "Bloque A: entorno general y específico de la empresa."
    - "Bloque A: estrategia competitiva."
  competencias:
    - "Analizar el entorno de la empresa y su influencia en las decisiones y la estrategia."
- tipo: section
  title: "El entorno empresarial: dos capas"
  subtitle: "Lo que la empresa puede negociar y lo que solo puede leer. Quien descuida la capa lejana pierde el negocio en cinco o diez años."
- tipo: split
  title: Dos capas, dos herramientas de análisis
  left:
    h: Microentorno o entorno específico
    items:
      - Clientes, proveedores, competidores, intermediarios y productos sustitutivos
      - Interacción directa y frecuente con la empresa
      - "La empresa puede actuar: negociar, fidelizar, integrar verticalmente"
      - Se analiza con las cinco fuerzas de Porter
  right:
    h: Macroentorno o entorno general
    items:
      - "Fuerzas amplias: economía, demografía, leyes, cultura, tecnología, ecología"
      - Afecta a todas las empresas del territorio o del sector
      - La empresa, individualmente, no puede influir en ellas
      - Solo cabe observar y anticipar; se analiza con PESTEL
- tipo: section
  title: "El microentorno: las cinco fuerzas de Porter"
  subtitle: Harvard Business Review rechazó dos veces el artículo en 1978. Hoy es el más reimpreso de la revista.
- tipo: figure
  src: edmn-2bach/03/porter-portrait.jpg
  alt: Retrato de Michael Porter, profesor de la Harvard Business School, durante una intervención pública.
  title: Michael Porter
  caption: Autor de las cinco fuerzas (1979) y de las estrategias genéricas (1980), los dos marcos de esta unidad.
  credit: "Foto: World Economic Forum, CC BY-SA 2.0 vía Wikimedia Commons"
- tipo: diagram
  diagrama: PorterForces
  caption: La rivalidad del sector, en el centro, es el resultado de la presión combinada de las otras cuatro fuerzas.
- tipo: split
  title: Las dos fuerzas de negociación
  left:
    h: Los clientes tienen poder cuando
    items:
      - Son pocos y compran mucho volumen, como Apple ante su proveedor de chips
      - El producto está estandarizado y es fácil de comparar
      - "El coste de cambio es bajo: cambiar de gasolinera no cuesta nada"
      - Pueden integrar hacia atrás y fabricar ellos lo que compran
  right:
    h: Los proveedores tienen poder cuando
    items:
      - "Son pocos y no hay alternativa real: ASML en litografía, Microsoft en ofimática"
      - Su producto es diferenciado y crítico para el comprador
      - Cambiar de ERP cuesta meses de migración y reentrenamiento
      - Pueden integrarse hacia delante y vender al cliente final
- tipo: split
  title: "Las dos amenazas: entrantes y sustitutivos"
  left:
    h: Barreras de entrada
    items:
      - "Capital: montar software es barato; una refinería, miles de millones"
      - "Regulación: licencias y homologaciones de años en banca, farmacia o telecomunicaciones"
      - "Marca: Coca-Cola domina refrescos aunque la receta no sea secreta"
      - Acceso a canales, economías de escala y curva de experiencia del incumbente
      - "La sexta fuerza, los complementos (Brandenburger y Nalebuff): un móvil nuevo necesita miles de apps"
  right:
    h: Amenaza de sustitutivos
    items:
      - "Vienen de otro sector: la videoconferencia desinfló el viaje de negocios"
      - Blockbuster vigilaba a otros videoclubes y no vio llegar a Netflix
      - El móvil sustituyó al reloj, la cámara, la agenda, el GPS y el despertador
      - "Piensa en funciones, no en objetos: nadie contrata un coche, contrata desplazarse"
- tipo: list
  title: Qué intensifica la rivalidad entre competidores
  items:
    - "Muchos competidores parecidos y equilibrados: guerra de precios"
    - Sector maduro o en declive, donde lo que gana uno lo pierde otro
    - "Costes fijos altos que obligan a vender a cualquier precio: aerolíneas, hoteles"
    - Producto indiferenciado, sin marca ni experiencia que defender
    - "Barreras de salida altas: las empresas resisten en el sector más allá de lo razonable"
- tipo: section
  title: "El macroentorno: el análisis PESTEL"
  subtitle: "Aguilar, 1967. Si listas cuarenta factores no has analizado, has inventariado: prioriza de tres a cinco críticos."
- tipo: diagram
  diagrama: PESTELHexagon
  caption: Seis dimensiones del macroentorno que la empresa observa y anticipa, pero no controla.
- tipo: list
  title: Las seis dimensiones del PESTEL
  items:
    - "P — Político: fiscalidad, aranceles y estabilidad regulatoria. El Brexit costó a las exportadoras españolas miles de millones."
    - "E — Económico: ciclo, inflación, tipos y tipo de cambio. La inflación española de 2022, del 8,4 %, fue la mayor desde 1985."
    - "S — Social: envejecimiento, urbanización, dietas y trabajo flexible. En 2025 teletrabaja el 14,8 % de los ocupados (EPA)."
    - "T — Tecnológico: IA generativa, renovables, vehículo eléctrico, biotecnología y robotización industrial."
    - "E — Ecológico: eventos extremos como la DANA de 2024, huella de carbono, escasez hídrica y derechos de emisión."
    - "L — Legal: derecho laboral, RGPD, normativa sectorial y una fiscalidad cambiante en Sociedades, IVA y tasas digitales."
- tipo: figure
  src: edmn-2bach/03/banco-espana.jpg
  alt: Fachada histórica del edificio principal del Banco de España en la Plaza de Cibeles, Madrid.
  title: La P y la L del PESTEL, en un edificio
  caption: "Banca, fiscalidad, derecho laboral, protección de datos: nadie los cambia solo, pero todos deben anticiparlos."
  credit: "Foto: Fer.filol, dominio público vía Wikimedia Commons"
- tipo: data
  numero: "+40 %"
  label: tráfico de datos en una semana
  title: El PESTEL de Movistar, marzo de 2020
  detalle: "Las telecomunicaciones pasaron a servicio esencial y se prohibieron los cortes por impago. La fibra dejó de ser un premium: Telefónica amplió la capacidad de red sin cargo y vendió paquetes de teletrabajo impensables en 2019."
- tipo: figure
  src: edmn-2bach/03/parque-eolico-cadiz.jpg
  alt: Aerogeneradores del parque eólico Los Almeriques en Medina-Sidonia, Cádiz, vistos desde un campo cercano.
  title: Cuando dos dimensiones del PESTEL se cruzan
  caption: La transición energética cruza lo tecnológico y lo ecológico, y ha reescrito en pocos años qué sectores son rentables.
  credit: "Foto: Emilio J. Rodríguez Posada, CC BY-SA 3.0 vía Wikimedia Commons"
- tipo: section
  title: Responsabilidad social corporativa, ODS e inclusión
  subtitle: "De «la única responsabilidad social es aumentar los beneficios» (Friedman, 1970) a la triple cuenta de Elkington (1994)."
- tipo: concept
  eyebrow: Caso real
  title: Patagonia, la empresa que se regaló al planeta
  body: "En septiembre de 2022 Yvon Chouinard transfirió el 100 % de Patagonia —3.000 M$— a dos vehículos: un trust que conserva los derechos de voto y vela por la misión ambiental, y una fundación que recibe los beneficios, unos 100 M$ al año, para financiar la lucha climática. Vista desde el marco de la unidad no es altruismo, sino lectura estratégica de un entorno legal, social y ambiental que premia esa coherencia."
  pull: "«La Tierra es ahora nuestro único accionista», escribió Chouinard al anunciarlo."
- tipo: figure
  src: edmn-2bach/03/patagonia-hq.jpg
  alt: Edificio bajo de la sede central de Patagonia en Ventura, California, rodeado de palmeras.
  title: Sede de Patagonia en Ventura, California
  caption: "En 2022 Chouinard transfirió el 100 % de las acciones a una fundación ambiental: RSC metida en la propia propiedad."
  credit: "Foto: Nicolás Boullosa, CC BY 2.0 vía Wikimedia Commons"
- tipo: terms
  title: Los tres pilares de la RSC, y cómo los miden los inversores
  terms:
    - t: Económico
      d: Cumplir con Hacienda sin recurrir a paraísos fiscales, pagar a proveedores en plazo (Ley 15/2010), reinvertir en el territorio y ser transparente.
    - t: Social
      d: "Condiciones dignas, formación y no discriminación. Plan de igualdad obligatorio desde 50 trabajadores; registro retributivo por sexo, en todas."
    - t: Ambiental
      d: "Medir la huella de carbono, reducir emisiones, gestionar residuos y diseñar pensando en el ciclo de vida completo: economía circular."
    - t: ESG
      d: Marco con el que los inversores institucionales evalúan a la empresa. Una mala nota encarece la financiación entre 30 y 100 puntos básicos.
- tipo: concept
  title: Los ODS dan estructura; el greenwashing la vacía
  body: "En 2015 la ONU aprobó la Agenda 2030 y sus 17 Objetivos de Desarrollo Sostenible. En la empresa pesan sobre todo el 5 (igualdad), el 8 (trabajo decente), el 9 (innovación), el 12 (consumo responsable) y el 13 (clima): nadie cubre los 17, solo aquellos donde su actividad más impacta. El greenwashing hace justo lo contrario: exagera lo marginal e ignora lo principal."
  pull: Una RSC seria se reconoce por métricas verificables y auditadas, no por campañas en redes.
- tipo: section
  title: El análisis DAFO
  subtitle: Albert Humphrey, Stanford Research Institute, años sesenta. La matriz que integra lo externo con lo interno.
- tipo: diagram
  diagrama: DAFOGrid
  caption: "Dos ejes —interno frente a externo, positivo frente a negativo— y, debajo, los cuatro cruces que salen de combinar las casillas."
- tipo: concept
  eyebrow: En la EBAU
  title: "Interno o externo: la regla de bolsillo"
  body: "Es la distinción que más se confunde y la que el examen pide con regularidad. Interno es lo que la empresa cambia con sus decisiones: formar al equipo, cerrar una línea, subir precios. Externo es lo que solo puede leer y anticipar: inflación, regulación, competencia, demografía. La inflación nunca es debilidad, es amenaza; un equipo desactualizado nunca es amenaza, es debilidad."
  pull: "¿Puede el director general arreglarlo con su firma? Si sí, es interno; si no, es externo."
- tipo: exercise
  title: DAFO de una librería de barrio frente al e-commerce
  enunciado: "Una librería de barrio compite con los grandes marketplaces. Construye su DAFO con un elemento por casilla y deriva dos cruces estratégicos: uno ofensivo y uno de supervivencia."
  pasos:
    - "Fortaleza: un equipo que conoce el catálogo y sabe recomendar."
    - "Debilidad: precios menos competitivos que los grandes marketplaces."
    - "Oportunidad: sensibilidad social creciente hacia el comercio local."
    - "Amenaza: gigantes del e-commerce con descuentos agresivos."
    - "Cruce FO: convertir la recomendación humana en servicio —clubs de lectura, eventos con autores—."
    - "Cruce DA: reducir stock muerto y especializarse en nichos donde el algoritmo recomienda mal."
- tipo: quiz
  eyebrow: En la EBAU
  pregunta: "«La inflación ha subido tres puntos y encarece nuestras materias primas.» ¿En qué casilla del DAFO entra?"
  opciones:
    - Debilidad, porque reduce el margen de la empresa
    - Amenaza, porque es externa y la empresa no la controla
    - Fortaleza, si la empresa puede subir precios
    - Oportunidad, porque obliga a revisar costes
  correcta: "1"
  explicacion: "La empresa no puede cambiar la inflación con sus decisiones: es externa y negativa, es decir, una amenaza. Colocarla como debilidad es uno de los errores más penalizados."
- tipo: section
  title: Estrategias empresariales clásicas
  subtitle: "Ansoff (1957) responde hacia dónde crecer; Porter (1980), cómo construir la ventaja. Son marcos complementarios."
- tipo: diagram
  diagrama: AnsoffMatrix
  caption: "El riesgo crece de izquierda a derecha y de arriba abajo: penetrar es lo seguro, diversificar la apuesta mayor."
- tipo: list
  title: La misma panadería en los cuatro cuadrantes
  ordered: true
  items:
    - "Penetración: abre también de noche para vender más pan en el mismo barrio."
    - "Desarrollo de producto: empieza a vender bocadillos preparados a sus clientes de siempre."
    - "Desarrollo de mercado: distribuye el pan que ya hace a tiendas de otros barrios."
    - "Diversificación: monta un negocio de catering para empresas, con producto y clientes nuevos."
- tipo: table
  title: Las tres estrategias genéricas de Porter
  head:
    - Estrategia
  ...
  rows:
    - - Liderazgo en costes
      - Estructura de costes más eficiente, precio menor
      - Mercadona, Ryanair, IKEA
    - - Diferenciación
      - Producto percibido como único; precio premium
      - Apple, Hermès, El Bulli
    - - Enfoque o nicho
      - Dominar un segmento estrecho, con coste bajo o diferenciación
      - Camper, Decathlon, Roomba
  caption: "Porter avisa contra quedarse atrapado en el medio: quien no destaca ni por coste ni por diferencia pierde cuota."
- tipo: quiz
  pregunta: Mercadona empieza a vender en Portugal en 2019 los mismos productos que ya vende en España. ¿Qué estrategia de Ansoff aplica?
  opciones:
    ...
    - Diversificación
  correcta: "2"
  explicacion: "El producto es el mismo y el mercado es nuevo: desarrollo de mercado. Sería diversificación solo si además vendiera un producto que hoy no tiene."
- tipo: concept
  eyebrow: Del libro al proyecto
  title: Cuatro documentos antes de entrar en el modelo de negocio
  body: "La unidad se entrega en cuatro piezas aplicadas al sector del proyecto: un PESTEL con tres factores críticos y su indicador de seguimiento, las cinco fuerzas valoradas como alta, media o baja con un argumento, un DAFO de tres elementos por casilla con dos cruces y la estrategia inicial situada en un cuadrante de Ansoff. Cada apartado se acota al sector y al momento concretos: las plantillas genéricas no cuentan."
  pull: "Etapa 3: los cuatro documentos son el punto de partida del modelo de negocio de la Unidad 4."
- tipo: recap
  eyebrow: "Repasa"
  title: "Antes de cerrar la unidad"
  items:
    - "Sabrías separar microentorno de macroentorno y nombrar los actores de cada uno."
    - "Sabrías aplicar un PESTEL a un caso real y sacar oportunidades y amenazas."
    - "Sabrías explicar la responsabilidad social corporativa y enlazarla con los ODS."
    - "Sabrías construir una matriz DAFO para un proyecto empresarial concreto."
    - "Sabrías distinguir las cuatro estrategias de Ansoff y decir cuál encaja en cada situación."
```
