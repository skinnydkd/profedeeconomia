...
1. **Resumen ejecutivo** — la versión escrita del elevator pitch (1-2 páginas máximo).
2. **Idea de negocio y propuesta de valor** — qué se hace, para quién, por qué es diferente.
3. **Equipo promotor** — quiénes están detrás, con qué experiencia y reparto de responsabilidades.
4. **Análisis del entorno** — PESTEL, fuerzas de Porter, DAFO.
5. **Estudio de mercado** — TAM/SAM/SOM, segmentos prioritarios.
6. **Plan de marketing** — marketing mix, canales, estrategia de captación.
7. **Plan de operaciones** — proceso productivo, recursos clave, organización.
8. **Plan de recursos humanos** — estructura, contratación, costes laborales.
9. **Plan económico-financiero** — inversión inicial, plan de financiación, balances y cuentas de resultados previsionales a 3 años, ratios, VAN, TIR.
10. **Análisis de escenarios y plan de contingencia** — qué hacer si las cosas no salen como esperamos.
