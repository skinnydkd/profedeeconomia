...
<CasoDilema
  titular="Nespresso va abaixar el preu de les seues càpsules i la facturació va caure un 8 %"
  fuente="Adaptado de análisis sectoriales · principios 2024"
  pregunta="Per què una rebaixa del 15 % pot reduir els ingressos en compte d'augmentar-los?"
>
A principis de 2024, Nespresso va experimentar amb una rebaixa del 15 % en les seues càpsules clàssiques per a frenar la competència de les marques blanques dels grans supermercats (Lidl, Carrefour, Mercadona). La hipòtesi era ampliar el segment atraent consumidors sensibles al preu. El resultat va ser el contrari: els ingressos van caure un 8 % el primer trimestre i la percepció de marca premium es va deteriorar en els estudis de mercat posteriors.
</CasoDilema>
...
<VuelveAlCaso referencia="Nespresso i la rebaixa del 15 %">
La rebaixa va desestabilitzar el **posicionament premium** que justificava el sobrecost sobre les marques blanques. El preu no era només un cost per al consumidor: era un **senyal** —de qualitat, exclusivitat i pertinença a un determinat segment— alineat amb la proposta de valor de Nespresso.

En trencar eixe senyal, Nespresso va perdre els seus clients premium sense atraure prou clients nous del segment sensible al preu: eixe segment ja comprava marca blanca a 0,15 €/càpsula i no estava disposat a pagar 0,35 € encara que fora més barat que els 0,42 € anteriors. La lliçó operativa: una baixada de preu **no és un moviment neutre**, és un canvi de segmentació disfressat de promoció. La coherència del mix —producte premium, preu premium, canal selectiu, comunicació d'exclusivitat— es va trencar en tocar només una variable.
</VuelveAlCaso>
