...
- tipo: curriculum
  ...
  saberes:
    - "Bloc A: entorn general i específic de l'empresa."
    - "Bloc A: estratègia competitiva."
  competencias:
    - "Analitzar l'entorn de l'empresa i la seua influència en les decisions i l'estratègia."
- tipo: section
  title: "L'entorn empresarial: dos capes"
  subtitle: "El que l'empresa pot negociar i el que només pot llegir. Qui descura la capa llunyana perd el negoci en cinc o deu anys."
- tipo: split
  title: Dos capes, dos ferramentes d'anàlisi
  left:
    h: Microentorn o entorn específic
    items:
      - Clients, proveïdors, competidors, intermediaris i productes substitutius
      - Interacció directa i freqüent amb l'empresa
      - "L'empresa pot actuar: negociar, fidelitzar, integrar verticalment"
      - S'analitza amb les cinc forces de Porter
  right:
    h: Macroentorn o entorn general
    items:
      - "Forces àmplies: economia, demografia, lleis, cultura, tecnologia, ecologia"
      - Afecta totes les empreses del territori o del sector
      - L'empresa, individualment, no hi pot influir
      - Només cal observar i anticipar; s'analitza amb PESTEL
- tipo: section
  title: "El microentorn: les cinc forces de Porter"
  subtitle: Harvard Business Review va rebutjar dos vegades l'article el 1978. Hui és el més reimprés de la revista.
- tipo: figure
  src: edmn-2bach/03/porter-portrait.jpg
  alt: Retrat de Michael Porter, professor de la Harvard Business School, durant una intervenció pública.
  title: Michael Porter
  caption: Autor de les cinc forces (1979) i de les estratègies genèriques (1980), els dos marcs d'esta unitat.
  credit: "Foto: World Economic Forum, CC BY-SA 2.0 via Wikimedia Commons"
- tipo: diagram
  diagrama: PorterForces
  caption: La rivalitat del sector, al centre, és el resultat de la pressió combinada de les altres quatre forces.
- tipo: split
  title: Les dos forces de negociació
  left:
    h: Els clients tenen poder quan
    items:
      - Són pocs i compren molt de volum, com Apple davant del seu proveïdor de xips
      - El producte està estandarditzat i és fàcil de comparar
      - "El cost de canvi és baix: canviar de gasolinera no costa res"
      - Poden integrar cap arrere i fabricar ells el que compren
  right:
    h: Els proveïdors tenen poder quan
    items:
      - "Són pocs i no hi ha alternativa real: ASML en litografia, Microsoft en ofimàtica"
      - El seu producte és diferenciat i crític per al comprador
      - Canviar d'ERP costa mesos de migració i reentrenament
      - Poden integrar-se cap avant i vendre al client final
- tipo: split
  title: "Les dos amenaces: entrants i substitutius"
  left:
    h: Barreres d'entrada
    items:
      - "Capital: muntar programari és barat; una refineria, milers de milions"
      - "Regulació: llicències i homologacions d'anys en banca, farmàcia o telecomunicacions"
      - "Marca: Coca-Cola domina els refrescos encara que la recepta no siga secreta"
      - Accés a canals, economies d'escala i corba d'experiència de l'incumbent
      - "La sexta força, els complements (Brandenburger i Nalebuff): un mòbil nou necessita milers d'apps"
  right:
    h: Amenaça de substitutius
    items:
      - "Venen d'un altre sector: la videoconferència va desinflar el viatge de negocis"
      - Blockbuster vigilava altres videoclubs i no va vore vindre Netflix
      - El mòbil va substituir el rellotge, la càmera, l'agenda, el GPS i el despertador
      - "Pensa en funcions, no en objectes: ningú contracta un cotxe, contracta desplaçar-se"
- tipo: list
  title: Què intensifica la rivalitat entre competidors
  items:
    - "Molts competidors semblants i equilibrats: guerra de preus"
    - Sector madur o en declivi, on el que guanya un ho perd un altre
    - "Costos fixos alts que obliguen a vendre a qualsevol preu: aerolínies, hotels"
    - Producte indiferenciat, sense marca ni experiència que defendre
    - "Barreres d'eixida altes: les empreses resistixen en el sector més enllà del raonable"
- tipo: section
  title: "El macroentorn: l'anàlisi PESTEL"
  subtitle: "Aguilar, 1967. Si llistes quaranta factors no has analitzat, has inventariat: prioritza de tres a cinc crítics."
- tipo: diagram
  diagrama: PESTELHexagon
  caption: Sis dimensions del macroentorn que l'empresa observa i anticipa, però no controla.
- tipo: list
  title: Les sis dimensions del PESTEL
  items:
    - "P — Polític: fiscalitat, aranzels i estabilitat regulatòria. El Brexit va costar a les exportadores espanyoles milers de milions."
    - "E — Econòmic: cicle, inflació, tipus i tipus de canvi. La inflació espanyola de 2022, del 8,4 %, va ser la major des de 1985."
    - "S — Social: envelliment, urbanització, dietes i treball flexible. El 2025 teletreballa el 14,8 % dels ocupats (EPA)."
    - "T — Tecnològic: IA generativa, renovables, vehicle elèctric, biotecnologia i robotització industrial."
    - "E — Ecològic: fenòmens extrems com la DANA de 2024, petjada de carboni, escassetat hídrica i drets d'emissió."
    - "L — Legal: dret laboral, RGPD, normativa sectorial i una fiscalitat canviant en Societats, IVA i taxes digitals."
- tipo: figure
  src: edmn-2bach/03/banco-espana.jpg
  alt: Façana històrica de l'edifici principal del Banc d'Espanya a la Plaça de Cibeles, Madrid.
  title: La P i la L del PESTEL, en un edifici
  caption: "Banca, fiscalitat, dret laboral, protecció de dades: ningú els canvia sol, però tots els han d'anticipar."
  credit: "Foto: Fer.filol, domini públic via Wikimedia Commons"
- tipo: data
  numero: "+40 %"
  label: trànsit de dades en una setmana
  title: El PESTEL de Movistar, març de 2020
  detalle: "Les telecomunicacions van passar a servici essencial i es van prohibir els talls per impagament. La fibra va deixar de ser premium: Telefónica va ampliar la xarxa sense càrrec i va vendre paquets de teletreball nous."
- tipo: figure
  src: edmn-2bach/03/parque-eolico-cadiz.jpg
  alt: Aerogeneradors del parc eòlic Los Almeriques a Medina-Sidonia, Cadis, vistos des d'un camp pròxim.
  title: Quan dues dimensions del PESTEL es creuen
  caption: La transició energètica creua el tecnològic i l'ecològic, i ha reescrit en pocs anys quins sectors són rendibles.
  credit: "Foto: Emilio J. Rodríguez Posada, CC BY-SA 3.0 via Wikimedia Commons"
- tipo: section
  title: Responsabilitat social corporativa, ODS i inclusió
  subtitle: "De «l'única responsabilitat social és augmentar els beneficis» (Friedman, 1970) al triple compte d'Elkington (1994)."
- tipo: concept
  eyebrow: Cas real
  title: Patagonia, l'empresa que es va regalar al planeta
  body: "El setembre de 2022 Yvon Chouinard va transferir el 100 % de Patagonia —3.000 M$— a dos vehicles: un trust que conserva els drets de vot i vetla per la missió ambiental, i una fundació que rep els beneficis, uns 100 M$ a l'any, per a finançar la lluita climàtica. Vista des del marc de la unitat no és altruisme, sinó lectura estratègica d'un entorn legal, social i ambiental que premia eixa coherència."
  pull: "«La Terra és ara el nostre únic accionista», va escriure Chouinard en anunciar-ho."
- tipo: figure
  src: edmn-2bach/03/patagonia-hq.jpg
  alt: Edifici baix de la seu central de Patagonia a Ventura, Califòrnia, envoltat de palmeres.
  title: Seu de Patagonia a Ventura, Califòrnia
  caption: "En 2022 Chouinard va transferir el 100 % de les accions a una fundació ambiental: RSC ficada en la mateixa propietat."
  credit: "Foto: Nicolás Boullosa, CC BY 2.0 via Wikimedia Commons"
- tipo: terms
  title: Els tres pilars de la RSC, i com els mesuren els inversors
  terms:
    - t: Econòmic
      d: Complir amb Hisenda sense recórrer a paradisos fiscals, pagar els proveïdors en termini (Llei 15/2010), reinvertir en el territori i ser transparent.
    - t: Social
      d: "Condicions dignes, formació i no discriminació. Pla d'igualtat obligatori des de 50 treballadors; registre retributiu per sexe, en totes."
    - t: Ambiental
      d: "Mesurar la petjada de carboni, reduir emissions, gestionar residus i dissenyar pensant en el cicle de vida complet: economia circular."
    - t: ESG
      d: Marc amb què els inversors institucionals avaluen l'empresa. Una mala nota encarix el finançament entre 30 i 100 punts bàsics.
- tipo: concept
  title: Els ODS donen estructura; el greenwashing la buida
  body: "El 2015 l'ONU va aprovar l'Agenda 2030 i els seus 17 Objectius de Desenvolupament Sostenible. En l'empresa pesen sobretot el 5 (igualtat), el 8 (treball digne), el 9 (innovació), el 12 (consum responsable) i el 13 (clima): ningú cobrix els 17, només aquells on la seua activitat més impacta. El greenwashing fa just el contrari: exagera el marginal i ignora el principal."
  pull: Una RSC seriosa es reconeix per mètriques verificables i auditades, no per campanyes en xarxes.
- tipo: section
  title: L'anàlisi DAFO
  subtitle: Albert Humphrey, Stanford Research Institute, anys seixanta. La matriu que integra l'extern amb l'intern.
- tipo: diagram
  diagrama: DAFOGrid
  caption: "Dos eixos —intern enfront d'extern, positiu enfront de negatiu— i els quatre encreuaments que ixen de combinar les caselles."
- tipo: concept
  eyebrow: En l'EBAU
  title: "Intern o extern: la regla de butxaca"
  body: "És la distinció que més es confon i la que l'examen demana amb regularitat. Intern és el que l'empresa canvia amb les seues decisions: formar l'equip, tancar una línia, pujar preus. Extern és el que només pot llegir i anticipar: inflació, regulació, competència, demografia. La inflació mai és debilitat, és amenaça; un equip desactualitzat mai és amenaça, és debilitat."
  pull: "Pot el director general arreglar-ho amb la seua firma? Si sí, és intern; si no, és extern."
- tipo: exercise
  title: DAFO d'una llibreria de barri enfront de l'e-commerce
  enunciado: "Una llibreria de barri competix amb els grans marketplaces. Construïx el seu DAFO amb un element per casella i deriva dos encreuaments estratègics: un d'ofensiu i un de supervivència."
  pasos:
    - "Fortalesa: un equip que coneix el catàleg i sap recomanar."
    - "Debilitat: preus menys competitius que els dels grans marketplaces."
    - "Oportunitat: sensibilitat social creixent cap al comerç local."
    - "Amenaça: gegants de l'e-commerce amb descomptes agressius."
    - "Encreuament FO: convertir la recomanació humana en servici —clubs de lectura, actes amb autors—."
    - "Encreuament DA: reduir estoc mort i especialitzar-se en nínxols on l'algoritme recomana malament."
- tipo: quiz
  eyebrow: En l'EBAU
  pregunta: "«La inflació ha pujat tres punts i encarix les nostres matèries primeres.» En quina casella del DAFO entra?"
  opciones:
    - Debilitat, perquè reduïx el marge de l'empresa
    - Amenaça, perquè és externa i l'empresa no la controla
    - Fortalesa, si l'empresa pot pujar preus
    - Oportunitat, perquè obliga a revisar costos
  correcta: "1"
  explicacion: "L'empresa no pot canviar la inflació amb les seues decisions: és externa i negativa, és a dir, una amenaça. Col·locar-la com a debilitat és un dels errors més penalitzats."
- tipo: section
  title: Estratègies empresarials clàssiques
  subtitle: "Ansoff (1957) respon cap a on créixer; Porter (1980), com construir l'avantatge. Són marcs complementaris."
- tipo: diagram
  diagrama: AnsoffMatrix
  caption: "El risc creix d'esquerra a dreta i de dalt a baix: penetrar és el segur, diversificar l'aposta major."
- tipo: list
  title: El mateix forn en els quatre quadrants
  ordered: true
  items:
    - "Penetració: obri també de nit per a vendre més pa en el mateix barri."
    - "Desenvolupament de producte: comença a vendre entrepans preparats als seus clients de sempre."
    - "Desenvolupament de mercat: distribuïx el pa que ja fa a botigues d'altres barris."
    - "Diversificació: munta un negoci de càtering per a empreses, amb producte i clients nous."
- tipo: table
  title: Les tres estratègies genèriques de Porter
  head:
    - Estratègia
    - Com es construïx l'avantatge
    - Exemples
  rows:
    - - Lideratge en costos
      - Estructura de costos més eficient, preu menor
      - Mercadona, Ryanair, IKEA
    - - Diferenciació
      - Producte percebut com a únic; preu premium
      - Apple, Hermès, El Bulli
    - - Enfocament o nínxol
      - Dominar un segment estret, amb cost baix o diferenciació
      - Camper, Decathlon, Roomba
  caption: "Porter avisa contra quedar-se atrapat al mig: qui no destaca ni per cost ni per diferència perd quota."
- tipo: quiz
  pregunta: Mercadona comença a vendre a Portugal el 2019 els mateixos productes que ja ven a Espanya. Quina estratègia d'Ansoff aplica?
  opciones:
    ...
    - Diversificació
  correcta: "2"
  explicacion: "El producte és el mateix i el mercat és nou: desenvolupament de mercat. Seria diversificació només si a més venguera un producte que hui no té."
- tipo: concept
  eyebrow: Del llibre al projecte
  title: Quatre documents abans d'entrar en el model de negoci
  body: "La unitat s'entrega en quatre peces aplicades al sector del projecte: un PESTEL amb tres factors crítics i el seu indicador de seguiment, les cinc forces valorades com a alta, mitjana o baixa amb un argument, un DAFO de tres elements per casella amb dos encreuaments i l'estratègia inicial situada en un quadrant d'Ansoff. Cada apartat s'acota al sector i al moment concrets: les plantilles genèriques no compten."
  pull: "Etapa 3: els quatre documents són el punt de partida del model de negoci de la Unitat 4."
- tipo: recap
  eyebrow: "Repassa"
  title: "Abans de tancar la unitat"
  items:
    - "Sabries separar microentorn de macroentorn i nomenar els actors de cadascun."
    - "Sabries aplicar un PESTEL a un cas real i traure'n oportunitats i amenaces."
    - "Sabries explicar la responsabilitat social corporativa i enllaçar-la amb els ODS."
    - "Sabries construir una matriu DAFO per a un projecte empresarial concret."
    - "Sabries distingir les quatre estratègies d'Ansoff i dir quina encaixa en cada situació."
```
