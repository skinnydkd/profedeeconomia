...
L'analista més conegut del microentorn és **Michael Porter**, professor de la Harvard Business School que en 1979 va publicar en *Harvard Business Review* el seu cèlebre marc de les **cinc forces competitives**. El marc es reprendrà en la Unitat 12 per a l'anàlisi de viabilitat d'un pla d'empresa, però convé entendre ja els seus cinc vèrtexs amb cert detall.
...
- tipo: concept
  ...
  pull: "Els quatre documents són el punt de partida del model de negoci de la Unitat 4."
- tipo: recap
  eyebrow: "Repassa"
