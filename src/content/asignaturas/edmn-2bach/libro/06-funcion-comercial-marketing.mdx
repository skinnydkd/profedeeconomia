...
- tipo: terms
  ...
  terms:
    ...
    - t: Conductuales
      d: "Frecuencia de uso, lealtad, beneficios buscados, ocasión de uso, sensibilidad al precio. Los más útiles: hablan de cómo se comporta el cliente en el sector."
- tipo: list
...
- tipo: list
  ...
  items:
    - "Indiferenciado: un solo mix para todo el mercado. Útil en commodities (electricidad, gas, sal) y cada vez más raro."
...
- tipo: diagram
  ...
  caption: Cuatro decisiones interconectadas que orbitan alrededor del cliente objetivo.
- tipo: terms
  title: Qué decide cada P
  terms:
    - t: Producto
      d: "Qué se vende: diseño, calidad, gama, marca, packaging, garantía y postventa. Incluye los atributos físicos y también los intangibles que el cliente recibe."
    - t: Precio
      d: "Cuánto cuesta: estrategia de precios, descuentos, formas de pago y condiciones de crédito. Es la P más rápida de cambiar y la que antes trae consecuencias."
    - t: Plaza
      d: "Dónde se vende: canales, cobertura, inventario, transporte y punto de venta físico o digital. El canal condiciona el resto del mix."
    - t: Promoción
      d: "Cómo se comunica: publicidad, promociones, relaciones públicas, venta personal y redes. La P más visible y la más fácil de hacer mal."
- tipo: list
...
- tipo: figure
  ...
  caption: "Poca variedad y mucha marca propia, precio estable, tienda de barrio y casi cero publicidad: cuatro decisiones alineadas."
  credit: "Foto: Daiima, CC0 vía Wikimedia Commons"
- tipo: section
...
- tipo: section
  ...
  subtitle: Cómo se cobra. Seis esquemas básicos que se pueden combinar según el segmento y la propuesta.
- tipo: list
  ...
  items:
    ...
    - "Pago por uso: se paga según el consumo (luz, agua, parking, cloud). Justo, pero difícil de empaquetar."
...
- tipo: quiz
  ...
  correcta: 1
  explicacion: "Valorar la calidad no permite contar ni describir a nadie: no sabemos quiénes son ni cuántos. Sin identificarlo, tampoco hay forma de comprobar las otras tres condiciones."
- tipo: concept
...
- tipo: list
  ...
  items:
    ...
    - La propuesta de valor resuelve un problema real, de forma distinguible y contable en una sola frase.
