...
<CasoDilema
  ...
  fuente="Adaptado de análisis sectoriales · principios 2024"
  pregunta="¿Por qué una rebaja del 15 % puede reducir los ingresos en lugar de aumentarlos?"
>
A principios de 2024, Nespresso experimentó con una rebaja del 15 % en sus cápsulas clásicas para frenar la competencia de las marcas blancas de los grandes supermercados (Lidl, Carrefour, Mercadona). La hipótesis era ampliar el segmento atrayendo a consumidores sensibles al precio. El resultado fue el contrario: los ingresos cayeron un 8 % el primer trimestre y la percepción de marca premium se deterioró en los estudios de mercado posteriores.
</CasoDilema>
...
La rebaja desestabilizó el **posicionamiento premium** que justificaba el sobrecoste sobre las marcas blancas. El precio no era solo un coste para el consumidor: era una **señal** —de calidad, exclusividad y pertenencia a un determinado segmento— alineada con la propuesta de valor de Nespresso.

Al romper esa señal, Nespresso perdió a sus clientes premium sin atraer suficientes clientes nuevos del segmento sensible al precio: ese segmento ya compraba marca blanca a 0,15 €/cápsula y no estaba dispuesto a pagar 0,35 € aunque fuera más barato que los 0,42 € anteriores. La lección operativa: una bajada de precio **no es un movimiento neutro**, es un cambio de segmentación disfrazado de promoción. La coherencia del mix —producto premium, precio premium, canal selectivo, comunicación de exclusividad— se rompió al tocar solo una variable.
</VuelveAlCaso>
...
- tipo: concept
  eyebrow: El caso
  title: Bajó el precio un 15 % y facturó un 8 % menos
  body: "A principios de 2024, Nespresso rebajó un 15 % sus cápsulas clásicas para frenar a las marcas blancas de Lidl, Carrefour y Mercadona. La hipótesis era ampliar el segmento atrayendo a consumidores sensibles al precio. El resultado fue el contrario: los ingresos cayeron un 8 % el primer trimestre y la percepción de marca premium se deterioró en los estudios de mercado posteriores."
  pull: "¿Por qué una rebaja del 15 % puede reducir los ingresos en lugar de aumentarlos?"
- tipo: section
...
- tipo: concept
  ...
  body: "La rebaja desestabilizó el posicionamiento premium que justificaba el sobrecoste sobre las marcas blancas. Nespresso perdió a sus clientes premium sin atraer a los sensibles al precio: ese segmento ya compraba marca blanca a 0,15 € la cápsula y no iba a pagar 0,35 €, aunque fuera menos que los 0,42 € anteriores."
