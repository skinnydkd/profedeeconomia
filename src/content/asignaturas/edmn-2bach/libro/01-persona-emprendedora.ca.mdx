...
objetivos:
  ...
  - Situar l'emprenedoria a Espanya amb dades reals i entendre la cultura emprenedora com una competència transversal.
...
Abans d'avançar és útil dedicar una sessió a discutir tres idees esteses sobre l'emprenedoria. Fer-ho evita que l'alumnat interioritze una imatge romàntica que després xoca amb la realitat.
...
<VocesDesacuerdo
  tema="Emprendre per oportunitat és el mateix que emprendre per necessitat?"
  postura_a={{
    etiqueta: 'És el mateix: emprendre és emprendre',
    tesis: "Qui munta alguna cosa assumix risc, organitza recursos i respon dels deutes, vinga d'on vinga. Distingir pel motiu introduïx un judici moral que les dades no necessiten.",
  }}
  postura_b={{
    etiqueta: 'Són fenòmens distints',
    tesis: "Qui emprén sense alternativa no tria: sosté una ocupació que el mercat no li dona. Barrejar-los en la mateixa estadística infla les xifres i amaga precarietat darrere d'una paraula que sona bé.",
  }}
>
La distinció no és retòrica: el **GEM** la fa servir des de fa dues dècades precisament perquè els dos grups es comporten distint —en supervivència, en contractació i en creixement—. Quan llegisques que a Espanya hi ha tants milers d'emprenedors nous, **la pregunta útil és quina part d'eixa xifra són projectes amb ambició de créixer i quina part són altes al RETA d'algú que no trobava una altra cosa**. Les dues són legítimes; només que no responen a la mateixa política pública ni admeten el mateix consell.
</VocesDesacuerdo>
...
Estes dades no es demana memoritzar-les, però convé presentar-les a l'aula perquè ajuden l'alumnat a contextualitzar les seues pròpies idees de negoci. L'emprenedoria no és una abstracció universal: té sectors, edats, regions i gèneres amb dinàmiques pròpies.
...
### Com usar este llibre

Este curs prepara la prova d'accés a la universitat (PAU/EBAU). L'examen d'Empresa i Disseny de Models de Negoci té dues parts: una **Part I de teoria**, amb qüestions sobre els continguts dels blocs, i una **Part II de problemes**, amb exercicis numèrics de producció, finances i comptabilitat. El llibre està pensat amb eixa prova davant: cada unitat indica quin bloc cobrix i en quina part de l'examen apareix, i inclou un **glossari**, unes **pistes EBAU** i un **test** d'autoavaluació per a comprovar que allò essencial s'ha entés.

Qui vulga portar la teoria a un projecte real té, a banda del llibre, el quadern de projecte de l'assignatura —la versió de «De zero a empresa» ancorada a este temari— en [/edmn-2bach/proyecto/](/edmn-2bach/proyecto/): un itinerari per fases per a construir un pla d'empresa aplicant les eines de cada unitat. És **material opcional**: el llibre no en depén i es pot seguir el curs complet sense obrir-lo.
...
>
  <Fragment slot="actividad">
    Després del primer quart del podcast (25 min), escriu el **teu propi «per què»** en tres frases: (1) un problema que veges clar al teu voltant, (2) per què et toca a tu més que a una altra persona, (3) què passaria si ningú no ho resol. Guarda'l: és l'embrió d'una possible idea de negoci. Comparteix una de les tres frases a la pròxima sessió.
  </Fragment>
...
- tipo: curriculum
  ...
  saberes:
    - "Bloc A: esperit emprenedor i la persona emprenedora."
    - "Bloc A: l'empresa com a agent econòmic i social."
  competencias:
    - "Comprendre l'empresa com a agent econòmic i social i el paper emprenedor."
- tipo: section
...
- tipo: timeline
  ...
  hitos:
    - fecha: "1985"
      hito: "El consell d'Apple l'acomiada"
      detalle: "Després del fracàs comercial del primer Macintosh."
    - fecha: "1985-1996"
      hito: "Funda NeXT"
      detalle: "Mai va assolir massa crítica de mercat."
    - fecha: "1996"
      hito: "Apple el recupera en comprar NeXT"
      detalle: "L'empresa estava a la vora de la fallida."
    - fecha: "1997"
      hito: "Torna a ser CEO"
      detalle: "Els trets eren els mateixos; van canviar el context i el que havia aprés pel camí."
- tipo: list
...
- tipo: concept
  ...
  body: "El RD 243/2022 situa la cultura emprenedora com una de les dues finalitats de l'assignatura. No es tracta que cada alumne munte una empresa, sinó d'entrenar en baix risc habilitats que servixen igual en una gran corporació: identificar oportunitats, organitzar recursos, comunicar una proposta i gestionar la incertesa. Cada unitat les entrena amb casos reals i activitats."
  pull: "Emprendre és un ofici que s'aprén, no un tret amb què es naix."
- tipo: recap
  eyebrow: "Repassa"
  title: "Abans de tancar la unitat"
  items:
    - "Sabries definir què és una empresa, quines funcions complix i amb quins criteris es classifica."
    - "Sabries nomenar els trets del perfil emprenedor i separar els que s'aprenen dels que no."
    - "Sabries defendre que èxit i fracàs són fases del mateix procés, no pols oposats."
    - "Sabries situar l'emprenedoria a Espanya amb dades reals i explicar què és la cultura emprenedora."
```
