...
- **El autónomo** es una empresa unipersonal a efectos económicos. Organiza recursos, asume riesgo y busca excedente, aunque jurídicamente sea una persona física. En España hay más de 3,3 millones de autónomos registrados; la mayoría son técnicamente *empresas* pese a que el término *empresario* casi nunca se les aplica en el lenguaje cotidiano.
...
<Figure
  ...
  caption="Supermercado Mercadona en Finestrat (Alicante). Una empresa con 102.000 personas en plantilla y un modelo retributivo que sitúa la función social al mismo nivel que la productiva."
...
Mercadona cerró 2023 con 102.000 personas en plantilla, un salario medio de entrada de 1.685 € brutos al mes —un 30 % por encima del convenio del comercio— y un beneficio neto de 1.009 M€. La empresa reparte cada año un 25 % de sus beneficios en pluses a los trabajadores y mantiene formaciones internas pagadas durante la jornada. Discutid en clase si esto es responsabilidad social o cálculo económico (rotación más baja, productividad por trabajador casi el doble que la media del sector). La respuesta es probablemente «las dos cosas a la vez», y precisamente esa convergencia entre rentabilidad económica y responsabilidad social es la dirección en la que va la gestión empresarial moderna.
</RealExample>
...
En 1975, Amancio Ortega abrió la primera tienda Zorba en A Coruña. La idea no era nueva (vender ropa) ni tecnológicamente disruptiva. Lo que sí era nuevo era el modelo: integrar verticalmente toda la cadena, reducir el ciclo entre diseño y venta a dos semanas y dejar que las tiendas decidieran el surtido. Cincuenta años después, ese movimiento de combinar elementos conocidos de manera distinta es lo que separa a la mayoría de empresas que abren cada año de las pocas que sobreviven una década. Ortega es schumpeteriano en sentido pleno: innovó en el modelo, no en el producto.
...
En España, los informes GEM (*Global Entrepreneurship Monitor*) muestran que aproximadamente el **70 % del emprendimiento** es por oportunidad y el **30 % por necesidad**, una proporción mejor que la media europea pero peor que la de los países nórdicos.
...
- La **tasa de actividad emprendedora** (porcentaje de adultos involucrados en crear una empresa o gestionarla en sus primeros tres años) es de aproximadamente el **6 %** en España, frente al 9-10 % de la media europea.
- El **70 %** del emprendimiento español es **por oportunidad** y el 30 % por necesidad.
- La **edad media** del emprendedor español al iniciar su proyecto está en el **rango 35-44 años**, cercana al dato del MIT.
- La **brecha de género** persiste: por cada 10 hombres que emprenden, lo hacen aproximadamente **7,5 mujeres**. La brecha es mayor en sectores tecnológicos y menor en servicios.
...
9. GEM España (2024). *Informe anual sobre la actividad emprendedora en España*. GEM Consortium.
