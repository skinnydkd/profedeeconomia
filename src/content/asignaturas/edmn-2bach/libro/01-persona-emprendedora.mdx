...
<RetoEtapa
  etapa={1}
  titulo="Tu idea + el «por qué tú»"
  entregable="Una ficha de una página: idea de negocio en una frase, problema que resuelve, qué tienes tú que no tiene otra persona para sacarla adelante."
>
Elige una **idea de negocio** sobre la que vas a trabajar durante todo el curso. No tiene que ser brillante, original ni viable; tiene que ser **tuya** y suficientemente concreta para no cambiarla cada semana. Si dudas entre varias, escribe las tres y pregúntate cuál te apetece defender en junio.

Escribe en una página: (1) tu idea en una frase del tipo *«para [segmento] que sufre [problema], ofrezco [solución] que se diferencia de [alternativa] porque [valor]»*; (2) el problema real que resuelve, con un ejemplo cercano; (3) **tus** competencias, contactos o experiencias que hacen que esta idea encaje contigo —no copies *«soy creativo y trabajador»*; sé específico—. Si esta etapa no la haces tuya, las once siguientes pierden el hilo.
</RetoEtapa>
...
>
  <Fragment slot="actividad">
    Después del primer cuarto del podcast (25 min), escribe tu **propio «por qué»** en tres frases: (1) un problema que veas claro a tu alrededor, (2) por qué te toca a ti más que a otra persona, (3) qué pasaría si nadie lo resuelve. Guárdalo: es el embrión de tu idea para la **etapa 1** del Reto del curso. Comparte una de las tres frases en la próxima sesión.
  </Fragment>
...
- tipo: concept
  ...
  body: "El RD 243/2022 sitúa la cultura emprendedora como una de las dos finalidades de la asignatura. No se trata de que cada alumno monte una empresa, sino de entrenar en bajo riesgo habilidades que sirven igual en una gran corporación: identificar oportunidades, organizar recursos, comunicar una propuesta y gestionar la incertidumbre. El proyecto capstone arranca aquí y se cierra en la Unidad 12."
  pull: "Etapa 1: tu idea en una frase y el «por qué tú» que la sostiene."
- tipo: recap
  eyebrow: "Repasa"
  ...
  items:
    ...
    - "Sabrías conectar las decisiones del emprendedor con tu proyecto capstone del curso."
```
