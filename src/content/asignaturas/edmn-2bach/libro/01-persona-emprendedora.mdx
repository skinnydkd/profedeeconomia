...
- tipo: terms
  ...
  terms:
    ...
    - t: Social
      d: Empleo, impuestos, renta distribuida y externalidades sobre el entorno. Gestionarla de forma consciente es la responsabilidad social corporativa.
- tipo: section
  title: Cómo clasificar una empresa
  subtitle: Cinco criterios que el currículo LOMLOE pide reconocer y que aparecen en todos los informes oficiales.
- tipo: list
...
- tipo: table
  ...
  rows:
    ...
    - ["Mediana", "< 250 personas", "≤ 50 M €", "≤ 43 M €"]
    - ["Grande", "≥ 250 personas", "> 50 M €", "> 43 M €"]
  caption: "Regla de la doble condición: hay que cumplir el criterio de plantilla y, además, uno cualquiera de los dos financieros."
- tipo: exercise
...
- tipo: terms
  title: Tres términos del glosario
  terms:
    - t: Destrucción creativa
      d: "Proceso por el que las empresas innovadoras desplazan a las menos eficientes: genera crecimiento agregado a costa de costes locales de adaptación."
    - t: Función empresarial
      d: En Kirzner, capacidad de detectar oportunidades de arbitraje que otros no han visto en un mercado en desequilibrio permanente.
    - t: Intraemprendedor
      d: Quien actúa con mentalidad emprendedora dentro de una empresa establecida. 3M, Google o BBVA tienen programas formales de intraemprendimiento.
- tipo: quiz
  pregunta: Alguien abre una papelería en un barrio nuevo donde no había ninguna. ¿Cómo describe la teoría ese movimiento?
  opciones:
    - "Emprendimiento kirzneriano: ocupa un hueco que el mercado había dejado pasar"
    - Destrucción creativa en el sentido de Schumpeter
    - Intraemprendimiento dentro de una empresa establecida
    - No es emprender, porque no innova en el producto
  correcta: 0
  explicacion: No crea nada radicalmente nuevo, pero ajusta la asignación de recursos. La mayor parte del valor económico real la generan emprendedores kirznerianos.
- tipo: list
  title: Por qué unas personas emprenden y otras no (Ajzen)
  items:
    ...
    - Una asignatura como esta incide en los tres factores a la vez, y por eso figura en el currículo.
- tipo: quiz
  pregunta: Marta se queda sin empleo, no encuentra otro y monta una tienda para autoemplearse. ¿Qué tipo de emprendimiento es?
  opciones:
  ...
  correcta: 0
  explicacion: Se autoemplea porque no hay alternativa razonable. No es peor en sí mismo, pero sobrevive menos porque la motivación no siempre coincide con una oportunidad real de mercado.
- tipo: section
  title: El perfil, los mitos y los datos
  subtitle: Qué asocia la literatura al perfil emprendedor, qué dicen los meta-análisis y qué conviene no repetir en clase.
- tipo: list
  ...
  items:
    ...
    - "Visión a largo plazo: reinvertir y diferir la gratificación durante el segundo o el tercer año."
...
- tipo: data
  ...
  detalle: "Adultos que crean o gestionan una empresa de menos de 42 meses (GEM España 2024-2025). Predomina la vía de la oportunidad, la edad media va de 35 a 44 años y la brecha de género se estrecha: 6,8 % ellas, 7,6 % ellos."
- tipo: concept
