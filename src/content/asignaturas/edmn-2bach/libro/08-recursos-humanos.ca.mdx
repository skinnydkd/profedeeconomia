...
c) Calcular les **cotitzacions patronals** (quota empresarial) sabent que la suma de contingències comunes, desocupació, FP, FOGASA i AT/EP representa aproximadament un **31 % de la base de cotització**, més el MEI (0,8 % empresarial en 2026).
