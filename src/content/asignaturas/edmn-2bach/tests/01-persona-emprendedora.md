...
title: "Test · Unidad 1 — La persona emprendedora"
...
preguntas:
  ...
  - enunciado: "Las cuatro funciones simultáneas de la empresa son…"
    opciones:
      ...
      - "Compras, ventas, finanzas y administración."
      - "Productiva, comercial, financiera y social."
      - "Marketing, operaciones, recursos humanos y tecnología."
    correcta: 2
    explicacion: "El currículo LOMLOE integra explícitamente la función social (impuestos, empleo, RSC) junto a las tres clásicas: productiva, comercial y financiera."
  ...
  - enunciado: "Según el estudio del MIT publicado en 2020 sobre 2,7 millones de fundadores en EE.UU., la edad media de quien funda una empresa exitosa es…"
    opciones:
      ...
      - "55 años."
    correcta: 2
    explicacion: "El dato contradice la narrativa del joven genio del garaje: la edad media de un fundador exitoso es 45 años, no 25."
  - enunciado: "¿Cuál de estos NO es un rasgo asociado tradicionalmente al perfil emprendedor?"
    opciones:
