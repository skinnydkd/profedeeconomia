...
- tipo: terms
  title: Cuatro sesgos, cuatro antídotos
  terms:
    - t: Anclaje
      d: "El primer número que aparece condiciona todo lo que viene después, aunque sea arbitrario. Antídoto: pregúntate cuánto pagarías tú sin conocer el precio del vendedor."
    - t: Sesgo de confirmación
      d: "Buscas lo que confirma tu hipótesis y filtras lo que la contradice, sin mala fe. Antídoto: habla con al menos dos personas que opinen lo contrario antes de decidir."
    - t: Coste hundido
      d: "Lo ya invertido e irrecuperable no debería pesar en lo que decides hoy. Antídoto: si empezaras hoy desde cero, ¿elegirías esto? Si la respuesta es no, no te ates."
    - t: Sesgo del presente
      d: "Preferimos 10 € hoy a 15 € en un mes: el cerebro infravalora lo lejano. Antídoto: haz visibles ahora los beneficios futuros (calendario, objetivo a la vista)."
- tipo: concept
  eyebrow: La bandera roja
  ...
  pull: "«Ya he invertido mucho como para dejarlo» es la bandera roja del coste hundido."
- tipo: data
  numero: "×10"
  label: menos compradores
...
- tipo: table
  title: "El test del aula: ocho situaciones de 1 a 5"
  head: ["Suma", "Perfil"]
  rows:
...
- tipo: concept
  ...
  body: "Acabó 4.º de ESO en 2018; su familia daba por hecho el Bachillerato, pero a ella le interesaba arreglar máquinas. Tras una matriz de decisión hecha con su tutor, eligió FP de Grado Medio en Mantenimiento Electromecánico. En 2022 ganó el oro en SpainSkills y en 2024 representó a España en WorldSkills Lyon. La moraleja: la decisión correcta depende de los criterios de cada persona, no del guión del entorno."
- tipo: quote
  texto: "Si me hubiera dejado llevar por lo que mi familia esperaba, ahora estaría arrastrándome por una carrera que no me gusta. La decisión costó porque iba contra el guión, pero era la decisión correcta para mí."
