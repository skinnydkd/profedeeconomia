...
lang: ca
estado: publicado
slug: "asignaturas/fopp-4eso/actividades/11-caso-tres-espejos-identidad.ca"
---
...
| --- | --- | --- |
| Distinció dels tres espills | Classifica correctament la informació del cas en autoimatge, imatge creguda i imatge percebuda | 30 % |
| Anàlisi de la distància | Identifica on està el major desajust i proposa una explicació raonable | 25 % |
| Qualitat del debat de decisió | Defén una postura amb arguments, no amb tòpics | 25 % |
| Filtre de la crítica | Distingix amb exemples la crítica útil de la descartable | 20 % |
