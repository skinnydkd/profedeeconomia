...
title: "Campanya de salut mental per al teu institut, sense ni un sol tòpic"
descripcion: "Encàrrec de comunicació amb una restricció dura: dissenyar tres peces sobre salut mental adolescent que no usen cap de les frases fetes que tot el món repetix, i que incloguen un recurs real al qual es puga acudir demà mateix."
tipo: creativo
duracion: "2 sessions de 55 min · investigació + disseny"
...
lang: ca
estado: publicado
slug: "asignaturas/fopp-4eso/actividades/02-creativo-campana-de-salud-mental-sin-topicos.ca"
---
...
| Peça | Format | Què ha d'aconseguir |
| --- | --- | --- |
| 1. El senyal | Cartell A3 | Que algú reconega en si mateix o en una altra persona un senyal d'alerta concret |
| 2. El pas següent | Cartell o targeta de butxaca | Què fer exactament: a qui, on, quan |
| 3. El que no ajuda | Format lliure | Què dir-li a algú que està malament, i què és millor no dir-li |
...
3. **Selecció (10 min).** La classe tria les peces que es proposaran a l'equip directiu per a penjar de veres.
...
| --- | --- | --- |
| Rigor | Senyals precisos i recursos verificats amb dades vigents | 35 % |
| Sense tòpics | Cap frase prohibida ni equivalent | 20 % |
| Utilitat | Les tres peces diuen què fer, no només com sentir-se | 25 % |
| Comunicació | Llegibles, adequades al públic i amb bon criteri visual | 20 % |

## Variants i extensions

- **Amb suport:** dues peces, amb la llista de recursos ja facilitada pel departament d'orientació.
- **Amb orientació:** treballar la campanya junt amb el departament d'orientació del centre, que pot validar els senyals i els recursos. És molt recomanable i millora molt el resultat.
- **Per a qui va sobrat:** afegir una versió en format vertical per al tauler digital o les xarxes del centre.
- **Nota per a l'aula:** esta activitat pot remoure coses. Convé recordar al principi on està el departament d'orientació i que la porta està oberta sense cita.
