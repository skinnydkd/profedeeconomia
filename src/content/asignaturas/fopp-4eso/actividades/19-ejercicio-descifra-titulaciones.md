...
materiales:
  - "Plantilla del esquema de niveles en A4 (incluida abajo)"
...
Una de las mayores fuentes de error al elegir itinerario es no entender bien **a qué da acceso cada titulación**. ¿Puedo ir a la universidad desde FP? ¿Un Grado Medio me deja hacer un Grado Superior? ¿La FP Básica da el título de la ESO? Confusiones de este tipo llevan a decisiones equivocadas con consecuencias de años.

Este ejercicio no pide opinar: pide **dominar el mapa**. Primero se completa el esquema de niveles y conexiones; después se aplica a seis casos prácticos con personajes que se plantean dudas reales. El objetivo es que al salir nadie confunda los niveles ni sus pasarelas.

## Objetivos didácticos

- Dominar el mapa de titulaciones del sistema educativo español tras 4.º ESO.
- Comprender las pasarelas entre niveles (qué da acceso a qué).
- Aplicar ese conocimiento a casos prácticos concretos.
- Eliminar los errores más comunes sobre el acceso a la universidad y a la FP.

## Plantilla del esquema (completar las flechas de acceso)
...
```
  ...
  (Sin título de ESO → FP Básica → da título de ESO)
```
...
>
> **Caso 6.** Lucía duda entre Bachillerato y Grado Medio porque cree que «la FP cierra la puerta a la universidad para siempre». ¿Es cierto?
...
| --- | --- | --- |
| Esquema de niveles | Completa las pasarelas correctamente | 30 % |
| Resolución de los casos | Responde bien los seis casos con justificación | 40 % |
| Corrección en parejas | Detecta y corrige errores con la fuente | 15 % |
| Desmontaje de mitos | Identifica y rebate al menos un mito sobre los itinerarios | 15 % |

## Variantes y extensiones

- **Variante itinerario propio.** Cada alumno dibuja en el esquema su propio camino previsto y comprueba que las pasarelas existen de verdad.
- **Conexión con la actividad 5.** Este ejercicio es el paso técnico previo al dossier de itinerarios: primero se domina el mapa, después se elige el camino.
