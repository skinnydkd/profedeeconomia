...
<RealExample title="MUD Jeans: vaqueros en alquiler para cerrar el círculo del algodón" source="MUD Jeans, Lease A Jeans y memorias de sostenibilidad de la empresa; Fundación Ellen MacArthur, casos de economía circular (ellenmacarthurfoundation.org)" sourceUrl="https://ellenmacarthurfoundation.org/">
La industria textil es uno de los ejemplos más claros del modelo lineal: se fabrican prendas baratas, se usan poco y se tiran, con un altísimo consumo de agua y de algodón. La empresa neerlandesa MUD Jeans le ha dado la vuelta con un modelo circular: en lugar de venderte los vaqueros, te los **alquila** mediante una cuota mensual; cuando ya no los quieres, los devuelves, y la empresa los repara para revenderlos como prendas de segunda mano o los deshilacha para fabricar tejido nuevo mezclando algodón reciclado con fibra virgen. Así el algodón no acaba en el vertedero, sino que vuelve a entrar en la cadena. No es un caso aislado ni una utopía: es un negocio real que ilustra los tres principios de la economía circular —diseñar para reciclar, mantener en uso y regenerar el material— y, de paso, muestra cómo un problema ambiental se convierte en un modelo de negocio. La Fundación Ellen MacArthur, referente mundial en la difusión de la economía circular, recoge decenas de casos parecidos en sectores muy distintos.
</RealExample>
