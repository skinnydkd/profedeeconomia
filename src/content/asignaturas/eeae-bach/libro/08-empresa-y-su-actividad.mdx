...
<TldrUnidad>
Una empresa tiene **funciones** (comercial, productiva, RR. HH., financiera) y opera dentro de un **sector** con dinámicas propias. Esta unidad presenta el mapa funcional de la empresa moderna y mira la empresa como fenómeno humano, no solo como organigrama.

Verás también la **revolución tecnológica** como marco que lo está cambiando todo, la cultura empresarial, la gestión del talento, el liderazgo y el papel de la mujer en la dirección.
</TldrUnidad>

<CasoDilema
  titular="Mercadona factura 35.529 M€ con 104.000 trabajadores y sigue siendo 100 % familiar"
  fuente="Memoria Mercadona 2024 + diversos análisis sectoriales"
  pregunta="¿Cómo se mantiene una empresa familiar cuando crece tanto?"
>
**Mercadona**, fundada por Juan Roig en Tavernes Blanques (l'Horta Nord) a partir del pequeño grupo de carnicerías de sus padres, factura **35.529 millones de euros** en 2024 con **104.000 personas en plantilla** y 1.677 supermercados. Es la cadena de alimentación líder en España por facturación. Y sin embargo, la familia Roig mantiene el **100 % del capital**: no cotiza en bolsa, no ha entrado capital de inversores externos, no ha hecho fusiones grandes. Ha crecido orgánicamente con beneficios retenidos.
</CasoDilema>
...
<RealExample title="El tejido empresarial español: un país de empresas pequeñas" source="INE, Directorio Central de Empresas (DIRCE), datos a 1 de enero de 2025; Ministerio de Industria y Turismo, Cifras PyME">
Según el Directorio Central de Empresas del INE, a 1 de enero de 2025 había en España 3,31 millones de empresas activas, un 1,7 % más que el año anterior. Lo revelador es su tamaño: más de la mitad (el 54,4 %) no tiene ningún asalariado (autónomos) y la gran mayoría de las que sí emplean tienen menos de diez trabajadores. Las empresas de 250 o más asalariados —las "grandes" en la estadística europea— apenas representan unas milésimas del total, aunque concentran una parte muy alta del empleo. La conclusión es clara: la actividad empresarial española descansa, sobre todo, en microempresas y pymes. Cuando pensamos en "la empresa", el caso típico no es una multinacional, sino un negocio pequeño con pocas personas, donde cultura, talento y liderazgo se viven de forma muy directa.
</RealExample>
...
<Callout label="Ejemplo" title="Cultura que bloquea el cambio: el caso Kodak">

Kodak dominó la fotografía durante décadas y, sin embargo, se declaró en quiebra en 2012. La lección no es tecnológica sino cultural: tener la tecnología no basta si la cultura de la empresa impide usarla. El caso se analiza en detalle —incluyendo la historia del ingeniero Steven Sasson y la decisión estratégica de guardar la cámara digital— en la Unidad 9, donde encaja en el contexto de la innovación disruptiva. La idea importante aquí es esta: una cultura que teme al cambio puede hundir incluso a quien inventa el cambio.

</Callout>

## La cultura empresarial

Si entras en dos empresas distintas, lo notas enseguida: cómo se habla la gente, cómo se viste, si se tutean, si se trabaja en silencio o entre risas, si las decisiones bajan desde arriba o se discuten en equipo. Eso que se "respira" es la **cultura empresarial**. Aquí la examinamos como fenómeno humano y motor del rendimiento; para su análisis dentro de la estrategia empresarial —incluyendo la RSC, la sostenibilidad y el entorno competitivo—, véase la Unidad 9 de esta misma materia. Es el conjunto de valores, creencias, normas no escritas y formas de hacer que comparten las personas de una organización. Es la **personalidad** de la empresa, y condiciona su comportamiento tanto o más que sus normas oficiales.
...
<Callout label="Ejemplo" title="Liderazgo que da ejemplo: Patagonia">

La empresa de ropa de montaña Patagonia es uno de los casos más citados de coherencia entre lo que una empresa dice y lo que su fundador hace: una cultura centrada en el respeto ambiental y en la confianza en los empleados, llevada hasta las decisiones de propiedad. El gesto central —Yvon Chouinard traspasando la empresa a una fundación climática en 2022— ilustra que el liderazgo más creíble es el que **da ejemplo**, alineando las decisiones personales con los valores proclamados. El caso se analiza en extenso en la Unidad 7 de esta materia, en el contexto de la misión y los valores empresariales; aquí basta retener la lección de fondo.
...
<VuelveAlCaso referencia="Mercadona: 100 % familiar, 35.529 M€ de facturación">
Mercadona mantiene la propiedad familiar gracias a una **estrategia financiera conservadora**: no se endeuda agresivamente, no sale a bolsa, no acepta capital externo. Crece despacio reinvirtiendo beneficios. Eso limita el crecimiento potencial —no podría comprar una cadena entera de la noche a la mañana, por ejemplo— pero **mantiene el control familiar y la coherencia cultural** a largo plazo.

Hay otros modelos viables. **Inditex**, también de propiedad familiar mayoritaria (Amancio Ortega), sí cotiza en bolsa y se ha internacionalizado mucho más rápido. Ambos modelos funcionan en sectores parecidos: la decisión de abrir o no a inversores externos no es neutra, es **estratégica**, y depende de qué prioriza la familia fundadora —velocidad de crecimiento, control, riesgo o coherencia—. Cuando emprendas, ese mismo dilema reaparecerá a tu escala: aceptar inversión externa para crecer más rápido o conservar el control aunque tardes más en escalar.
</VuelveAlCaso>
...
- El **liderazgo** es influir para mover a un grupo hacia una meta, y no equivale al **mando formal**; el liderazgo eficaz es **situacional** (se adapta al equipo y al momento) y el **liderazgo de servicio** invierte la pirámide: el líder sirve al equipo, no al revés.
...
<MirarFora
  ...
  libro={{
    ...
    porque: 'El clásico sobre clusters y ventaja competitiva, con capítulos específicos sobre el caso del cluster textil y agroalimentario español. Ayuda a leer una empresa local dentro del ecosistema en el que opera.',
    paginas: 'Capítulos 2 y 7',
  }}
  video={{
    titulo: 'Mercadona — historia de un imperio familiar',
    meta: 'Documental · RTVE Play',
    duracion: '~50 min',
    porque: 'Recorrido por la historia de Mercadona desde la carnicería familiar hasta el liderazgo del sector. Conecta directamente con el caso y permite ver las decisiones culturales que han sostenido el modelo.',
    url: 'https://www.rtve.es/play/buscador/?q=mercadona',
  }}
  cuenta={{
    titulo: '@businessbarista',
    meta: 'X / Twitter',
    porque: 'Hilos sobre casos empresariales españoles e internacionales, con foco en cultura corporativa y modelos de negocio. Útil para mantener un goteo semanal de empresas analizadas.',
  }}
  actividad_titulo="Las cuatro funciones de una empresa local"
  actividad_duracion="40 min · 1 sesión + investigación previa"
>
  <Fragment slot="actividad">
    Elige una **empresa local** que conozcas (la panadería de tu calle, una academia, un taller, una empresa de tu familia, un comercio del centro). Identifica sus **cuatro funciones**: producción/operaciones, comercial/marketing, RR. HH., financiera. Para cada una, describe en una frase cómo se hace de verdad ahí dentro (no en abstracto). Si una función está ausente, indícalo: en muchas pymes pequeñas no hay RR. HH. propio.
  </Fragment>
  <Fragment slot="para-clase">
    **Comparativa** en grupos de 4. Cada persona presenta su empresa en 90 segundos. El grupo elige dos del mismo sector y compara cómo gestionan cada función. Pregunta final para la discusión: ¿qué función está peor gestionada de media en las pymes que habéis analizado y por qué? Duración: 45 min.
  </Fragment>
</MirarFora>
...
- tipo: concept
  eyebrow: El caso
  title: 35.529 M€, 104.000 personas y el 100 % del capital en una familia
  body: Mercadona nació del pequeño grupo de carnicerías de los padres de Juan Roig en Tavernes Blanques. Hoy es la cadena de alimentación líder en España por facturación, con 1.677 supermercados. No cotiza en bolsa ni ha aceptado capital externo.
  pull: Ha crecido orgánicamente con beneficios retenidos. ¿Cómo se mantiene familiar una empresa que crece tanto?
- tipo: section
  title: La empresa como unidad básica
  subtitle: El mercado coordina, pero quien produce de verdad, dentro del mercado, son las empresas.
- tipo: concept
  eyebrow: Concepto clave
  title: Empresa
  body: Organización que combina recursos —personas, dinero, materiales, conocimiento, tecnología— para producir bienes o servicios y ofrecerlos en un mercado, asumiendo el riesgo de que salga bien o mal.
  pull: "No es solo una estructura: es un conjunto de personas que coopera."
- tipo: list
  eyebrow: Para qué existe
  title: Cuatro funciones sociales de la empresa
  items:
    - "Crea valor: transforma recursos en bienes o servicios que la gente quiere."
    - "Genera empleo y rentas: paga salarios que sostienen a las familias."
    - "Coordina: reúne el trabajo de muchos hacia un objetivo que ninguno lograría solo."
    - "Canaliza la innovación: dentro de las empresas la mayoría de ideas se vuelven productos."
    - "Y no actúa en el vacío: clientes, trabajadores, proveedores, comunidad y administraciones dependen de ella."
- tipo: diagram
  diagrama: EmpresaFunctions
  caption: Las grandes áreas de actividad, coordinadas en torno a un mismo objetivo. Cultura, talento y liderazgo las atraviesan todas.
- tipo: data
  numero: "54,4 %"
  label: sin ningún asalariado
  title: El tejido empresarial español es diminuto
  detalle: "De los 3,31 millones de empresas activas a 1 de enero de 2025, más de la mitad son autónomos sin empleados y la mayoría de las que emplean tienen menos de diez personas. Fuente: INE, DIRCE 2025."
- tipo: section
  title: La revolución tecnológica
  subtitle: El marco que está redefiniendo qué producen las empresas, cómo lo producen y cómo se relacionan.
- tipo: table
  eyebrow: El cambio no es nuevo
  title: Tres olas, cada vez más rápidas
  head:
    - Ola
    - Cuándo
    - Qué cambió
  rows:
    - - Máquina de vapor
      - Siglo XVIII
      - Mecanizó la producción y creó la fábrica
    - - Electricidad y cadena
      - Finales del XIX y siglo XX
      - Hizo posible la gran empresa industrial
    - - Revolución digital
      - De finales del XX a hoy
      - Información y datos pesan tanto como las máquinas
  caption: Cada ola no solo creó productos nuevos, cambió la forma de organizar el trabajo y de dirigir a las personas.
- tipo: split
  eyebrow: Las dos caras
  title: Qué supone la ola actual
  left:
    h: Para las grandes
    items:
      - La tecnología es fuente de poder económico.
      - Quien controla una plataforma o unos datos condiciona sectores enteros.
      - Por eso las empresas más valiosas del mundo son tecnológicas.
  right:
    h: Para las pequeñas
    items:
      - Ha abaratado lo que antes solo era para las grandes.
      - Vender por internet, llegar lejos, automatizar tareas.
      - Democratiza en parte la actividad empresarial.
- tipo: concept
  eyebrow: Modelos de negocio
  title: Maneras de ganar dinero que antes no existían
  body: "La tecnología multiplicó las variantes: la suscripción (una cuota periódica en lugar de comprar), las plataformas que conectan a dos grupos sin producir nada, o el freemium (servicio básico gratis, funciones avanzadas de pago)."
  pull: No solo cambia los productos, cambia la forma misma de hacer negocio. La Unidad 9 los retoma.
- tipo: section
  title: La cultura empresarial
  subtitle: Eso que se «respira» al entrar y que no aparece en ningún organigrama.
- tipo: concept
  eyebrow: Concepto clave
  title: Cultura empresarial
  body: Conjunto de valores, creencias, normas no escritas, símbolos y formas de hacer que comparten las personas de una organización. Es la personalidad de la empresa, y condiciona su comportamiento tanto o más que sus normas oficiales.
  pull: No se ve en el organigrama, pero se nota en cuanto entras.
- tipo: list
  eyebrow: Elementos
  title: De qué está hecha una cultura
  items:
    - "Valores y principios: no los declarados, sino los que se ven en las decisiones difíciles."
    - "Normas no escritas: si se puede discrepar del jefe, si se responden correos de noche."
    - "Símbolos y lenguaje: el espacio, la forma de vestir, los rituales y las palabras de la casa."
    - "Historias y referentes: cómo empezó, qué crisis superó, quiénes son sus héroes internos."
- tipo: concept
  eyebrow: De dónde sale
  title: La cultura no se cambia por decreto
  body: "Nace del ejemplo de quien funda y dirige, y se refuerza con a quién se contrata, a quién se asciende y qué se premia. Si una empresa dice valorar la iniciativa pero asciende siempre a los obedientes, su cultura real es la obediencia. Y no hay una cultura ideal para todos: un banco necesita rigor; un estudio de videojuegos, tolerancia al ensayo."
  pull: Se transforma cuando los líderes cambian de conducta de forma sostenida, no cuando se cuelga un cartel.
- tipo: concept
  eyebrow: Caso · Buurtzorg
  title: Una cultura que confía en sus profesionales
  body: Esta organización neerlandesa de enfermería a domicilio organiza a sus enfermeras en equipos autogestionados de unas doce personas que deciden ellas mismas cómo atender, con un mínimo de personal administrativo. Alta satisfacción de pacientes y profesionales.
  pull: La cultura puede ser una ventaja competitiva tan real como la tecnología o el capital.
- tipo: section
  title: La gestión del talento
  subtitle: En muchos sectores el recurso escaso ya no es el capital, sino las personas con habilidades difíciles de encontrar.
- tipo: terms
  eyebrow: Tres verbos
  title: Atraer, desarrollar, retener
  terms:
    - t: Atraer
      d: Que las personas valiosas quieran trabajar aquí y no en otra parte. Depende del salario, pero también de la cultura y del proyecto.
    - t: Desarrollar
      d: Ayudarlas a crecer con formación, nuevas responsabilidades y aprendizaje. El talento no es estático.
    - t: Retener
      d: "Lograr que se queden. Perder a alguien clave cuesta más que su salario: se va con su experiencia y sus contactos."
- tipo: concept
  eyebrow: Motivación
  title: El salario no lo explica todo
  body: Desde los experimentos de Hawthorne se sabe que las personas también rinden por reconocimiento, autonomía, sentido y buen ambiente. Cuando alguien valioso se marcha, muchas veces no se va por el sueldo, sino por su jefe o por sentirse estancado.
  pull: "Talento, cultura y liderazgo son tres caras de una misma realidad: las personas."
- tipo: section
  title: El liderazgo
  subtitle: Influir en un grupo para que se mueva hacia una meta compartida. Liderar no es lo mismo que mandar.
- tipo: split
  eyebrow: Dos cosas distintas
  title: Autoridad formal y liderazgo
  left:
    h: Autoridad formal
    items:
      - El poder que da un cargo.
      - Permite dar órdenes porque el puesto lo permite.
      - Hay jefes con cargo a quienes nadie sigue de verdad.
  right:
    h: Liderazgo
    items:
      - Que la gente te siga porque quiere, no porque deba.
      - No necesita cargo para existir.
      - Hay quien lidera sin ningún puesto formal.
- tipo: list
  eyebrow: Habilidades
  title: Qué hace bien quien lidera
  items:
    - Comunica una dirección con claridad, de modo que todos sepan hacia dónde van y por qué.
    - Escucha, porque liderar no es hablar más, sino captar lo que el equipo necesita.
    - Practica la empatía para detectar tensiones antes de que estallen.
    - Da ejemplo. Nada erosiona más el liderazgo que pedir una cosa y hacer la contraria.
    - Adapta el estilo al equipo y al momento. Los tres estilos clásicos se vieron en la Unidad 5.
- tipo: concept
  eyebrow: Robert Greenleaf, 1970
  title: El liderazgo de servicio invierte la pirámide
  body: "El papel de quien lidera no es que el equipo le sirva, sino servir al equipo: quitar obstáculos, dar recursos, hacer crecer a las personas para que el grupo funcione mejor."
  pull: No es quien más manda, es quien hace posible que los demás trabajen bien.
- tipo: section
  title: El papel de la mujer en la empresa
  subtitle: En España la licencia marital no desapareció del derecho hasta 1975. Ese pasado tan reciente pesa todavía.
- tipo: concept
  eyebrow: Concepto clave
  title: Brecha de género y techo de cristal
  body: "La brecha de género aumenta a medida que se sube en la jerarquía. El techo de cristal es la barrera invisible que dificulta el acceso a la máxima dirección pese a no existir prohibiciones formales: estereotipos, redes masculinas, reparto desigual de cuidados y sesgos en la promoción."
- tipo: data
  numero: "1/3"
  label: de los consejos de la UE
  title: Un avance real pero incompleto
  detalle: "En 2024 alrededor de un tercio de los consejeros de las grandes cotizadas de la UE eran mujeres, frente a un 10 % a comienzos de los 2000. Siguen siendo minoría en presidencias y puestos ejecutivos. Fuente: Eurostat y CNMV."
- tipo: figure
  src: eeae-bach/08/margarita-salas.jpg
  alt: Retrato de la científica Margarita Salas
  title: Margarita Salas
  caption: Su patente sobre la enzima del fago phi29 fue una de las más rentables del CSIC.
  credit: LaMèreVeille, CC BY-SA 4.0 vía Wikimedia Commons
- tipo: figure
  src: eeae-bach/08/mary-barra.jpg
  alt: Retrato oficial de Mary Barra
  title: Mary Barra
  caption: Primera mujer al frente de General Motors, un gran fabricante mundial de automóviles.
  credit: Benjamin Applebaum, dominio público vía Wikimedia Commons
- tipo: concept
  eyebrow: También económicamente
  title: Desaprovechar la mitad del talento es una ineficiencia
  body: Más allá de la justicia, que sería razón suficiente, hay un argumento económico. Los equipos directivos diversos integran más puntos de vista y reducen el pensamiento de grupo.
  pull: Es la escasez autoinfligida de la Unidad 1, aplicada al talento.
- tipo: quiz
  eyebrow: Comprueba que lo pillas
  pregunta: Dos empresas del mismo sector, con recursos y organigrama casi idénticos, rinden muy distinto. ¿Dónde mirarías primero?
  opciones:
    - En sus máquinas y su tecnología.
    - En su cultura, su talento y su liderazgo.
    - En el tamaño de su plantilla.
    - En su forma jurídica.
  correcta: "1"
  explicacion: Es la idea que recorre toda la unidad. Cuando los recursos son parecidos, la diferencia de rendimiento casi nunca está en las máquinas, sino en las personas y en cómo se las organiza y se las dirige.
- tipo: list
  eyebrow: Hilo del curso
  title: Adónde lleva esta unidad
  items:
    - Abre el bloque de actividad empresarial mirando la empresa como fenómeno humano.
    - "Unidad 9: estrategia, competitividad y modelos de negocio, cómo compiten y se reinventan."
    - "Unidad 10: transformación digital y empresa del futuro, cómo serán el trabajo y las organizaciones."
    - Una empresa es, en el fondo, personas organizadas para crear valor.
```
