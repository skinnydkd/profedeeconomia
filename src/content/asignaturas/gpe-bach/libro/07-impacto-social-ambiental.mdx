...
La forma más práctica de reducir esa huella es pensar el proyecto en **circular** en vez de en lineal. El modelo lineal —extraer, producir, tirar— da por hecho que cada cosa termina en la basura. La economía circular pregunta, en cada decisión: ¿puedo usar menos?, ¿puedo usarlo más tiempo?, ¿puede esto volver a entrar en algún ciclo en lugar de convertirse en residuo? Llevado a vuestro proyecto:
