...
<TldrUnidad>
Todo proyecto tiene impactos más allá del beneficio económico: sobre las personas que trabajan en él, sobre la comunidad donde se asienta y sobre el medio ambiente. Esta unidad presenta cómo medir esos impactos y, sobre todo, cómo **integrarlos desde el diseño** —no como decoración a posteriori—. Un proyecto con propósito empieza pensando en su impacto el día uno.
</TldrUnidad>

<CasoDilema
  titular="Auara vende agua mineral y destina el 100 % de los beneficios a llevar agua potable a comunidades sin acceso. ¿Es empresa o es ONG?"
  fuente="Comunicats Auara · 2016-2024"
  pregunta="¿Puede una empresa renunciar deliberadamente al beneficio para sus accionistas sin morir?"
>
**Auara** es una empresa social española fundada en 2016 que vende agua mineral envasada en plástico 100 % reciclado. Su característica más llamativa es que **el 100 % de los beneficios se destinan a proyectos de acceso a agua potable** en comunidades sin red en África, Asia y América Latina —más de 100 proyectos completados hasta 2024, más de 250.000 personas con acceso a agua—. Auara factura, contrata, paga impuestos y compite con Font Vella o Solán de Cabras en el lineal del supermercado. ¿Es una empresa convencional? ¿Es una ONG? ¿Una mezcla rentable o un experimento condenado al fracaso?
</CasoDilema>
...
<VuelveAlCaso referencia="Auara y el 100 % de beneficios a impacto">
Auara es una **empresa social**: una figura cada vez más reconocida en España y Europa, que combina forma jurídica empresarial (factura, paga impuestos, contrata, asume riesgo) con una finalidad principal **distinta** del beneficio para los accionistas. La actividad empresarial es el medio para sostener un objetivo social o ambiental, no el fin último.

Hay un dato de fondo que cambia este debate: cada vez más jóvenes prefieren trabajar en empresas con propósito —en torno al **30 %** de millennials y Gen Z así lo declaran en las encuestas Deloitte de los últimos años— y, en mercados saturados, lo declaran también muchos consumidores. Esa preferencia reconfigura quién captura el mejor talento y quién retiene mejor a sus clientes en el siglo XXI. Para tu proyecto, la conclusión operativa es directa: **incluye los objetivos sociales o ambientales desde el diseño inicial**, no como un añadido cosmético al final. Es más fácil construir un proyecto con propósito que injertárselo cuando ya está rodando.
</VuelveAlCaso>
...
<MirarFora
  ...
  libro={{
    ...
    porque: 'El marco más claro para pensar en impacto: la prosperidad como espacio entre los mínimos sociales y los techos ambientales. No es un manual de RSC; es una forma distinta de mirar qué hace tu proyecto en el sitio donde nace.',
    paginas: 'Capítulos 1 y 6',
  }}
  video={{
    titulo: 'Auara — la empresa que vende agua para llevar agua',
    meta: 'YouTube · entrevistas y reportajes',
    duracion: '~10-15 min',
    porque: 'Ver al fundador explicar cómo se monta y se sostiene una empresa social rentable. Útil para desmontar la idea de que «con propósito» significa «condenado a perder dinero».',
    url: 'https://www.youtube.com/results?search_query=auara+empresa+social+agua',
  }}
  cuenta={{
    titulo: '@auara',
    meta: 'Instagram / X',
    porque: 'Comunicación corporativa de una empresa social en activo: cuántos proyectos completan al mes, cuánta agua llevan, qué problemas operativos tienen. Plantilla útil para ver cómo se cuenta el impacto sin caer en el postureo.',
  }}
  actividad_titulo="Tres impactos del proyecto"
  actividad_duracion="25-35 min"
>
  <Fragment slot="actividad">
    Para la idea con la que trabajas en el cuaderno, identifica **dos impactos positivos** (uno social, uno ambiental) y **un impacto negativo** que tu proyecto generaría. Para cada uno, propón una acción concreta: cómo **maximizar los positivos** y cómo **mitigar el negativo** sin renunciar al proyecto. Cierra conectando los dos positivos con un ODS concreto (objetivo y meta numerada, no solo "el 8").
  </Fragment>
  <Fragment slot="para-clase">
    Cada equipo presenta sus tres impactos en 90 segundos. La clase vota si los impactos son **reales y específicos** o si son genéricos —vale "creará empleo a tres jóvenes del barrio", no vale "contribuirá al empleo"—. Los equipos con impactos genéricos los reformulan para la siguiente sesión hasta tener impactos verificables. Duración total: 45-60 min.
  </Fragment>
</MirarFora>
...
- tipo: concept
  eyebrow: El caso
  title: Destina el 100 % de sus beneficios a llevar agua potable. ¿Es empresa o es ONG?
  body: "Auara es una empresa social española fundada en 2016 que vende agua mineral envasada en plástico cien por cien reciclado. Todo su beneficio va a proyectos de acceso a agua potable en comunidades sin red: más de cien proyectos y 250.000 personas hasta 2024. Factura, contrata, paga impuestos y compite en el lineal con Font Vella y Solán de Cabras."
  pull: ¿Puede una empresa renunciar deliberadamente al beneficio para sus accionistas sin morir en el intento?
- tipo: section
  title: La propuesta de valor nace de una necesidad local
  subtitle: La pregunta que da sentido a todo el curso. No qué gana vuestro proyecto, sino qué le devuelve al sitio donde nace.
- tipo: concept
  eyebrow: Idea clave
  title: La empresa global piensa, el proyecto local resuelve
  body: "Casi cualquier producto puede venir hoy de cualquier parte del mundo. Pero la mayoría de necesidades cotidianas se viven en un sitio concreto: un barrio sin taller de bicis, un pueblo cuyos mayores no tienen quien les lleve la compra, una zona agrícola que tira un excedente que nadie aprovecha. Un proyecto local lo entiende mejor que una gran empresa lejana."
  pull: "La pregunta que valida un proyecto no es «¿esto se puede vender?», sino «¿qué necesidad de mi entorno resuelve, y por qué yo, aquí, lo hago mejor?»."
- tipo: concept
  eyebrow: Desarrollo económico local
  title: Emprender es, también, hacer territorio
  body: "Cada proyecto que arranca en un pueblo o un barrio hace algo más que vender: ocupa un local que estaba vacío, da una primera oportunidad laboral, anima una calle, retiene talento joven que si no se marcharía. El progreso de un territorio no llega solo desde fuera, ni con una gran fábrica que aterriza ni con subvenciones lejanas."
  pull: Se construye también desde abajo, con muchas iniciativas pequeñas arraigadas en el sitio. Vuestro proyecto, por modesto que sea, es una de esas piezas.
- tipo: section
  title: Que el valor se quede cerca
  subtitle: "Un proyecto mueve dinero: cobra, paga, contrata. La pregunta decisiva para el impacto local es dónde acaba ese dinero."
- tipo: concept
  eyebrow: Concepto clave
  title: Dos proyectos que facturan igual y dejan cosas muy distintas
  body: El primero compra al proveedor del polígono de al lado, contrata a alguien del pueblo y encarga la web a un autónomo de la zona. El segundo compra todo a una gran plataforma de fuera y paga servicios a empresas lejanas. Facturan lo mismo, pero en el primer caso el dinero vuelve a circular en el entorno y en el segundo se evapora casi al instante.
  pull: El retorno local es la parte del gasto que se queda dentro de la economía de proximidad. A mayor retorno, mayor impacto sobre el territorio con la misma facturación.
- tipo: list
  eyebrow: Producción y consumo responsables
  title: Cuatro decisiones que refuerzan el retorno local
  ordered: true
  items:
...
- tipo: figure
  ...
  alt: Puestos de frutas y verduras en el interior del Mercat Central de València, con clientes y comerciantes.
  title: Casi toda la unidad, en una foto
  caption: Comercio de proximidad, producto de temporada y dinero que se queda circulando en el territorio.
  credit: "Foto: Adam Jones, CC BY-SA 2.0 vía Wikimedia Commons"
- tipo: concept
  eyebrow: Economía colaborativa
  title: Compartir en vez de poseerlo todo
  body: "Para un proyecto que arranca con recursos limitados, compartir encaja especialmente bien: un local o un taller con otros emprendedores, un espacio de coworking, maquinaria alquilada en vez de comprada, una plataforma vecinal de intercambio. Abarata el arranque, reduce recursos ociosos y de paso teje red con otros proyectos del entorno."
  pull: Es desarrollo local en estado puro. En vez de que cada cual lo tenga todo, la comunidad aprovecha mejor lo que ya hay.
- tipo: figure
  src: gpe-bach/07/tarongers-petres.jpg
  alt: Campo de naranjos cargados de fruta en Petrés, en el Camp de Morvedre, cerca de Sagunt.
  title: El valor de un cultivo, en su comarca
  caption: Cuando un proyecto compra el cítrico a la citricultura de su propia comarca, ese valor se queda en la zona en lugar de irse.
  credit: "Foto: Nel Fernàndez, CC BY-SA 4.0 vía Wikimedia Commons"
- tipo: concept
  eyebrow: Zuvamesa, Sagunt
  title: Lo que sobra vale dinero si alguien lo mira
  body: "Zuvamesa elabora zumo exprimido con cítricos de la propia Comunitat Valenciana. Lo interesante no es el zumo, sino lo que hace con lo que sobra: aprovecha más del 90 % de sus residuos en lugar de enviarlos al vertedero. Pellets con las cortezas, aceites esenciales prensados de la piel, biogás en una planta propia y certificación Residuo Cero de AENOR."
  pull: "No hace falta ser grande para copiar la lógica. La pregunta «¿qué tiro que alguien podría aprovechar?» vale igual para un proyecto de aula."
- tipo: section
  title: La huella ecológica de tu proyecto
  subtitle: Toda actividad consume recursos y genera residuos. Reconocerlo no es un castigo, es información para decidir mejor.
- tipo: list
  eyebrow: Tres preguntas bastan para empezar
  title: Dónde aprieta vuestro proyecto
  items:
...
- tipo: diagram
  ...
  caption: El modelo lineal extrae, fabrica, usa y tira. El circular cierra el ciclo para que los materiales vuelvan a entrar.
- tipo: list
  eyebrow: Reciclar es solo una parte
  title: Pensar vuestro proyecto en circular
  ordered: true
  items:
...
- tipo: figure
  ...
  alt: Contenedores soterrados de recogida selectiva de residuos urbanos en una calle de Gandía.
  title: El primer eslabón del ciclo
  caption: Lo que se separa bien puede volver a ser materia prima. Pero el reto de un proyecto es diseñar antes para generar menos.
  credit: "Foto: Zarateman, CC0 vía Wikimedia Commons"
- tipo: concept
  eyebrow: Comunitat Valenciana, Ley 5/2022
  title: Donde hay un residuo mal aprovechado hay una oportunidad
  body: Desde 2022 la Comunitat Valenciana tiene ley propia de economía circular y una agencia autonómica de residuos. En paralelo, sistemas como Reciclos han llevado a València máquinas y contenedores con código QR que recompensan por reciclar envases. Más allá de la anécdota, lo interesante es el cambio de marco.
  pull: Lo que antes era basura que alguien recoge se está convirtiendo en un recurso con valor, con reglas, incentivos y un mercado alrededor.
- tipo: concept
  eyebrow: Consumo sostenible
  title: Lo que compráis para producir también decide
  body: La economía circular no es solo lo que producís, sino lo que consumís para producirlo. En el aprovisionamiento significa elegir materiales reciclados o reciclables, proveedores con buenas prácticas, producto de temporada y de cercanía, menos embalaje. Cada decisión de compra es, en pequeño, un voto por un tipo de economía.
  pull: "Y comprar de proximidad une los dos objetivos de esta unidad a la vez: menos huella de transporte y más retorno local."
- tipo: section
  title: Valor compartido y ODS
  subtitle: "La idea que une las dos mitades: un proyecto no tiene por qué elegir entre ganar dinero y hacer el bien si está bien diseñado."
- tipo: concept
  eyebrow: Idea clave
  title: Ganar y aportar como la misma cosa
  body: Crear valor compartido significa que el proyecto genera valor económico para sí mismo y, al mismo tiempo, valor social y ambiental para su entorno. No es filantropía, que regala parte del beneficio después, ni lavado de imagen. Es diseñar el negocio de manera que su forma de ganar dinero sea, en sí misma, beneficiosa.
  pull: Un proyecto que da empleo local, compra de proximidad y aprovecha sus residuos no está siendo bueno a costa de su rentabilidad. La está construyendo sobre esa base.
- tipo: split
  eyebrow: Anclar el proyecto, con honestidad
  title: Uno o dos ODS, no diecisiete logos
  left:
    h: Cómo se hace bien
    items:
...
- tipo: quiz
  ...
  pregunta: Vuestro proyecto repara y revende bicicletas usadas del barrio, con piezas recuperadas y un taller compartido. ¿Qué genera principalmente?
  opciones:
    - Filantropía, porque regala parte del beneficio a la comunidad
    - Valor compartido, porque su forma de ganar dinero es en sí misma beneficiosa
    - Lavado de imagen, porque usa la sostenibilidad como reclamo comercial
    - Solo retorno local, porque el impacto ambiental es indirecto
  correcta: "1"
  explicacion: "No hay reparto posterior de beneficio ni un mensaje añadido encima: el propio modelo alarga la vida de un producto, recupera piezas y mantiene el gasto en el barrio. Ganar dinero y aportar son aquí la misma operación."
- tipo: concept
  eyebrow: Volviendo a Auara
  title: La empresa social, y por qué esto no es un gesto bonito
  body: "Auara es una empresa social: forma jurídica empresarial —factura, paga impuestos, contrata, asume riesgo— con una finalidad principal distinta del beneficio para los accionistas. Y hay un dato de fondo que cambia el debate: en torno al 30 % de millennials y Gen Z declara preferir trabajar en empresas con propósito, según las encuestas Deloitte de los últimos años."
  pull: Esa preferencia reconfigura quién captura el mejor talento y quién retiene mejor a sus clientes. Es más fácil construir un proyecto con propósito que injertárselo cuando ya rueda.
- tipo: list
  eyebrow: Puente al cuaderno
  title: Con esto cerráis el análisis de impacto de la Fase 4
  items:
