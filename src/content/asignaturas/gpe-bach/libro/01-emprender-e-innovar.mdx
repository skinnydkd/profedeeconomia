...
*Gestión de Proyectos de Emprendimiento* es una materia optativa de oferta obligatoria de Bachillerato **propia de la Comunitat Valenciana** (Decret 108/2022): **no tiene base estatal en el Real Decreto 243/2022**. Su única referencia curricular es el currículo autonómico (DOGV / Decret 108/2022). Los centros de otras comunidades pueden no ofrecerla o disponer de optativas equivalentes con otra estructura, por lo que conviene consultar la normativa autonómica correspondiente.
</Callout>
