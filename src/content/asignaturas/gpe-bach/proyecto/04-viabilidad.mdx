...
entregable: "Presupuesto, cuenta de resultados previsional, punto muerto y análisis de impacto (económico, social y ambiental)."
...
unidades_relacionadas:
  - { asignatura: gpe-bach, unidad: 6, nota: "Contabilidad, fiscalidad y financiación" }
  - { asignatura: gpe-bach, unidad: 7, nota: "Impacto social y ambiental" }
cuaderno:
  tarea: "Calculad el <strong>punto muerto</strong> de vuestro proyecto: cuántas unidades tenéis que vender para no perder dinero. Rellenad la plantilla con vuestros costes fijos, precio y coste variable unitario."
  reflexion: "¿El punto muerto que os sale es alcanzable de verdad con vuestra clientela, o necesitáis vender una cantidad imposible?"
  orientacion_docente: "El error más común es contar solo la viabilidad económica. Exigid las tres viabilidades: económica, social y ambiental. Y separad beneficio de caja: se puede tener beneficio en la cuenta de resultados y quedarse sin dinero para pagar a fin de mes."
  plantilla:
    tipo: punto-muerto
lang: es
estado: publicado
...
<EnEstaFase
  haras="Hacer los números del proyecto: presupuesto, cuenta de resultados, punto muerto y financiación; y comprobar que también es viable social y ambientalmente."
  entregable="Números del proyecto + análisis de impacto"
  sesiones="4-5 sesiones"
>
Repasad de la **Unidad 6** la cuenta de resultados y el punto muerto, y de la **Unidad 7** el impacto social y ambiental.
</EnEstaFase>
...
<CasoReal
  titular="La Fageda: rentable y, a la vez, con impacto social real"
  fuente="Fuentes públicas sobre La Fageda, cooperativa de La Garrotxa (Girona): web corporativa y prensa"
  pregunta="¿Vuestro proyecto sería viable contando también su impacto social y ambiental, no solo el económico?"
>
La Fageda es una cooperativa catalana que vende yogures y postres lácteos en un mercado muy competitivo, frente a grandes marcas, y se sostiene económicamente con sus propias ventas. No vive de donaciones: compite y vende.

Y lo hace mientras su misión social —dar trabajo digno a personas con discapacidad o trastorno mental de su comarca— es el núcleo del proyecto, no un añadido para quedar bien. La lección es que en GPE la viabilidad es triple: un proyecto rentable que daña su entorno no es viable, y uno que mejora su comunidad mientras se sostiene es justo lo que la materia busca.
</CasoReal>
...
<ErroresQueCuestan>
- **Contar solo la viabilidad económica y olvidar la social y ambiental.** Un proyecto puede salir rentable sobre el papel y, aun así, no ser viable en GPE si daña su entorno o no aporta nada a la comunidad.
- **Ingresos optimistas sin calcular el punto muerto.** Esperar vender mucho más de lo que el mercado permite hincha la cuenta de resultados; sin el punto muerto no sabéis cuánto hay que vender de verdad para no perder.
- **Confundir beneficio con caja.** Se puede tener beneficio en la cuenta de resultados y, al mismo tiempo, no tener dinero en la cuenta para pagar a proveedores o nóminas a fin de mes.
</ErroresQueCuestan>
