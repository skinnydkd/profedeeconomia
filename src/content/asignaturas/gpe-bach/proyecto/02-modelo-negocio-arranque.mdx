...
La Unidad 3 del libro explica las **formas jurídicas básicas**, los criterios de **localización y dimensión** y los **trámites de constitución y el PAE**. El modelo de negocio se apoya además en lo visto en la Unidad 2. No repetimos esa teoría: tenedla a mano para decidir con fundamento, no a ojo.
</Callout>
