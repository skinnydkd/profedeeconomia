...
- **Tasa de actividad** = `(activos / población de 16 años o más) × 100`. Mide qué porcentaje de la población en edad de trabajar **participa** en el mercado laboral (ya sea trabajando o buscando trabajo). En España ronda el **58-59 %** en 2024.
- **Tasa de paro** = `(parados / activos) × 100`. Es la cifra que más se cita en los medios. **Importante**: el denominador son los activos, no la población total. En España ronda el **11-12 %** en 2024.
- **Tasa de empleo** = `(ocupados / población de 16 años o más) × 100`. Mide qué porcentaje de la población en edad de trabajar **está efectivamente trabajando**. En España ronda el **51-52 %** en 2024.
...
España experimentó entre 2017 y 2024 una de las **subidas más rápidas del SMI** en la UE: pasó de **735,90 €/mes** en 2017 a **1 134 €/mes** en 14 pagas en 2024, un **+54 %** en siete años. El cuadro siguiente recoge las subidas escalón a escalón:
...
Quedan pendientes problemas serios que ninguna reforma ha resuelto: el **paro juvenil** sigue duplicando la media europea (en torno al **27 %** en 2024 frente al **14 %** UE), el **paro de larga duración** afecta a más del **40 %** de los parados, y la **productividad laboral** española sigue por debajo de la media europea (España produce aproximadamente **80 %** del valor por hora trabajada que Alemania).
...
- El **SMI** subió en España un +54 % entre 2017 y 2024 (de 707 € a 1 134 €). La teoría neoclásica predice destrucción de empleo; la evidencia empírica (Card-Krueger; AIReF, BdE) muestra efectos pequeños sobre el empleo agregado y reducción real de la desigualdad salarial en el extremo inferior.
