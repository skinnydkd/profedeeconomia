...
- tipo: concept
  ...
  body: "En el primer semestre de 2020 el PIB español cayó un 22 % acumulado. El paro saltó por encima del 16 %, miles de empresas cerraron y los hogares perdieron ingresos de golpe. Pero el rebote también fue rápido: a finales de 2021 casi se había recuperado el nivel previo. Ningún ciclo económico clásico explicaba una caída y un rebote tan abruptos."
  pull: Si el modelo AD-AS no explica del todo la COVID, ¿es porque el modelo es malo o porque aquel shock fue excepcional?
- tipo: section
