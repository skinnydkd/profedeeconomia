...
España cerró 2024 con un déficit del **3,0 % del PIB** y una deuda pública en torno al **107 % del PIB**, según datos del Banco de España y la AIReF. El déficit ha bajado significativamente desde los picos de la pandemia (10,1 % en 2020), pero la deuda sigue muy por encima del nivel pre-Covid (98 %) y del umbral del 60 % que marca el Pacto de Estabilidad. El **servicio de la deuda** —los intereses que el Estado paga cada año a sus acreedores— ha pasado de unos 25 000 M€ a unos 40 000 M€ entre 2021 y 2024 a consecuencia de la subida de tipos del BCE, comprimiendo el margen presupuestario para otras políticas.
...
<SolvedExercise number="11.2" title="Efecto de una subida de tipos sobre la cuota hipotecaria">
...
### QE y QT en la zona euro: 2015-2024

La política monetaria del BCE atraviesa tres grandes fases recientes:

- **2015-2019 (QE convencional).** Tras la crisis del euro y con inflación persistentemente baja (1 %), el BCE lanza el PSPP en marzo de 2015. Compra deuda pública por unos 2,6 billones de euros hasta finales de 2018. Los tipos oficiales se mantienen en mínimos históricos (MRO al 0 %, depósito al −0,4 %).
...
- **Desde 2022 (QT y subida de tipos).** Con la inflación disparada (10,6 % en octubre de 2022, máximo de la serie histórica del IPCA), el BCE invierte el rumbo: sube tipos del 0 % al 4,5 % en catorce meses y empieza a no reinvertir la deuda vencida. A partir de junio de 2024, una vez la inflación vuelve a niveles cercanos al 2 %, comienza una bajada gradual y cautelosa de tipos.
...
- **Política fiscal**: gasto e impuestos. El **multiplicador del gasto** k = 1/(1−c) muestra que un euro público mueve más PIB que su valor nominal. España 2024: déficit 3,0 %, deuda 107 % del PIB; nueva regla fiscal europea con sendas plurianuales.
...
6. Krugman, P. y Wells, R. (2021). *Macroeconomía*. Reverté, 4ª ed.
7. Blanchard, O. (2021). *Macroeconomía*. Pearson, 8ª ed.
