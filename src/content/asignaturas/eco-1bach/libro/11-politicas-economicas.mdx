...
<RecursoDestacado href="/eco-1bach/recursos/multiplicador-gasto/" kicker="Herramienta" title="Calculadora del multiplicador del gasto" descripcion="Ajusta la propensión marginal al consumo y un aumento del gasto para ver el multiplicador, el efecto total sobre la renta y la cascada de rondas que lo produce." colorVar="--color-eco1" />
...
- tipo: timeline
  eyebrow: "El caso"
  title: "Del 0 % al 4,5 % en dieciocho meses"
  hitos:
    - fecha: "Julio 2022"
      hito: "El BCE inicia la subida más rápida de su historia"
      detalle: "Tras una década de tipos cercanos a cero."
    - fecha: "Octubre 2022"
      hito: "La inflación toca el 10,6 % interanual"
      detalle: "El máximo de la serie en la zona euro."
    - fecha: "Febrero 2024"
      hito: "La inflación baja al 2,5 %"
      detalle: "¿Por la subida de tipos, o por normalizarse el gas y las cadenas de suministro?"
- tipo: section
  title: Positiva y normativa
  subtitle: Antes de hablar de instrumentos conviene saber si estamos discutiendo sobre hechos o sobre valores. Confundirlos envenena el debate público.
- tipo: terms
  eyebrow: Dos planos distintos
  title: Describir y prescribir
  terms:
    - t: Economía positiva
      d: Describe cómo funciona la economía con enunciados contrastables con datos. Se puede estar de acuerdo o no apelando a la evidencia, no a las convicciones.
    - t: Economía normativa
      d: "Juzga qué debería hacerse a partir de valores que no salen del modelo, sino de fuera: equidad, libertad, sostenibilidad, dignidad."
- tipo: quiz
  eyebrow: Comprueba que lo has pillado
  pregunta: "«Una subida del salario mínimo del 10 % reduciría el empleo juvenil entre un 1 % y un 3 %». ¿Qué tipo de enunciado es?"
  opciones:
    - Normativo, porque habla de una política pública concreta
    - Normativo, porque el salario mínimo es un tema controvertido
    - Positivo, porque es una predicción empírica que los datos pueden confirmar o refutar
    - Ninguno de los dos, porque habla del futuro y el futuro no se puede medir
  correcta: "2"
  explicacion: "Que un tema sea polémico no lo hace normativo. La frase predice una magnitud y se discute con datos. Sería normativo decir que el salario mínimo debe subir hasta el 60 % del mediano: ahí hay un juicio de valor."
- tipo: list
  eyebrow: Por qué interviene el Estado
  title: Cuatro justificaciones técnicas
  ordered: true
  items:
...
- tipo: section
  ...
  subtitle: La palanca del Gobierno. Se ejerce con el presupuesto, y su efecto depende de en qué tramo de la oferta esté la economía.
- tipo: figure
  src: eco-1bach/11/congreso-diputados-madrid.jpg
  alt: Fachada principal del Congreso de los Diputados en la carrera de San Jerónimo de Madrid, con sus leones de bronce y su pórtico clásico.
  title: Donde se aprueba la palanca
  caption: Los Presupuestos Generales del Estado son el instrumento más potente de política económica en manos de un gobierno.
  credit: "Foto: Luis García, CC BY-SA 3.0 vía Wikimedia Commons"
- tipo: split
  title: Los dos lados del presupuesto
  left:
    h: Gasto público
    items:
...
- tipo: concept
  eyebrow: Expansiva y restrictiva
  title: El efecto depende de dónde esté la economía
  body: Una política fiscal expansiva sube el gasto o baja los impuestos y desplaza la demanda agregada a la derecha. Pero el resultado no es siempre el mismo. Si la economía está en el tramo horizontal de la oferta, con paro y capacidad ociosa, casi todo el efecto va a producción. Si está en pleno empleo, casi todo va a precios sin ganar un euro de PIB real.
  pull: "Estimular una economía recalentada no crea empleo: crea inflación. El mismo instrumento da resultados opuestos según el momento del ciclo."
- tipo: diagram
  diagrama: MultiplicadorFiscal
  caption: Un euro público se convierte en renta de alguien que consume parte, y esa cadena de rondas multiplica el efecto inicial.
- tipo: concept
  eyebrow: "k = 1 / (1 − c)"
  title: Por qué un euro público mueve más de un euro de PIB
  body: Si la propensión marginal al consumo es 0,7, el multiplicador vale 3,33. En la práctica, en economías abiertas y con impuestos, se sitúa entre 0,5 y 1,5 según el tipo de gasto, porque parte de la renta se filtra hacia importaciones y hacia la recaudación. La lógica se mantiene aunque la cifra baje.
  pull: El multiplicador es mayor cuando se invierte en algo que se produce dentro y menor cuando el dinero acaba comprando bienes importados.
- tipo: exercise
  title: Calcular déficit, deuda y saldo primario
  enunciado: "Un país ingresa 360 mil millones y gasta 440, de los cuales 35 son intereses de la deuda. Su PIB es de 1.200 y arrastra una deuda acumulada de 760 a 1 de enero. Calcula el saldo presupuestario en euros y en porcentaje del PIB, la ratio de deuda al inicio y al final, y el saldo primario."
  pasos:
...
- tipo: data
  numero: 102-103 %
  label: deuda pública española sobre el PIB
  title: El stock que dejaron los flujos
  detalle: "España cerró 2025 con un déficit del 2,7-2,8 % y una deuda del 102-103 %, sobre el 98 % pre-Covid y lejos del umbral del 60 %. El servicio de la deuda pasó de 25.000 M€ en 2021 a unos 40.000 M€ en 2024."
- tipo: concept
  eyebrow: La curva de la servilleta
  title: Subir el tipo no siempre significa recaudar más
  body: "Laffer dibujó en 1974, en una servilleta de restaurante, una idea sencilla: con un tipo del 0 % no se recauda nada, y con uno del 100 % tampoco, porque nadie trabaja si no se queda con nada. Entre ambos hay un máximo. Pasado ese punto, subir más reduce lo recaudado porque cae la base imponible: menos trabajo, más fraude, más economía sumergida."
  pull: La curva no dice que cualquier subida sea contraproducente. Dice que existe un punto óptimo, y dónde esté es una cuestión empírica que depende del país.
- tipo: list
  eyebrow: Cuatro pilares
  title: Qué financia el Estado del bienestar
  items:
...
- tipo: terms
  eyebrow: Dos modelos de pensiones
  title: Bismarck y Beveridge
  terms:
    - t: Reparto contributivo
      d: Las cotizaciones de quien trabaja hoy pagan las pensiones de quien está jubilado hoy, y la cuantía depende de lo cotizado. Es el modelo español, alemán, francés e italiano.
    - t: Universal asistencial
      d: El Estado garantiza una pensión básica a toda la población anciana con impuestos generales. Pensiones más planas y menos ligadas al historial laboral.
- tipo: section
  title: Política monetaria
  subtitle: La palanca del BCE. Objetivo primario, una inflación del 2 % a medio plazo medida con el índice armonizado.
- tipo: list
  eyebrow: Precio y cantidad
  title: Con qué actúa el BCE
  items:
...
- tipo: diagram
  ...
  caption: Del tipo oficial al crédito, de ahí a inversión y consumo, luego a la demanda agregada y al final al PIB y los precios.
- tipo: table
  eyebrow: Zona euro, 2015-2026
  title: Cuatro fases en once años
  head:
    - Fase
    - Qué hizo el BCE
    - Tipos
  rows:
    - - "2015-2019"
      - "QE convencional: 2,6 billones en deuda pública"
      - "MRO 0 %"
    - - "2020-2022"
      - "PEPP contra la fragmentación: 1,85 billones"
      - Ultraexpansivos
    - - "2022-2024"
      - Subida agresiva y comienzo del QT
      - "Hasta 4,5 %"
    - - Desde 2024
      - Ciclo de bajadas manteniendo el QT
      - "Depósito 2,25 %"
  caption: La subida de 2022-2023 fue el viraje restrictivo más rápido de toda la historia del euro.
- tipo: figure
  src: eco-1bach/11/mario-draghi.jpg
  alt: Retrato de Mario Draghi, presidente del Banco Central Europeo entre 2011 y 2019, con traje formal y corbata azul oscuro.
  title: Londres, 26 de julio de 2012
  caption: La prima de riesgo española pasaba de 600 puntos y los mercados apostaban abiertamente por la ruptura del euro.
  credit: "Foto: Aron Urb (EU2017EE), CC BY 2.0 vía Wikimedia Commons"
- tipo: concept
  eyebrow: Whatever it takes
  title: Tres frases que valieron más que mil millones
  ...
  pull: La política monetaria moderna funciona también, y a veces sobre todo, a través de las expectativas. Una promesa creíble puede bastar.
- tipo: section
  title: Inflación
  subtitle: La política monetaria existe en gran medida para controlarla. Conviene entonces distinguir por dónde llega, porque el remedio cambia.
- tipo: figure
  src: eco-1bach/11/milton-friedman.jpg
  alt: Retrato fotográfico del economista estadounidense Milton Friedman, premio Nobel de Economía en 1976.
  title: Milton Friedman (1912-2006)
  caption: Su tesis de que la inflación es siempre y en todas partes un fenómeno monetario dio forma a los bancos centrales independientes.
  credit: "Foto: The Friedman Foundation for Educational Choice, dominio público vía Wikimedia Commons"
- tipo: list
  eyebrow: Tres mecanismos distintos
  title: Por dónde llega la subida de precios
  ordered: true
  items:
...
- tipo: concept
  eyebrow: Anatomía de 2022-2023
  title: El peor episodio inflacionario desde los setenta
  body: "El índice armonizado tocó el 10,6 % en la zona euro en octubre de 2022 y el 10,8 % en España en julio. Se combinaron tres cosas: cadenas de suministro rotas tras la reapertura, la guerra de Ucrania disparando gas, petróleo, cereales y fertilizantes, y el ahorro acumulado en confinamiento liberándose de golpe sobre mercados ya tensionados."
  pull: Dos componentes de costes y uno de demanda a la vez. Por eso ninguna receta única servía y el debate sobre la respuesta sigue vivo.
- tipo: list
  eyebrow: La respuesta española
  title: Qué hizo el escudo social de 2022
  items:
...
- tipo: figure
  ...
  alt: Retrato oficial de Christine Lagarde, presidenta del Banco Central Europeo desde noviembre de 2019, sobre fondo neutro.
  title: Tres manuales en un solo mandato
  caption: Le tocaron la expansión de la pandemia, el ajuste más rápido de la historia del euro y la normalización posterior.
  credit: "Foto: Lemrich / European Central Bank, licencia de atribución"
- tipo: split
  eyebrow: No todos los bancos son iguales
  title: Mandato jerárquico frente a mandato dual
  left:
    h: BCE
    items:
...
- tipo: concept
  eyebrow: La pregunta del principio
  title: Por qué el dilema del BCE no es solo técnico
  body: "En política económica el experimento controlado es imposible: no podemos repetir 2022 sin subida de tipos para ver qué habría pasado. La evidencia sugiere que la subida contribuyó a bajar la inflación, pero parte se explica por la normalización de suministros y la caída del gas. Desconfía tanto de quien atribuye todo el mérito al BCE como de quien se lo niega entero."
  pull: Elegir entre proteger el poder adquisitivo o evitar una recesión es una decisión sobre valores. Reconocer la incertidumbre ya es un avance.
- tipo: recap
  eyebrow: "Repasa"
