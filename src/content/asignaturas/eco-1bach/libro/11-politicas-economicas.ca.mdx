...
<RecursoDestacado href="/eco-1bach/recursos/multiplicador-gasto/" kicker="Ferramenta" title="Calculadora del multiplicador de la despesa" descripcion="Ajusta la propensió marginal al consum i un augment de la despesa per a vore el multiplicador, l'efecte total sobre la renda i la cascada de rondes que el produïx." colorVar="--color-eco1" />
...
- tipo: curriculum
  ...
  saberes:
    - "Bloc D: política fiscal, ingressos i despesa pública."
    - "Bloc D: política monetària i el BCE."
  competencias:
    - "Valorar l'efecte de les polítiques fiscal i monetària sobre l'activitat econòmica."
- tipo: timeline
  eyebrow: "El cas"
  title: "Del 0 % al 4,5 % en díhuit mesos"
  hitos:
    - fecha: "Juliol 2022"
      hito: "El BCE inicia la pujada més ràpida de la història"
      detalle: "Després d'una dècada de tipus pròxims a zero."
    - fecha: "Octubre 2022"
      hito: "La inflació toca el 10,6 % interanual"
      detalle: "El màxim de la sèrie a la zona euro."
    - fecha: "Febrer 2024"
      hito: "La inflació baixa al 2,5 %"
      detalle: "Per la pujada de tipus, o per normalitzar-se el gas i les cadenes de subministrament?"
- tipo: section
  title: Positiva i normativa
  subtitle: Abans de parlar d'instruments convé saber si estem discutint sobre fets o sobre valors. Confondre-ho enverina el debat públic.
- tipo: terms
  eyebrow: Dos plans distints
  title: Descriure i prescriure
  terms:
    - t: Economia positiva
      d: Descriu com funciona l'economia amb enunciats contrastables amb dades. Es pot estar d'acord o no apel·lant a l'evidència, no a les conviccions.
    - t: Economia normativa
      d: "Jutja què s'hauria de fer a partir de valors que no ixen del model, sinó de fora: equitat, llibertat, sostenibilitat, dignitat."
- tipo: quiz
  eyebrow: Comprova que ho has pillat
  pregunta: "«Una pujada del salari mínim del 10 % reduiria l'ocupació juvenil entre un 1 % i un 3 %». Quin tipus d'enunciat és?"
  opciones:
    - Normatiu, perquè parla d'una política pública concreta
    - Normatiu, perquè el salari mínim és un tema controvertit
    - Positiu, perquè és una predicció empírica que les dades poden confirmar o refutar
    - Cap dels dos, perquè parla del futur i el futur no es pot mesurar
  correcta: "2"
  explicacion: "Que un tema siga polèmic no el fa normatiu. La frase prediu una magnitud i es discutix amb dades. Seria normatiu dir que el salari mínim ha de pujar fins al 60 % del mitjà: ací sí que hi ha un judici de valor."
- tipo: list
  eyebrow: Per què intervé l'Estat
  title: Quatre justificacions tècniques
  ordered: true
  items:
    - "Corregir fallades de mercat: externalitats, béns públics, informació asimètrica i poder de mercat."
    - "Estabilitzar el cicle: suavitzar recessions i refredar sobreescalfaments per a abaratir el cost social."
    - "Redistribuir: un mercat eficient pot ser molt desigual, i això no ho corregix ell tot sol."
    - "Proveir béns públics i preferents: defensa i justícia, però també sanitat, educació i cultura."
- tipo: section
  title: Política fiscal
  subtitle: La palanca del Govern. S'exercix amb el pressupost, i el seu efecte depén de en quin tram de l'oferta estiga l'economia.
- tipo: figure
  src: eco-1bach/11/congreso-diputados-madrid.jpg
  alt: Façana principal del Congrés dels Diputats a la carrera de San Jerónimo de Madrid, amb els seus lleons de bronze i el pòrtic clàssic.
  title: On s'aprova la palanca
  caption: Els Pressupostos Generals de l'Estat són l'instrument més potent de política econòmica en mans d'un govern.
  credit: "Foto: Luis García, CC BY-SA 3.0 via Wikimedia Commons"
- tipo: split
  title: Els dos costats del pressupost
  left:
    h: Despesa pública
    items:
      - "Consum públic i inversió: les que més arrosseguen ocupació i activitat"
      - "Transferències com pensions o atur: es filtren en part a l'estalvi"
      - "Interessos del deute: pura transferència cap als creditors"
  right:
    h: Impostos
    items:
      - "Directes (IRPF, Societats): permeten aplicar progressivitat"
      - "Indirectes (IVA, especials): fàcils de recaptar però regressius"
      - Les rendes baixes dediquen al consum una proporció major del seu ingrés
- tipo: concept
  eyebrow: Expansiva i restrictiva
  title: L'efecte depén d'on estiga l'economia
  body: Una política fiscal expansiva puja la despesa o baixa els impostos i desplaça la demanda agregada a la dreta. Però el resultat no és sempre el mateix. Si l'economia està en el tram horitzontal de l'oferta, amb atur i capacitat ociosa, quasi tot l'efecte va a producció. Si està en plena ocupació, quasi tot va a preus sense guanyar un euro de PIB real.
  pull: "Estimular una economia sobreescalfada no crea ocupació: crea inflació. El mateix instrument dona resultats oposats segons el moment del cicle."
- tipo: diagram
  diagrama: MultiplicadorFiscal
  caption: Un euro públic es convertix en renda d'algú que en consumix una part, i eixa cadena de rondes multiplica l'efecte inicial.
- tipo: concept
  eyebrow: "k = 1 / (1 − c)"
  title: Per què un euro públic mou més d'un euro de PIB
  body: Si la propensió marginal al consum és 0,7, el multiplicador val 3,33. A la pràctica, en economies obertes i amb impostos, se situa entre 0,5 i 1,5 segons el tipus de despesa, perquè part de la renda es filtra cap a importacions i cap a la recaptació. La lògica es manté encara que la xifra baixe.
  pull: El multiplicador és major quan s'invertix en una cosa que es produïx dins i menor quan els diners acaben comprant béns importats.
- tipo: exercise
  title: Calcular dèficit, deute i saldo primari
  enunciado: "Un país ingressa 360 mil milions i gasta 440, dels quals 35 són interessos del deute. El seu PIB és de 1.200 i arrossega un deute acumulat de 760 a 1 de gener. Calcula el saldo pressupostari en euros i en percentatge del PIB, la ràtio de deute a l'inici i al final, i el saldo primari."
  pasos:
    - Resta despeses d'ingressos i expressa el resultat en percentatge del PIB.
    - Compara eixa xifra amb el 3 % de referència europea.
    - Suma el dèficit de l'any al deute inicial i recalcula la ràtio.
    - Exclou els interessos per a obtindre el saldo primari.
    - Interpreta què significa que el saldo primari també siga negatiu.
- tipo: data
  numero: 102-103 %
  label: deute públic espanyol sobre el PIB
  title: L'estoc que van deixar els fluxos
  detalle: "Espanya va tancar el 2025 amb un dèficit del 2,7-2,8 % i un deute del 102-103 %, sobre el 98 % pre-Covid i lluny del llindar del 60 %. El servici del deute va passar de 25.000 M€ el 2021 a uns 40.000 M€ el 2024."
- tipo: concept
  eyebrow: La corba del tovalló
  title: Pujar el tipus no sempre significa recaptar més
  body: "Laffer va dibuixar el 1974, en un tovalló de restaurant, una idea senzilla: amb un tipus del 0 % no es recapta res, i amb un del 100 % tampoc, perquè ningú treballa si no es queda amb res. Entre tots dos hi ha un màxim. Passat eixe punt, pujar més reduïx el recaptat perquè cau la base imposable: menys treball, més frau, més economia submergida."
  pull: La corba no diu que qualsevol pujada siga contraproduent. Diu que hi ha un punt òptim, i on estiga és una qüestió empírica que depén del país.
- tipo: list
  eyebrow: Quatre pilars
  title: Què finança l'Estat del benestar
  items:
    - "Sanitat universal, gratuïta en el punt d'ús i finançada amb impostos generals: model Beveridge."
    - Educació pública obligatòria i gratuïta fins als 16 anys, amb finançament majoritari després.
    - Pensions contributives i no contributives, finançades sobretot amb cotitzacions socials.
    - "Atenció a la dependència, regulada a Espanya per la Llei 39/2006."
    - "La despesa en protecció social ronda el 28 % del PIB, en la mitjana de la UE però davall França o Finlàndia."
- tipo: terms
  eyebrow: Dos models de pensions
  title: Bismarck i Beveridge
  terms:
    - t: Repartiment contributiu
      d: Les cotitzacions de qui treballa hui paguen les pensions de qui està jubilat hui, i la quantia depén del cotitzat. És el model espanyol, alemany, francés i italià.
    - t: Universal assistencial
      d: L'Estat garantix una pensió bàsica a tota la població anciana amb impostos generals. Pensions més planes i menys lligades a l'historial laboral.
- tipo: section
  title: Política monetària
  subtitle: La palanca del BCE. Objectiu primari, una inflació del 2 % a mitjà termini mesurada amb l'índex harmonitzat.
- tipo: list
  eyebrow: Preu i quantitat
  title: Amb què actua el BCE
  items:
    - "Operacions principals de finançament: subhastes setmanals on la banca obté liquiditat contra col·lateral."
    - "Facilitat marginal de crèdit: préstec a un dia sense subhasta. És el sostre del corredor de tipus."
    - "Facilitat de depòsit: el que la banca cobra per aparcar reserves. És el sòl, i la referència més seguida."
    - "Compres d'actius (QE): injecten liquiditat i baixen els tipus a llarg termini comprant deute al secundari."
    - "Reducció de balanç (QT): deixar véncer el deute comprat sense reinvertir-lo, drenant liquiditat del sistema."
- tipo: diagram
  diagrama: TransmisionMonetaria
  caption: Del tipus oficial al crèdit, d'ací a inversió i consum, després a la demanda agregada i al final al PIB i els preus.
- tipo: table
  eyebrow: Zona euro, 2015-2026
  title: Quatre fases en onze anys
  head:
    - Fase
    - Què va fer el BCE
    - Tipus
  rows:
    - - "2015-2019"
      - "QE convencional: 2,6 bilions en deute públic"
      - "MRO 0 %"
    - - "2020-2022"
      - "PEPP contra la fragmentació: 1,85 bilions"
      - Ultraexpansius
    - - "2022-2024"
      - Pujada agressiva i començament del QT
      - "Fins al 4,5 %"
    - - Des del 2024
      - Cicle de baixades mantenint el QT
      - "Depòsit 2,25 %"
  caption: La pujada del 2022-2023 va ser el viratge restrictiu més ràpid de tota la història de l'euro.
- tipo: figure
  src: eco-1bach/11/mario-draghi.jpg
  alt: Retrat de Mario Draghi, president del Banc Central Europeu entre 2011 i 2019, amb trage formal i corbata blau fosc.
  title: Londres, 26 de juliol del 2012
  caption: La prima de risc espanyola passava de 600 punts i els mercats apostaven obertament per la ruptura de l'euro.
  credit: "Foto: Aron Urb (EU2017EE), CC BY 2.0 via Wikimedia Commons"
- tipo: concept
  eyebrow: Whatever it takes
  title: Tres frases que van valdre més que mil milions
  body: Draghi va dir davant d'inversors que, dins del seu mandat, el BCE estava disposat a fer el que calguera per a preservar l'euro, i que seria suficient. Les primes de risc van començar a caure eixe mateix dia sense que el BCE comprara ni un bo addicional. Setmanes després va formalitzar el programa OMT, que mai es va arribar a activar però va quedar com una assegurança implícita.
  pull: La política monetària moderna funciona també, i a vegades sobretot, a través de les expectatives. Una promesa creïble pot bastar.
- tipo: section
  title: Inflació
  subtitle: La política monetària existix en gran manera per a controlar-la. Convé llavors distingir per on arriba, perquè el remei canvia.
- tipo: figure
  src: eco-1bach/11/milton-friedman.jpg
  alt: Retrat fotogràfic de l'economista estatunidenc Milton Friedman, premi Nobel d'Economia el 1976.
  title: Milton Friedman (1912-2006)
  caption: La seua tesi que la inflació és sempre i pertot arreu un fenomen monetari va donar forma als bancs centrals independents.
  credit: "Foto: The Friedman Foundation for Educational Choice, domini públic via Wikimedia Commons"
- tipo: list
  eyebrow: Tres mecanismes distints
  title: Per on arriba la pujada de preus
  ordered: true
  items:
    - "De demanda: la demanda agregada creix més ràpid que la capacitat productiva. Es corregix refredant."
    - "De costos: un shock encarix energia o matèries primeres. L'oferta es desplaça i pugen preus amb menys producció."
    - "Espiral salaris-preus: els salaris perseguixen els preus i els preus els salaris, sense final."
    - El que temen els bancs centrals no és la pujada puntual, sinó que s'enquiste en les expectatives i en els convenis.
- tipo: concept
  eyebrow: Anatomia del 2022-2023
  title: El pitjor episodi inflacionari des dels setanta
  body: "L'índex harmonitzat va tocar el 10,6 % a la zona euro l'octubre del 2022 i el 10,8 % a Espanya al juliol. S'hi van combinar tres coses: cadenes de subministrament trencades després de la reobertura, la guerra d'Ucraïna disparant gas, petroli, cereals i fertilitzants, i l'estalvi acumulat en confinament alliberant-se de colp sobre mercats ja tensionats."
  pull: Dos components de costos i un de demanda alhora. Per això cap recepta única servia i el debat sobre la resposta continua viu.
- tipo: list
  eyebrow: La resposta espanyola
  title: Què va fer l'escut social del 2022
  items:
    - Baixada de l'IVA de l'electricitat al 5 % i descomptes generalitzats al transport públic.
    - Bonificació de 20 cèntims per litre de carburant durant bona part del 2022.
    - "Excepció ibèrica: desvincular parcialment el preu majorista de l'electricitat del preu del gas."
    - "El resultat: la inflació espanyola va tancar el 2023 en el 3,2 % front al 5,4 % de la zona euro."
- tipo: figure
  src: eco-1bach/11/christine-lagarde.jpg
  alt: Retrat oficial de Christine Lagarde, presidenta del Banc Central Europeu des del novembre del 2019, sobre fons neutre.
  title: Tres manuals en un sol mandat
  caption: Li van tocar l'expansió de la pandèmia, l'ajust més ràpid de la història de l'euro i la normalització posterior.
  credit: "Foto: Lemrich / European Central Bank, llicència d'atribució"
- tipo: split
  eyebrow: No tots els bancs són iguals
  title: Mandat jeràrquic front a mandat dual
  left:
    h: BCE
    items:
      - "Objectiu primari: l'estabilitat de preus, per damunt de tot"
      - Només sense perjudici d'eixe objectiu dona suport a creixement i ocupació
      - Disseny heretat del Bundesbank i del trauma de la hiperinflació de Weimar
  right:
    h: Reserva Federal
    items:
      - Dos objectius amb el mateix rang, preus estables i ocupació màxima
      - Pot tolerar més inflació si l'ocupació està dèbil
      - La diferència es nota en la velocitat i la duresa de cada ajust
- tipo: concept
  eyebrow: La pregunta del principi
  title: Per què el dilema del BCE no és només tècnic
  body: "En política econòmica l'experiment controlat és impossible: no podem repetir el 2022 sense pujada de tipus per a veure què hauria passat. L'evidència suggerix que la pujada va contribuir a baixar la inflació, però part s'explica per la normalització de subministraments i la caiguda del gas. Desconfia tant de qui atribuïx tot el mèrit al BCE com de qui l'hi nega sencer."
  pull: Triar entre protegir el poder adquisitiu o evitar una recessió és una decisió sobre valors. Reconéixer la incertesa ja és un avanç.
- tipo: recap
  eyebrow: "Repassa"
  title: "Abans de tancar la unitat"
  items:
    - "Sabries separar economia positiva de normativa amb exemples que de veres discriminen."
    - "Sabries enumerar les quatre justificacions tècniques de la intervenció de l'Estat."
    - "Sabries aplicar política fiscal a l'AD-AS i usar el multiplicador keynesià simple."
    - "Sabries llegir el dèficit i el deute amb la regla fiscal europea i la corba de Laffer."
    - "Sabries traçar la política monetària del BCE fins a la quota hipotecària."
    - "Sabries separar inflació de demanda, de costos i estanflació, i explicar 2022-2023."
```
