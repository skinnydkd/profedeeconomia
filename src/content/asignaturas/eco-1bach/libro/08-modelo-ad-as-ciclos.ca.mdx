...
<RecursoDestacado href="/eco-1bach/recursos/simulador-ad-as/" kicker="Simulador" title="Simulador del model AD-AS" descripcion="Manipula xocs de demanda, d'oferta a curt termini i de producció potencial, i mira què li passa al nivell de preus i al PIB en cada termini." colorVar="--color-eco1" />
...
<VocesDesacuerdo
  tema="Cal créixer sempre?"
  postura_a={{
    etiqueta: 'Sense creixement no hi ha marge',
    tesis: "El creixement és el que ha tret milers de milions de persones de la pobresa i el que paga pensions, sanitat i transició energètica. Parar l'economia no repartix millor: repartix menys.",
  }}
  postura_b={{
    etiqueta: 'Créixer així té un sostre físic',
    tesis: 'El PIB creix sobre una base material finita. Si el consum de recursos no es desacobla del creixement prou de pressa, continuar creixent consistix a traslladar el cost a qui ve després.',
  }}
>
El punt on el debat es torna concret té nom: **desacoblament**, és a dir, si és possible créixer consumint menys recursos i emetent menys. Hi ha desacoblament relatiu ben documentat —cada euro de PIB emet menys que fa trenta anys— i la discussió seriosa està en si l'absolut arriba a la velocitat necessària. **Fixa't que les dues postures compartixen l'objectiu i discrepen sobre el mitjà**, així que la pregunta útil a classe no és «créixer sí o no», sinó **què hauria de passar perquè el creixement i les emissions se separen de veritat, i a quin ritme**.
</VocesDesacuerdo>
...
- tipo: curriculum
  ...
  saberes:
    - "Bloc C: el model AD-AS."
    - "Bloc C: cicles econòmics, expansió i recessió."
  competencias:
    - "Interpretar la realitat macroeconòmica a partir del model AD-AS."
- tipo: caso
  eyebrow: "El cas"
  title: "Un quart del PIB desaparegut en sis mesos"
  contexto: "El primer semestre del 2020 l'economia espanyola es va parar de colp. Cap cicle econòmic clàssic explicava una caiguda i un rebot tan abruptes."
  datos:
    - "El PIB va caure un 22 % acumulat en sis mesos."
    - "L'atur va botar per damunt del 16 %."
    - "Milers d'empreses van tancar i les llars van perdre ingressos de colp."
    - "A finals del 2021 quasi s'havia recuperat el nivell previ."
  pregunta: "Si el model AD-AS no explica del tot la COVID, és perquè el model és roín o perquè el xoc va ser excepcional?"
- tipo: section
...
- tipo: recap
  ...
  items:
    - "Sabries dibuixar el model AD-AS amb les seues tres corbes i justificar el pendent de cadascuna."
    - "Sabries analitzar els quatre xocs sobre preus i producció a curt i a llarg termini."
    - "Sabries nomenar les quatre fases del cicle i aplicar-les a Espanya entre 2008 i 2024."
    - "Sabries separar creixement (PIB per capita) de desenvolupament (IDH) i citar els factors de Solow."
    - "Sabries llegir una corba de Lorenz i calcular l'índex de Gini amb dades senzilles."
```
