...
### Órdenes de magnitud en la zona euro (2024)

- **M0** (billetes y monedas en circulación): aproximadamente **1,5 billones de euros**.
- **M1**: aproximadamente **10,7 billones de euros**.
- **M3**: aproximadamente **16 billones de euros**.
...
- **Tipo de la facilidad marginal de crédito**: el tipo al que el BCE presta liquidez de un día (*overnight*) a los bancos comerciales contra colateral. En octubre de 2024: **3,65 %**.
- **Tipo de las operaciones principales de financiación (MRO)**: el tipo de las operaciones semanales de refinanciación. En octubre de 2024: **3,40 %**.
- **Tipo de la facilidad de depósito**: el tipo que el BCE paga (o cobra) por las reservas excedentarias que los bancos depositan en el banco central de un día para otro. **Es la referencia más seguida**: en octubre de 2024: **3,25 %**, tras los recortes desde el máximo del **4 %** de septiembre de 2023.
...
En 2024, el **Euribor a 12 meses** osciló entre el **3,2 % y el 3,7 %**, frente al **−0,5 %** que tocó en diciembre de 2021. Es la magnitud del shock que vivieron los hogares con hipoteca variable entre 2022 y 2023, ya analizado en la Unidad 3.
...
- **Banco Sabadell** — cuarto grupo nacional, objeto de una **OPA hostil** de BBVA lanzada en 2024.
...
<RealExample title="El rescate de Bankia: 22.000 millones de euros públicos y la lección regulatoria" source="Banco de España, Informe sobre la crisis financiera y bancaria en España (2017)" sourceUrl="https://www.bde.es">
**Bankia** se constituyó en diciembre de 2010 mediante la fusión de **siete cajas de ahorros** —encabezadas por Caja Madrid y Bancaja— en un sistema institucional de protección (SIP) que pretendía sanear el sector. Salió a bolsa en julio de 2011 con una valoración de **3,75 € por acción** y una colocación masiva entre **pequeños inversores minoristas** (más de 350.000 familias compraron acciones en oficinas de toda España). Apenas **diez meses después**, en mayo de 2012, el Gobierno tuvo que nacionalizar el grupo: las acciones se desplomaron hasta valer prácticamente cero y los Estados financieros reformulados revelaron pérdidas de **19.193 millones de euros** en 2012, la mayor pérdida empresarial en la historia de España.

El rescate movilizó **22.424 millones de euros** del **FROB** (Fondo de Reestructuración Ordenada Bancaria), financiados a su vez por el **MEDE** (Mecanismo Europeo de Estabilidad) mediante un préstamo de hasta 100.000 millones a España. El coste neto para el contribuyente español, ya hechas las recuperaciones parciales con la fusión posterior con CaixaBank (2021), se estima en **más de 15.000 millones de euros** según el propio Banco de España (*Informe sobre la crisis financiera y bancaria*, 2017).

La crisis dejó tres lecciones regulatorias que cambiaron el sistema financiero europeo:
1. **Supervisión unificada europea (MUS, 2014)**: las decisiones de supervisión de grandes bancos se trasladaron del Banco de España al BCE para evitar que los supervisores nacionales fueran capturados por presiones políticas locales.
2. **Resolución bancaria (MUR, 2015)**: se creó un mecanismo único para liquidar bancos en quiebra sin recurrir al rescate público, mediante el principio de ***bail-in*** —que los costes los absorban primero accionistas y acreedores, no contribuyentes—.
3. **Reforzamiento de los requisitos de capital (Basilea III)**: los bancos europeos pasaron a estar obligados a mantener colchones de capital muy superiores a los anteriores a 2008.
</RealExample>
...
En julio de 1944, con la Segunda Guerra Mundial todavía en curso, **730 delegados de 44 países** se reunieron durante tres semanas en el complejo hotelero de **Bretton Woods** (New Hampshire) para diseñar el sistema monetario internacional de la posguerra. La conferencia, presidida por el economista británico **John Maynard Keynes** y el estadounidense **Harry Dexter White**, alumbró un sistema híbrido: las monedas nacionales se vinculaban a paridades fijas con el **dólar estadounidense**, y este último era convertible en **oro a una tasa fija de 35 dólares por onza**. Nacieron también el **Fondo Monetario Internacional (FMI)** y el **Banco Mundial**, todavía operativos hoy.

El sistema funcionó razonablemente bien durante 27 años, pero la **Guerra de Vietnam**, los déficits estadounidenses crecientes y la incapacidad estructural de Estados Unidos para mantener la convertibilidad oro-dólar al precio acordado terminaron por hacerlo inviable. El 15 de agosto de 1971, en una alocución televisada un domingo por la noche, el presidente **Richard Nixon** anunció unilateralmente la **suspensión de la convertibilidad del dólar en oro** —el llamado *Nixon shock*—. A partir de ese momento, todas las monedas del mundo pasaron a ser **fiduciarias puras**, sin respaldo en metal precioso, con su valor flotando libremente en los mercados de divisas. Es el sistema en el que vivimos desde entonces, y la razón por la que el dinero que usamos cada día es, técnicamente, **una promesa institucional sin respaldo material**.
</Curiosity>
...
- **Pagos digitales y transferencias instantáneas**. En España, **Bizum** —lanzado en 2016 como joint venture de la banca tradicional— alcanzó en 2024 más de **27 millones de usuarios** y movió más de **70.000 millones de euros** anuales. A escala europea, el sistema **SEPA Instant** permite transferencias en menos de 10 segundos en toda la zona euro. La iniciativa **Wero** —impulsada por la banca europea para competir con Apple Pay y Google Pay— inició su despliegue en 2024.
...
La fintech ha logrado reducir comisiones, mejorar la experiencia de usuario y dar acceso a productos financieros a colectivos antes mal servidos (jóvenes, migrantes, microempresas). Pero **no ha sustituido a la banca tradicional**: la captación de depósitos, la concesión de hipotecas y el crédito empresarial siguen estando dominados por los bancos clásicos. Lo más habitual ha sido la **integración**: los bancos tradicionales han comprado fintechs o han desarrollado sus propias divisiones digitales.
...
- Como **depósito de valor**: su precio es **extremadamente volátil** —pasó de 65.000 dólares en noviembre 2021 a 16.000 en diciembre 2022, y de vuelta a 70.000 en marzo 2024—. Funciona más como un activo especulativo que como un depósito estable.

### Stablecoins

Las **stablecoins** son criptomonedas diseñadas para mantener una paridad estable con una moneda fiduciaria (habitualmente el dólar) mediante el respaldo en reservas reales. Las principales son **USDT** (Tether) y **USDC** (Circle). Son útiles dentro del ecosistema cripto como «refugio» en moneda estable, pero han sufrido escándalos por la opacidad de sus reservas y por episodios de **desanclaje** del precio (la stablecoin algorítmica **TerraUSD** colapsó en mayo de 2022, evaporando 60.000 millones de dólares).

### El consumo energético: el debate ambiental

La validación por *proof of work* de Bitcoin requiere un consumo energético masivo: en 2024, la red Bitcoin consume aproximadamente **130 TWh anuales**, similar al consumo eléctrico de **Argentina o Polonia**. El debate ambiental sobre las criptomonedas ha llevado a algunas redes (Ethereum, desde septiembre de 2022) a migrar a *proof of stake*, mucho menos intensivo en energía.
...
<Steps label="Cómo se transmite la política monetaria del BCE a la economía real" title="Del Consejo de Gobierno a la cuota de la hipoteca" variant="arabic">

<li><strong>El Consejo de Gobierno del BCE decide.</strong> Cada seis semanas, los 26 miembros (6 del Comité Ejecutivo + 20 gobernadores nacionales) deciden los tipos de interés oficiales en función de la inflación, el crecimiento y las expectativas.</li>

<li><strong>Se ajustan los tipos del Eurosistema.</strong> Las decisiones se aplican simultáneamente al tipo de depósito, MRO y facilidad marginal. Suelen modificarse en pasos de 25 puntos básicos (0,25 %).</li>

<li><strong>El Mercado Interbancario reacciona.</strong> Los bancos comerciales, que se prestan entre sí cada día, ajustan los tipos del mercado (Euribor) hacia los nuevos tipos oficiales. La transmisión es rápida (días, no meses) en los plazos cortos.</li>

<li><strong>Los bancos comerciales repercuten en sus clientes.</strong> Los tipos de las nuevas hipotecas variables (referenciadas al Euribor) se actualizan automáticamente; los tipos de los préstamos personales, de los depósitos y de las hipotecas fijas se ajustan en plazos más largos por la competencia entre entidades.</li>

<li><strong>Cambian las decisiones de hogares y empresas.</strong> Con tipos más altos: los hogares ahorran más y consumen menos, las empresas posponen inversiones. Con tipos más bajos: ocurre lo contrario. El efecto sobre la economía real se nota plenamente entre <strong>12 y 24 meses</strong> después de la decisión inicial del BCE.</li>

</Steps>

## Cifras y datos para situar la realidad (2024)

Algunos órdenes de magnitud útiles que el alumnado debería poder citar al cerrar la unidad:

- **Tipo de la facilidad de depósito del BCE** (referencia más seguida): **3,25 %** en octubre de 2024, tras recortes desde el máximo del **4 %** de septiembre 2023.
- **Euribor a 12 meses**: alrededor del **2,7-3,2 %** durante el segundo semestre de 2024.
- **Inflación zona euro (HICP)**: **1,7-2,2 %** en 2024, frente al pico del **10,6 %** de octubre 2022.
- **M3 zona euro**: aproximadamente **16 billones de euros** (2024).
- **Capitalización bursátil de BME**: aproximadamente **700.000 millones de euros**.
- **Activos totales del sistema bancario español**: aproximadamente **2,9 billones de euros**.
- **Cinco mayores bancos españoles** (Santander, BBVA, CaixaBank, Sabadell, Bankinter) concentran más del **70 %** del crédito y los depósitos nacionales.
- **Usuarios de Bizum en España (2024)**: más de **27 millones**.
- **Bitcoin precio medio 2024**: entre **40.000 y 70.000 USD** (volatilidad ±50 % intraanual).
...
6. Mishkin, F. S. (2019). *The Economics of Money, Banking and Financial Markets* (12.ª ed.). Pearson.
