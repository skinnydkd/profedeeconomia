...
- **Deciden** entre **consumir** o **ahorrar** parte de esa renta. El consumo agregado de las familias (C) es la principal partida del PIB español por el lado del gasto: en torno al **57 % del PIB** según el INE (2023).
...
En España, el gasto público total representa en torno al **45 % del PIB** (incluyendo transferencias); el consumo público que entra en el PIB ronda el **19 %** (Eurostat, 2023).
...
España es una economía abierta: las exportaciones de bienes y servicios suponen alrededor del **38 % del PIB** (Eurostat, 2023), un porcentaje que ha crecido sostenidamente desde la entrada en la UE en 1986. Veremos el comercio internacional con más detalle en la Unidad 12.
...
En España, el PIB ronda los **1,5 billones de euros** anuales en 2023 (1.498.324 millones de euros corrientes según el INE, edición de 2024). Es la décima economía mundial por tamaño y la cuarta de la zona euro.
...
En España, la distribución sectorial del VAB en 2023 fue, según el INE: servicios **74,3 %**, industria **15,6 %**, construcción **6,8 %**, agricultura, ganadería y pesca **2,6 %**, energía y similares el resto.
...
Donde la **remuneración de asalariados** son los sueldos brutos más cotizaciones empresariales, y el **Excedente Bruto de Explotación (EBE)** agrupa los beneficios empresariales y las rentas mixtas de los autónomos. En España, el reparto típico es de un **47 % para trabajo** y un **42 % para excedente** (el resto son impuestos netos), según las Cuentas Nacionales 2023.

<RealExample title="España recupera el PIB pre-pandemia en 2024" source="INE, Contabilidad Nacional Trimestral, datos de cierre 2024 (revisión marzo 2025) y Banco de España, Informe anual 2024.">
El PIB español se hundió un **11,2 %** en 2020, el peor desplome desde la Guerra Civil. La recuperación fue desigual: se cerró 2021 con un crecimiento del 6,4 %, 2022 con un 5,8 % y 2023 con un 2,5 %. Fue en el **segundo trimestre de 2024** cuando España volvió oficialmente al nivel de PIB real previo a la pandemia, según el INE. Italia, Alemania y Francia ya lo habían hecho antes, pero el ritmo de crecimiento español durante 2023-2024 (en torno al 2,5-3 %) fue el más alto de las grandes economías de la zona euro, impulsado por el turismo —cifras récord de visitantes internacionales— y el despliegue de los fondos *Next Generation EU*.
</RealExample>
...
La aceleración de 2022 fue la mayor en cuatro décadas, impulsada por el encarecimiento de la energía tras la invasión rusa de Ucrania y los cuellos de botella post-pandemia. En 2023 y 2024 se moderó gracias a las subidas de tipos del BCE, la caída de los precios energéticos y, en parte, a las medidas fiscales del Gobierno (rebaja del IVA en alimentos básicos, descuentos al transporte público).
...
Datos españoles del **tercer trimestre de 2024** (INE, EPA T3-2024):

| Indicador | Valor T3-2024 |
|---|---|
| Población activa | 24,2 millones |
| Población ocupada | 21,5 millones |
| Población parada | 2,7 millones |
| Tasa de paro | **11,3 %** |
| Tasa de actividad | **58,7 %** |
| Tasa de paro juvenil (16-24 años) | **26,6 %** |

España convive desde los años ochenta con tasas de paro estructuralmente más altas que la media de la UE: la media de la zona euro en 2024 ronda el **6,4 %**. Esa diferencia es uno de los grandes problemas del modelo laboral español y será objeto de la Unidad 9 (mercado de trabajo).
...
Tras décadas de déficit por cuenta corriente, España presenta **superávit por cuenta corriente desde 2012**. En 2023, según el Banco de España, el saldo de la cuenta corriente fue de **+39.000 millones de euros** (≈ +2,6 % del PIB), impulsado por dos motores:
...
- El **IPC** mide el precio de una cesta de consumo. La **tasa de inflación** es su variación. España registró +2,8 % en 2024 (INE), por debajo del pico de 2022.
- La **tasa de paro EPA** española en T3-2024 fue del **11,3 %**, sensiblemente por encima de la media de la zona euro (~6,4 %). La tasa de actividad rondó el 58,7 %.
- La **balanza de pagos** registra las operaciones con el exterior. España presenta superávit por cuenta corriente desde 2012 (≈ +2,6 % del PIB en 2023), gracias sobre todo al turismo.
</KeyTakeaways>
...
8. Mankiw, N. G. (2021). *Principios de economía*. 9.ª edición. Cengage Learning. Caps. 23-24.
9. Krugman, P., Wells, R. y Graddy, K. (2020). *Fundamentos de economía*. 3.ª edición. Reverté. Caps. 21-22.
