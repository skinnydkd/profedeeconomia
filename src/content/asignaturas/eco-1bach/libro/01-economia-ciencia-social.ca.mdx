...
<SolvedExercise number="1.1" title="Cost d'oportunitat i creixement sobre la frontera">

**Enunciat**

Un país pot dedicar tots els seus recursos a produir com a màxim **100 unitats de béns de consum** o **80 unitats de béns de capital**. La seua frontera de possibilitats de producció és una recta entre eixos dos extrems.

a) Quin és el cost d'oportunitat d'una unitat de béns de consum?
b) Si el país produïx 60 de consum, quant capital pot produir com a màxim?
c) Classifica el punt (60 de consum, 40 de capital).
d) El país creix un 10 % en els dos béns. Què li passa a eixe mateix punt?

**Solució**

1. Renunciar als 80 de capital permet produir 100 de consum, així que **1 consum = 80/100 = 0,8 de capital**. Al revés, **1 capital = 100/80 = 1,25 de consum**. Sobre una frontera recta eixe cost és el mateix en tot el traçat: tant li fa on es mesure.
2. Amb 60 de consum queden lliures el 40 % dels recursos: 80 × (1 − 60/100) = 80 × 0,4 = **32 de capital**.
3. El punt (60, 40) demana 40 de capital quan la frontera només en permet 32, així que és **inabastable**: no hi ha recursos prou amb la tecnologia de hui.
4. Després de créixer un 10 %, els màxims passen a 110 i 88. Ara, amb 60 de consum, el país pot produir 88 × (1 − 60/110) = 88 × 5/11 = **40 de capital exactament**. El punt que era inabastable **queda just sobre la nova frontera**.
5. *El que cal emportar-se.* El creixement no consistix a moure's per la frontera, sinó a **desplaçar-la cap a fora**: convertix en possible el que abans no ho era. I fixa't que el cost d'oportunitat no ha canviat —continua sent 0,8—, perquè els dos béns han crescut igual. Si n'haguera crescut només un, la frontera s'hauria **inclinat** i el cost d'oportunitat sí que canviaria.
