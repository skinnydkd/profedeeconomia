...
Al juliol de 1944, amb la Segona Guerra Mundial encara en curs, **730 delegats de 44 països** es van reunir tres setmanes a **Bretton Woods** (New Hampshire) per a dissenyar el sistema monetari de la postguerra. La conferència, presidida per **Keynes** (Regne Unit) i **Harry Dexter White** (Estats Units), va enllumenar un sistema híbrid: monedes nacionals amb paritat fixa al **dòlar**, i dòlar convertible en **or a 35 dòlars per unça**. Van nàixer també el **FMI** i el **Banc Mundial**. El sistema va funcionar 27 anys fins que, el 15 d'agost de 1971, el president **Richard Nixon** va suspendre unilateralment la convertibilitat del dòlar en or (el *Nixon shock*). Des d'aleshores totes les monedes del món són **fiduciàries pures**, sense respatler en metall preciós, i els diners que fem servir cada dia són tècnicament una promesa institucional sense respatler material.
</Curiosity>
...
- Els **diners** complixen tres funcions —mitjà de pagament, unitat de compte, depòsit de valor— i hui són **fiduciaris** i majoritàriament **bancaris/electrònics**, no respaldats per metall preciós des de 1971.
...
1. Un bitllet de 50 € val 50 € perquè tots acceptem que val 50 €. Què passaria amb eixa confiança en un episodi d'hiperinflació? Per què els diners fiduciaris funcionen la immensa majoria del temps malgrat no tindre respatler material?
