...
Es una de las unidades más útiles del curso fuera del aula: la herramientas que vas a aprender —coste de oportunidad, análisis marginal, sesgos de Kahneman y Tversky, *nudges* de Thaler— sirven para decidir mejor en tu propia vida.
</TldrUnidad>

<CasoDilema
  titular="Concorde voló 27 años perdiendo dinero. Británicos y franceses lo mantuvieron por orgullo"
  fuente="British Airways y Air France · 1976-2003 (operativa) · análisis económicos de la AEA y The Economist"
  pregunta="¿Por qué seguir invirtiendo en algo que pierde dinero claramente? ¿Qué sesgo cognitivo explica la decisión?"
>
El supersónico Concorde —en servicio comercial entre 1976 y 2003— fue uno de los proyectos más caros de la historia de la aviación. Ya en los años ochenta las cifras eran claras: el avión perdía dinero por vuelo, los costes operativos triplicaban a los de un Boeing 747 y los pasajeros pagaban un sobrecoste enorme por ahorrar 3 horas en transatlántico. Pese a eso, los gobiernos británico y francés —que habían invertido miles de millones en su desarrollo— se negaron a retirarlo durante décadas.
</CasoDilema>
...
<VocesDesacuerdo
  tema="¿El homo economicus existe?"
  postura_a={{
    etiqueta: 'Modelo neoclásico',
    tesis: 'Los agentes son racionales: maximizan su utilidad con información completa y preferencias estables. El modelo permite predicciones y políticas claras.',
  }}
  postura_b={{
    etiqueta: 'Kahneman · Tversky · Thaler',
    tesis: 'La mente humana es sistemáticamente sesgada. La racionalidad acotada de Simon es la regla, no la excepción. Cualquier modelo realista tiene que incorporarla.',
  }}
>
Hoy la economía del comportamiento ha entrado en los modelos macro y micro. La política pública aplica *nudges* —pequeños empujones de diseño— para que la gente decida mejor sin restringir su libertad. La discusión no es ya *si* los sesgos importan, sino **cuánto pesan en cada contexto** y cuándo conviene corregirlos.
</VocesDesacuerdo>
...
<Diagram caption="La función de valor es cóncava en las ganancias y convexa —y más pronunciada— en las pérdidas: una pérdida duele más de lo que agrada una ganancia equivalente. Todo se mide respecto a un punto de referencia, no en términos absolutos." source="Kahneman y Tversky (1979), Prospect Theory">
  <TeoriaProspectiva />
</Diagram>
...
<VuelveAlCaso referencia="Concorde y la falacia del coste hundido">
El caso ilustra con precisión clínica la **falacia del coste hundido**: seguir invirtiendo en algo perdedor porque «ya hemos invertido mucho». La inversión pasada es **irrecuperable**; debería ignorarse al decidir si seguir o no. Lo único que importa es el cálculo de coste y beneficio **futuro** desde hoy.

Pero emocionalmente el dinero ya gastado pesa: por eso clausurar negocios, retirar productos del mercado o admitir errores estratégicos es psicológicamente costoso, incluso cuando es la decisión racional. Reconocer el sesgo es el primer paso para neutralizarlo —en tu propio CV, en una relación, en una carrera universitaria que ya no te interesa, o en un proyecto empresarial que no funciona—.
</VuelveAlCaso>
...
<MirarFora
  ...
  libro={{
    ...
    porque: 'El manual de referencia sobre los dos sistemas de pensamiento (intuitivo y analítico) y los sesgos asociados a cada uno. Los capítulos sobre anclaje y aversión a la pérdida son lectura directa para esta unidad.',
    paginas: 'Partes I y IV',
  }}
  video={{
    titulo: 'El dilema del prisionero · MIS PROBLEMAS FAVORITOS',
    meta: 'Mates Mike · YouTube',
    duracion: '~10-12 min',
    porque: 'Explicación visual del dilema del prisionero clásico y de cómo cambia cuando se repite muchas veces. Conecta directamente con la sección de teoría de juegos.',
    url: 'https://www.youtube.com/results?search_query=dilema+del+prisionero+mis+problemas+favoritos',
  }}
  cuenta={{
    titulo: '@ArielRubinstein',
    meta: 'X / Twitter',
    porque: 'Catedrático de Tel Aviv, hilos cortos y accesibles sobre teoría de juegos y racionalidad en economía. Útil para entrenar la intuición estratégica.',
  }}
  actividad_titulo="Caza tu propio sesgo"
  actividad_duracion="25 min"
>
  <Fragment slot="actividad">
    Identifica **una decisión reciente tuya** —compra, elección de optativa, ruptura, abandono de un curso— donde reconozcas haber caído en uno de los sesgos vistos (anclaje, disponibilidad, aversión a la pérdida, coste hundido, exceso de confianza). Describe el sesgo, la decisión y cómo habrías decidido **sin él**.
  </Fragment>
  <Fragment slot="para-clase">
    Variante *experimento de aula*: el profesor propone una elección con anclaje («¿pagarías 5 € por este cuaderno? ¿y 25 €? ¿cuál sería tu disposición a pagar?»). Se comparan respuestas en pizarra, se revela el sesgo y se discute. Duración: 45 min.
  </Fragment>
</MirarFora>
...
- tipo: concept
  eyebrow: El caso
  title: 27 años volando y perdiendo dinero
  body: "Hacia 1973 los gobiernos británico y francés ya sabían que el Concorde no sería rentable: caro, ruidoso, con costes operativos que triplicaban los de un Boeing 747 y solo apto para rutas concretas. Aun así lo financiaron durante décadas, y voló comercialmente de 1976 a 2003 sin generar beneficios. El argumento en los debates parlamentarios fue siempre el mismo: «ya hemos invertido demasiado para parar ahora»."
  pull: "¿Por qué seguir invirtiendo en algo que pierde dinero de forma evidente?"
- tipo: section
  title: El coste de oportunidad
  subtitle: De todo lo que la economía aporta al pensamiento cotidiano, probablemente el concepto más valioso.
- tipo: concept
  eyebrow: Concepto clave
  title: El valor de la mejor alternativa
  body: "El coste de oportunidad de elegir A es el valor de la mejor alternativa B a la que renunciamos. No es la suma de todo lo descartado, solo la mejor de esas opciones, e incluye costes no monetarios. Estudiar un grado no cuesta solo las matrículas: cuesta también el salario de esos cuatro años. Y es invisible: las facturas aparecen en el extracto, lo que dejamos de hacer no aparece en ningún sitio."
  pull: "El hábito mental más útil del curso: ante cada decisión, preguntar qué estoy dejando de hacer al elegir esto."
- tipo: concept
  title: Beneficio contable y beneficio económico
  body: "Una empresaria que dirige su propio negocio se paga un salario. Pero el coste real de su trabajo no es ese salario contable, sino el sueldo más alto que habría cobrado en otro empleo. Si su negocio le deja 25.000 € y trabajando para otros habría cobrado 35.000 €, hay 10.000 € de coste de oportunidad que el balance nunca refleja."
  pull: Una empresa puede ser rentable en contabilidad y destruir valor económico a la vez.
- tipo: section
  title: Los costes hundidos
  subtitle: "La cara opuesta del coste de oportunidad, y una regla radical: no deben influir en las decisiones futuras."
- tipo: figure
  src: eco-1bach/02/concorde.jpg
  alt: Avión supersónico Concorde de British Airways en vuelo, con su característico morro alargado y las alas en delta.
  title: El caso de estudio canónico
  caption: Los manuales de economía conductual llaman Concorde fallacy a la versión institucional de la falacia del coste hundido.
  credit: "Foto: dominio público vía Wikimedia Commons"
- tipo: concept
  title: Lo ya gastado no se recupera decidas lo que decidas
  body: "Los costes hundidos son los gastos ya realizados e irrecuperables. Como no cambian con la decisión, no deberían pesar en ella: lo único relevante es el cálculo de coste y beneficio futuro desde hoy. Pero emocionalmente el dinero gastado pesa mucho, y por eso cerrar un negocio, retirar un producto o admitir un error estratégico resulta psicológicamente costoso incluso cuando es lo racional."
  pull: Reconocer el sesgo es el primer paso para neutralizarlo — en un proyecto, en una carrera o en una relación.
- tipo: section
  title: El análisis marginal
  subtitle: Las buenas decisiones rara vez se toman comparando totales. Se toman comparando incrementos.
- tipo: concept
  title: "La regla: seguir mientras BMg ≥ CMg"
  body: "No preguntamos «¿debo producir?», sino «¿debo producir una unidad más?». El beneficio marginal es el incremento de utilidad que aporta esa unidad adicional; el coste marginal, lo que cuesta añadirla. Conviene seguir mientras el beneficio marginal iguale o supere al coste marginal, y detenerse cuando lo pierda de vista. En condiciones de continuidad, el óptimo está justo donde BMg = CMg."
  pull: Si una unidad más añade 12 € de ingresos y 8 € de costes, conviene. Si añade 12 € y cuesta 15 €, no.
- tipo: exercise
  title: Por qué los totales engañan
  enunciado: "Una empresa de mochilas vende 1.000 unidades con 30.000 € de ingresos y 20.000 € de costes. Estudia subir a 1.100 unidades: los ingresos irían a 32.500 € y los costes a 23.500 €. Mirando totales, las dos opciones dan beneficio. ¿Conviene producir esas 100 mochilas adicionales?"
  pasos:
...
- tipo: section
  title: Los incentivos
  subtitle: La convicción de que la gente responde a incentivos es lo que más distingue al economista del resto de las ciencias sociales.
- tipo: list
  title: Cómo se clasifican, y por qué se tuercen
  items:
    - "Monetarios: una bonificación por objetivos, una subvención, un impuesto, una multa."
...
- tipo: concept
  eyebrow: Caso real
  title: Las cobras de Delhi
  body: "El gobierno colonial británico ofreció una recompensa por cada cobra muerta para frenar una plaga. Funcionó al principio; después los habitantes empezaron a criar cobras en casa para matarlas y cobrar. Al descubrirlo, la administración canceló el programa, los criadores soltaron las cobras inservibles y la población en libertad acabó siendo mayor que antes del incentivo."
  pull: El cobra effect abre cualquier manual de diseño de políticas públicas, a modo de advertencia.
- tipo: section
  title: Teoría de juegos
  subtitle: Qué ocurre cuando el resultado de mi decisión depende de lo que decida otra persona a la vez que yo.
- tipo: figure
  src: eco-1bach/02/john-nash.jpg
  alt: Retrato fotográfico del matemático John Nash, premio Nobel de Economía en 1994.
  title: John Nash (1928-2015)
  caption: Nobel de Economía en 1994. Su concepto de equilibrio es la herramienta central de la teoría de juegos moderna.
  credit: "Foto: Elke Wetzig, CC BY-SA 3.0 vía Wikimedia Commons"
- tipo: table
  title: "El dilema del prisionero (años de cárcel; menos es mejor)"
  head:
    - ""
    - B calla
    - B confiesa
  rows:
    ...
    - - A confiesa
      - "A: libre · B: 10 años"
      - "A: 5 años · B: 5 años"
  caption: "Pase lo que pase, a cada uno le conviene confesar: es una estrategia dominante. Y acaban con 5 años en vez de 1."
- tipo: concept
  eyebrow: Concepto clave
  title: Equilibrio de Nash
  body: "Es una combinación de estrategias en la que ningún jugador puede mejorar su resultado cambiando de estrategia, dadas las estrategias de los demás. El dilema del prisionero enseña la lección incómoda: el equilibrio de Nash no es necesariamente la mejor solución colectiva. Aquí la búsqueda del interés individual produce un resultado peor para los dos que la cooperación."
  pull: Estable no significa eficiente. Un equilibrio puede ser malo para todos y aun así sostenerse.
- tipo: terms
  title: Tres conceptos que vertebran el resto del curso
  terms:
    - t: Eficiencia paretiana
      d: No se puede mejorar la situación de alguien sin empeorar la de otro. Ojo, una asignación puede ser eficiente y profundamente injusta.
    - t: Riesgo
      d: "Conocemos las probabilidades de los resultados posibles: un dado, una ruleta, un producto con demanda histórica conocida. Se modela con probabilidad."
    - t: Incertidumbre
      d: "Ni siquiera conocemos las probabilidades: cómo estará el mercado laboral en quince años. Knight (1921) fijó la distinción, y casi toda decisión grande es de este tipo."
- tipo: section
  title: Racionalidad acotada y economía del comportamiento
  subtitle: La mirada moderna sobre cómo decidimos de verdad, no sobre cómo deberíamos decidir.
- tipo: figure
  src: eco-1bach/02/herbert-simon.jpg
  alt: Retrato pintado al óleo de Herbert A. Simon, sentado, con expresión serena, de la colección de Carnegie Mellon University.
  title: Herbert A. Simon (1916-2001)
  caption: Nobel de Economía en 1978 por la teoría de la racionalidad acotada. Retrato de Richard Rappaport, Carnegie Mellon.
  credit: "Imagen: Richard Rappaport, CC BY 3.0 vía Wikimedia Commons"
- tipo: concept
  title: No maximizamos, satisfacemos
  ...
  pull: Si las personas no maximizan, los modelos construidos sobre la maximización fallan en muchas predicciones.
- tipo: figure
  src: eco-1bach/02/kahneman.jpg
  alt: Retrato fotográfico del psicólogo Daniel Kahneman, con cabello blanco, mirando ligeramente fuera de cámara.
  title: Daniel Kahneman (1934-2024)
  caption: Nobel de Economía en 2002 por integrar la investigación psicológica en la ciencia económica, junto a Amos Tversky.
  credit: "Foto: Eirik Solheim / nrkbeta, CC BY-SA 2.0 vía Wikimedia Commons"
- tipo: split
  title: Los dos sistemas mentales de Kahneman
  left:
    h: Sistema 1
    items:
...
- tipo: list
  title: Cinco sesgos que aparecen una y otra vez
  ordered: true
  items:
...
- tipo: diagram
  ...
  caption: Cóncava en las ganancias, convexa y más pronunciada en las pérdidas. Todo se mide respecto a un punto de referencia.
- tipo: concept
  eyebrow: Thaler, Nobel 2017
  title: Nudges, o arquitectura de elección
  ...
  pull: "No decidir cómo se presentan las opciones ya es una decisión: si no la toma el regulador, la toma el mercado."
- tipo: list
  title: Nudges que ya estructuran decisiones en España
  items:
...
- tipo: quiz
  eyebrow: Nivel EBAU
  pregunta: Has pagado 60 € por una entrada no reembolsable y el día del concierto tienes fiebre. ¿Cómo debe influir ese pago en tu decisión?
  opciones:
    - Debe empujarte a ir, para no desperdiciar los 60 €
    - "No debe influir en nada: son coste hundido, irrecuperable vayas o no"
    - Debe empujarte a ir solo si el concierto dura más de dos horas
    - Debe empujarte a quedarte, porque ya has perdido el dinero
  correcta: 1
  explicacion: Los 60 € están gastados en cualquier escenario, así que no cambian con la decisión. Lo único relevante es comparar de hoy en adelante lo que ganas yendo con fiebre frente a quedarte en casa.
- tipo: concept
  eyebrow: Vuelve al caso
  title: La inversión pasada es irrecuperable
  body: "El Concorde ilustra con precisión clínica la falacia del coste hundido: seguir invirtiendo en algo perdedor porque «ya hemos invertido mucho». Los miles de millones gastados en desarrollo eran irrecuperables en 1973, en 1985 y en 2003; lo único que debía pesar era el coste y el beneficio futuros desde cada uno de esos momentos. Pero el dinero ya gastado pesa emocionalmente, y por eso el error se repite."
  pull: Lo mismo vale para un negocio que no arranca, una carrera que ya no te interesa o un proyecto que no funciona.
```
