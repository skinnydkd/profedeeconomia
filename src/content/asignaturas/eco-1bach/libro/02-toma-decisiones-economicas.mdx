...
- tipo: timeline
  ...
  hitos:
    - fecha: "Hacia 1973"
      hito: "Los gobiernos ya sabían que no sería rentable"
      detalle: "Caro, ruidoso, con costes operativos que triplicaban los de un Boeing 747."
    - fecha: "1976"
      hito: "Primer vuelo comercial"
      detalle: "Solo apto para rutas concretas."
    - fecha: "1976-2003"
      hito: "Financiado durante décadas sin dar beneficios"
      detalle: "«Ya hemos invertido demasiado para parar ahora», se repetía en el Parlamento."
    - fecha: "2003"
      hito: "Último vuelo"
      detalle: "¿Por qué seguir invirtiendo en algo que pierde dinero de forma evidente?"
- tipo: section
...
- tipo: formula
  eyebrow: "Análisis marginal"
  title: "La regla: seguir mientras BMg ≥ CMg"
  formula: "el óptimo está donde BMg = CMg"
  terminos:
    - s: "BMg"
      d: "Beneficio marginal: la utilidad que aporta producir una unidad más."
    - s: "CMg"
      d: "Coste marginal: lo que cuesta añadir esa unidad adicional."
  ejemplo: "Si una unidad más añade 12 € de ingresos y 8 € de costes, conviene. Si añade 12 € y cuesta 15 €, no. La pregunta nunca es «¿produzco?», sino «¿produzco una más?»."
- tipo: exercise
