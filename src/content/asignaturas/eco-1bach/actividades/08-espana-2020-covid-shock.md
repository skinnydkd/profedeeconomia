...
| --- | --- | --- |
| Manejo gráfico del modelo AD-AS | Dibuja correctamente los desplazamientos de AD y SRAS y predice P e Y | 30 % |
| Argumentación con datos | Cita series macro concretas (INE, Eurostat) para sostener el diagnóstico | 30 % |
| Comparación 2008 vs 2020 | Identifica el cambio de doctrina europea y sus consecuencias | 20 % |
| Reflexión final escrita | Posición personal con un dato del caso, no opinión genérica | 20 % |
