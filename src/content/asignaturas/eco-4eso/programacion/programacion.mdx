...
- **CE1** — Reconocer el **espíritu emprendedor** y desarrollar las habilidades personales y sociales que lo sostienen (comunicación, trabajo en equipo, creatividad, resiliencia).
- **CE2** — Valorar el impacto **ético, social y medioambiental** de la actividad económica y emprendedora.
- **CE3** — Analizar el **entorno** para detectar necesidades no cubiertas y transformarlas en oportunidades.
- **CE4** — Ejercer un **consumo responsable e informado**, conociendo los derechos del consumidor y los riesgos del consumo digital.
- **CE5** — Gestionar la **economía personal**: presupuesto, ahorro, financiación, nómina, IRPF y contratos laborales.
- **CE6** — **Diseñar, validar y comunicar** un proyecto emprendedor sencillo desde la idea hasta su defensa pública.
