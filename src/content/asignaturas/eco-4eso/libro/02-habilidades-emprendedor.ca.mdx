...
<VocesDesacuerdo
  tema="Cal celebrar el fracàs?"
  postura_a={{
    etiqueta: 'Cultura del «fracassa ràpid»',
    tesis: "Sense permís per a equivocar-se ningú prova res. Normalitzar l'error reduïx la por, accelera l'aprenentatge i permet descartar idees roïnes prompte, quan descartar-les encara és barat.",
  }}
  postura_b={{
    etiqueta: "Els qui desconfien de l'eslògan",
    tesis: "El fracàs no ensenya tot sol: ensenya l'anàlisi del fracàs, que quasi ningú fa. I el seu cost no es repartix igual: qui té xarxa darrere ho torna a intentar, qui no la té es queda fora.",
  }}
>
Les dues postures hi caben alhora, i qui les junta sol eixir guanyant. Fracassar no és una virtut, però **amagar el fracàs sí que és un problema**, perquè impedix l'única part que servix: seure a mirar què va passar, separar el que depenia de tu del que no, i escriure-ho. Fixa't a més en qui es pot permetre el consell: **la frase «fracassa ràpid» es diu molt més fàcil des d'una posició còmoda**, i això convé tindre-ho davant abans de repetir-la.
</VocesDesacuerdo>
