...
6. **Cotización a la Seguridad Social del trabajador** — alrededor del 6,35 % de la base de cotización.
...
| Cotización SS trabajador (6,35 % s/ base) | −111,13 € |
| Retención IRPF (≈ 9 % s/ bruto) | −135,00 € |
| **Líquido a percibir (neto mensual)** | **≈ 1.253,87 €** |
...
<Steps label="Cómo leer una nómina" title="Tu primera nómina en siete pasos" variant="arabic">
  ...
  <li>**Comprueba las dos deducciones**: la cotización de la Seguridad Social (≈ 6,35 % de la base) y la retención de IRPF (porcentaje variable según tu sueldo anual). Que aparezcan los dos.</li>
...
b) La **cotización a la Seguridad Social** mensual que se le descontará (6,35 % aproximado).
...
2. **Cotización a la Seguridad Social (6,35 %)**:
   - 1.285,71 € × 0,0635 = **81,64 € al mes**.
   - (Para mayor precisión real habría que usar la base de cotización con prorrateo de extras —≈ 1.500 € mensuales—, lo que daría unos 95,25 € al mes. Usamos el cálculo simplificado para 4.º ESO.)
3. **Retención de IRPF (9 % sobre el bruto mensual)**:
   - 1.285,71 € × 0,09 = **115,71 € al mes**.
4. **Salario neto mensual**:
   - 1.285,71 € − 81,64 € − 115,71 € = **≈ 1.088,36 €** netos al mes.
5. **Total neto anual**:
   - 1.088,36 € × 14 pagas = **≈ 15.240 € netos al año**.
6. **Resumen**: de los **18.000 € brutos anuales** pactados, Marina ingresa **unos 15.240 € netos**. La diferencia (≈ 2.760 €) se reparte entre Seguridad Social (≈ 1.140 €/año) y Hacienda (≈ 1.620 €/año en concepto de IRPF). A cambio acumula días cotizados para futuras prestaciones (paro, baja, jubilación) y financia los servicios públicos.
...
- **Salario bruto** es lo pactado antes de descuentos; **salario neto** es lo que entra en tu cuenta tras restar Seguridad Social (≈ 6,35 %) e IRPF (variable).
