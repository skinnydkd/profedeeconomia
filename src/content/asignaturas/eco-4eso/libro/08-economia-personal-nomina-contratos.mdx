...
2. **Cotización a la Seguridad Social (6,35 %)**:
   ...
   - (Para mayor precisión real habría que usar la base de cotización con prorrateo de extras —≈ 1.500 € mensuales—, lo que daría unos 95 € al mes. Usamos el cálculo simplificado para 4.º ESO.)
...
5. **Total neto anual**:
   - 1.088,36 € × 14 pagas = **≈ 15.237 € netos al año**.
6. **Resumen**: de los **18.000 € brutos anuales** pactados, Marina ingresa **unos 15.200 € netos**. La diferencia (≈ 2.760 €) se reparte entre Seguridad Social (≈ 1.140 €/año) y Hacienda (≈ 1.620 €/año en concepto de IRPF). A cambio acumula días cotizados para futuras prestaciones (paro, baja, jubilación) y financia los servicios públicos.
