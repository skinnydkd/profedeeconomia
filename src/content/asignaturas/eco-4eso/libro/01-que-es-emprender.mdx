...
- tipo: concept
  ...
  body: "En 2018, Bruno Casanovas y Alex Benlloch vendían sudaderas hechas a mano en mercadillos de Barcelona. Sin dinero, sin contactos y sin formación empresarial, contaban su día a día en redes sociales. Seis años después su marca de ropa factura más de 50 M€ al año y ha abierto tiendas en Madrid, Barcelona y México. La mayoría de sus seguidores tienen entre 16 y 24 años: vuestra edad."
...
- tipo: terms
  ...
  terms:
    - t: Autoemprendimiento
      d: Creas tu propio proyecto económico, casi siempre como autónomo o pequeña sociedad. Asumes la mayor parte del riesgo y te quedas la mayor parte del excedente.
...
- tipo: table
  ...
  rows:
    - - Autoemprendimiento
      ...
      - Fran Villalba la fundó con 19 años; clientes en 180 países
    - - Intraemprendimiento
      - BBVA Open Talent
...
- tipo: data
  ...
  detalle: El 99,8 % son pymes de menos de 250 empleados y el 94,2 % microempresas de menos de 10. Solo 5.211 empresas en todo el país superan los 250 trabajadores.
- tipo: diagram
  diagrama: PymesEspana
  caption: El 99,8 % son pymes y el 94,2 % microempresas; las grandes son una porción mínima del total.
- tipo: concept
  title: La empresa española típica no tiene ni un empleado
  body: "1.847.000 empresas no tienen ningún asalariado: son autónomos sin equipo o sociedades unipersonales. Si eliges al azar una empresa del DIRCE, el 55 % de las veces será una sola persona trabajando por su cuenta. Menos del 3 % del total tiene entre 10 y 49 trabajadores y solo el 0,2 % supera los 250. La economía española se sostiene sobre millones de personas trabajando solas."
...
- tipo: split
  ...
  left:
    ...
    items:
      ...
      - "El 64 % del empleo privado está en pymes: buscaréis trabajo en una de ellas."
      - "Emprender no es la excepción: es la forma habitual de organizar la actividad."
  right:
    h: Comparados con Europa
    items:
      - Unas 72 empresas por cada 1.000 habitantes, ratio similar a la de Italia.
      - Media de 4,7 trabajadores por empresa; en Alemania son 11,3.
      - Las empresas pequeñas pagan menos, investigan menos y exportan menos.
- tipo: section
...
- tipo: concept
  ...
  body: "Poner en marcha algo nuevo exige habilidades técnicas, comerciales, financieras y legales, y casi nadie las domina todas. Quien lo intenta solo se quema antes y consigue financiación con más dificultad: los inversores desconfían de los proyectos sin equipo. Detrás del panadero del barrio hay una red invisible: la pareja, el gestor que cuadra la fiscalidad, el banco del primer préstamo y los clientes que recomiendan."
...
- tipo: data
  ...
  title: El estudio del MIT sobre 2,7 millones de fundadores (2018)
...
- tipo: list
  ...
  items:
    - "Creatividad: combinar cosas que ya existen de una forma nueva, mirando lo que te rodea con otra pregunta."
...
- tipo: concept
  ...
  body: "Bruno y Alex no inventaron la moda: vieron un hueco entre Zara, masivo y barato, y las marcas premium, caras e inalcanzables, y lo llenaron con ejecución consistente —sudaderas, marca, distribución, marketing—, mejorando una pieza cada vez. El trabajo real del emprendedor se parece más a hojas de cálculo, llamadas comerciales y fiscalidad que a la versión de Netflix."
