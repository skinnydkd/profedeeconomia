...
<RealExample title="Multa de 30.000 € a Renfe por seguros preseleccionados en la web" source="Resolución AEPD PS/00057/2023">
En febrero de 2023 la Agencia Española de Protección de Datos sancionó a **Renfe** por una práctica que combinaba *misdirection* y *drip pricing*: durante el proceso de compra de billetes online, una casilla con un seguro de viaje opcional aparecía **preseleccionada** y en un paso intermedio que muchos usuarios pasaban sin notar. Para no contratar el seguro había que **desmarcar activamente** la casilla. La resolución consideró que esto vulneraba el principio de consentimiento explícito del RGPD y el deber de transparencia precontractual de la LGDCU. La multa fue de 30.000 €. Renfe modificó la interfaz para que el seguro apareciera **sin preseleccionar** y con casillas equivalentes en tamaño. Es un ejemplo limpio de cómo un diseño aparentemente menor (una casilla marcada por defecto) es legalmente un dark pattern sancionable.
</RealExample>
