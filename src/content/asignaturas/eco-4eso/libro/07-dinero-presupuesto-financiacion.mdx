...
<TldrUnidad>
El dinero no es solo lo que ganas, es **lo que decides hacer con lo que ganas**. Esta unidad enseña a hacer un presupuesto personal, distinguir necesidades de deseos y entender el **interés compuesto** —la fuerza que hace que ahorrar a tu edad valga muchísimo más que ahorrar a los 35.
</TldrUnidad>

<CasoDilema
  titular="Pagar el «mínimo» de una tarjeta cuesta tres veces el precio del producto"
  fuente="Adaptado de sentencias del Tribunal Supremo sobre tarjetas revolving · 2020-2024"
  pregunta="¿Por qué pedimos préstamos que nos arruinan si la información sobre el coste está disponible?"
>
En España, miles de jóvenes y adultos han contratado **tarjetas revolving** —tarjetas que permiten pagar «cómodamente cada mes» un porcentaje pequeño de lo gastado. Una compra de **200 €** pagada al «mes a mes» con un TAE del 24 % puede acabar costando **600 €** al cabo de unos años. En 2023, miles de demandas judiciales (WiZink, Vodafone, Cetelem, Cofidis) obligaron a los bancos a devolver intereses considerados abusivos. La información del TAE está en el contrato, pero la mayoría no lo lee.
</CasoDilema>
...
**Pruébalo tú mismo:** introduce tus ingresos mensuales reales y la calculadora reparte automáticamente el 50 %, el 30 % y el 20 % en las tres categorías.
...
<RecursoDestacado href="/eco-4eso/recursos/calculadora-presupuesto/" kicker="Herramienta" title="Calculadora del presupuesto 50-30-20" descripcion="Compara tu presupuesto real con la regla de Elizabeth Warren, localiza el bloque que se desequilibra y decide qué ajustar." colorVar="--color-eco4" />
...
<Diagram caption="100 € al 10 % anual: la línea del interés simple crece recta hasta 400 €; la del compuesto se dispara hasta 1.745 € a 30 años.">
  <InteresCompuesto />
</Diagram>
...
**Pruébalo tú mismo:** antes de comprarte un coche (o cualquier compra grande a plazos), compara el coste real total frente a las alternativas.
...
<VuelveAlCaso referencia="Las tarjetas revolving y el interés compuesto en tu contra">
Porque **el interés compuesto no es intuitivo**. El cerebro humano no entiende bien crecimientos exponenciales: ve un 2 % mensual y le parece pequeño, sin calcular que un 2 % mensual compone más del **24 % anual** (TAE). Una tarjeta al 24 % TAE duplica el saldo en unos 3 años si se paga solo el mínimo.

La regla operativa para tu vida: **nunca aceptes pagar el «mínimo mensual» de una tarjeta**. Si no puedes pagar el total cada mes, no compres con la tarjeta. El interés compuesto puede ser tu mejor aliado (cuando ahorras) o tu peor enemigo (cuando debes). La diferencia entre las dos cosas es saber leer un TAE.
</VuelveAlCaso>
...
<VocesDesacuerdo
  tema="¿Arrancar con lo que tienes o pedir dinero fuera?"
  postura_a={{
    etiqueta: 'Con recursos propios',
    tesis: 'Sin deuda no hay cuota que pagar el mes que no vendes, y sin socios externos no hay que rendir cuentas a nadie. El proyecto crece más despacio, pero crece con lo que de verdad genera.',
  }}
  postura_b={{
    etiqueta: 'Con financiación externa',
    tesis: 'Esperar a tener ahorros deja pasar el momento y deja el proyecto en manos de quien ya tenía dinero. Un préstamo o una ronda permiten comprar tiempo y llegar antes a un tamaño que se sostenga.',
  }}
>
Las dos posturas comparten una regla que conviene no saltarse: **la deuda se devuelve venda quien venda**. Por eso la pregunta no es «¿me endeudo?» sino **«¿de dónde saldrá la cuota si el primer año va peor de lo previsto?»**. Si la respuesta no existe, la financiación externa está trasladando el riesgo a un futuro que no controlas. Y con las cifras delante: revisa la TAE del apartado anterior, porque el coste de esperar y el coste de pedir se comparan en euros, no en sensaciones.
</VocesDesacuerdo>
...
<MirarFora
  ...
  libro={{
    ...
    porque: 'Veinte historias cortas sobre por qué tomamos decisiones tan malas con el dinero (suscripciones, deuda, lotería, ahorro). El libro de finanzas personales más recomendado actualmente; se lee en un fin de semana.',
    paginas: 'Capítulos 1, 4, 5 y 11',
  }}
  video={{
    titulo: 'El interés compuesto explicado en 5 minutos',
    meta: 'Two Cents · PBS Digital Studios (YouTube)',
    duracion: '~5 min',
    porque: 'El concepto más importante de esta unidad explicado con gráficos animados. Si vas a recordar una sola idea del libro, que sea esta.',
    url: 'https://www.youtube.com/results?search_query=interes+compuesto+explicado+two+cents',
  }}
  cuenta={{
    titulo: '@carrera_dinero',
    meta: 'X / Twitter',
    porque: 'Divulgación de finanzas personales en castellano: trucos para el presupuesto, comparación de TAE de tarjetas, alertas sobre productos abusivos. Sin vender humo.',
  }}
  actividad_titulo="¿Cuánto cuesta «cómodo» de verdad?"
  actividad_duracion="20 min · trae calculadora"
>
  <Fragment slot="actividad">
    Imagina que compras un móvil de **300 €** a 24 cuotas mensuales con un **2 % de interés mensual** (≈ 24 % TAE). Calcula: ¿cuánto pagarás en total? ¿Cuánto pagarías al contado? La diferencia es lo que vale la «comodidad» de pagar a plazos. Trae los dos números.
  </Fragment>
  <Fragment slot="para-clase">
    Dramatización: tres alumnos representan a un **joven que quiere un móvil**, al **banco que le ofrece financiación**, y al **padre/madre que opina**. Cada papel argumenta su postura. Después, los demás votan: ¿comprar al contado, pedir préstamo a la familia, financiarlo con la tienda o esperar? Duración: 30 min. Materiales: calculadora y pizarra.
  </Fragment>
</MirarFora>
...
- tipo: concept
  ...
  title: "Una compra de 200 € que acaba costando 600 €"
  body: "Las tarjetas revolving permiten pagar «cómodamente» cada mes un porcentaje pequeño de lo gastado. Con una TAE del 24 %, esos 200 € pueden acabar costando 600 € al cabo de unos años. En 2023, miles de demandas contra WiZink, Vodafone, Cetelem o Cofidis obligaron a los bancos a devolver intereses considerados abusivos. La TAE estaba en el contrato: la mayoría no lo leyó."
  pull: "¿Por qué pedimos préstamos que nos arruinan si la información sobre el coste está disponible?"
- tipo: section
  title: El presupuesto personal
  subtitle: Ingresos, gastos fijos, gastos variables y ahorro
- tipo: terms
  title: Las cuatro piezas de un presupuesto
  terms:
    - t: Presupuesto
      d: "Hoja donde se anota qué dinero entra y qué dinero sale en un periodo, normalmente un mes. La utilidad no está en la hoja: está en que verlo por escrito cambia las decisiones."
    - t: Gasto fijo
      d: "Se repite cada mes con el mismo importe: móvil, gimnasio, suscripciones. Se decide una vez y luego sangra cada mes: 19,99 € que ya no usas son 240 € al año."
    - t: Gasto variable
      d: "Depende de lo que hagas: salir, ropa, ocio, regalos. Es el margen real de decisión mensual, y los micropagos cotidianos suman más que las compras grandes."
    - t: Ahorro
      d: "Diferencia positiva entre ingresos y gastos. No es lo que sobra al final del mes: es lo que se aparta al principio, en cuanto entra el ingreso."
- tipo: diagram
  diagrama: Presupuesto503020
  caption: "La regla 50-30-20 de Elizabeth Warren: 50 % necesidades, 30 % deseos, 20 % ahorro"
- tipo: concept
  title: Págate a ti primero
  body: "La regla más útil del ahorro personal cabe en cuatro palabras. Cuando entra un ingreso, lo primero que sale va a la cuenta de ahorro o al sobre de «no tocar», no a un gasto. Si esperas a ver qué queda al final del mes, siempre queda cero, porque el gasto se expande hasta ocupar todo el ingreso disponible. Si retiras el 10 o el 20 % al principio, te las arreglas con el resto."
  pull: El ahorro se aparta primero, no se deja para el final.
- tipo: figure
  src: eco-4eso/07/hucha-ceramica.jpg
  alt: Conjunto de huchas de cerámica de distintos colores agrupadas, símbolo tradicional del ahorro doméstico.
  title: Apartar primero
  caption: La forma cambia —cuenta remunerada, sobre, app— pero el principio de meter algo dentro antes de gastarlo no.
  credit: "Foto: Abraham, CC0 vía Wikimedia Commons"
- tipo: exercise
  title: "Ejercicio 7.1 — El presupuesto de Marta"
  enunciado: "Marta tiene 17 años y cobra 400 € al mes trabajando los sábados en una cafetería. Sus gastos mensuales son: móvil 18 €, Spotify 5 €, gimnasio 30 €, salidas 90 €, ropa y caprichos 70 € y regalos 25 €. ¿Cuánto puede ahorrar y se ajusta a la regla 50-30-20?"
  pasos:
...
- tipo: list
  title: Cómo armar tu presupuesto mensual en cinco pasos
  ordered: true
  items:
    - "Anota los ingresos reales del último mes: paga, trabajillos, becas. El real, no el idealizado."
    - "Lista los gastos fijos: móvil, transporte, suscripciones, gimnasio. Las suscripciones olvidadas son el agujero más habitual."
    - "Repasa 30 días de movimientos y categoriza los variables: comida fuera, ropa, ocio, regalos, micropagos."
    - "Calcula la diferencia: ingresos − fijos − variables = ahorro real. Si sale negativo, mira dónde recortar antes de pedir más."
    - Fija un objetivo y automatiza la transferencia el día que entra el ingreso, para no decidirlo cada mes.
- tipo: section
  title: Interés simple e interés compuesto
  subtitle: Por qué empezar a ahorrar joven es desproporcionadamente más rentable
- tipo: figure
  src: eco-4eso/07/euros-billetes-monedas.jpg
  alt: Billetes y monedas de euro extendidos sobre una superficie, con varias denominaciones de la moneda única.
  title: Solo una cara del dinero
  caption: La otra —la que de verdad multiplica el ahorro— son los intereses que ese dinero genera si se queda quieto el tiempo suficiente.
  credit: "Foto: Avij, dominio público vía Wikimedia Commons"
- tipo: split
  title: Dos formas de calcular los intereses
  left:
    h: Interés simple
    items:
      - Se calculan siempre sobre el capital inicial, sin contar los intereses ya generados.
      - "Interés = capital × tipo × tiempo"
      - "100 € al 10 % durante 5 años: 100 × 0,10 × 5 = 50 €. Al final, 150 €."
  right:
    h: Interés compuesto
    items:
      - Los intereses se suman al capital y generan intereses ellos mismos al año siguiente.
      - "Capital final = capital inicial × (1 + tipo)^años"
      - "100 € al 10 % durante 5 años: 100 × (1,10)^5 = 161 €. Solo 11 € más que el simple, a cinco años."
- tipo: table
  title: "100 € al 10 % anual: el plazo lo cambia todo"
  head:
    - Plazo
    - Interés simple
    - Interés compuesto
  rows:
    ...
    - ["20 años", "300 €", "673 €"]
    - ["30 años", "400 €", "1.745 €"]
  caption: A 30 años el compuesto multiplica por más de 17 el capital inicial; el simple, apenas por cuatro.
- tipo: diagram
  diagrama: InteresCompuesto
  caption: "La línea del interés simple crece recta hasta 400 €; la del compuesto se dispara hasta 1.745 €"
- tipo: data
  numero: "1.745 €"
  label: a 30 años con interés compuesto
  title: "Los mismos 100 € al 10 % anual"
  detalle: "Con interés simple serían 400 €. La diferencia no la pone el dinero aportado, sino el plazo: quien ahorra 50 € al mes desde los 18 termina con más que quien ahorra 200 € al mes desde los 40."
- tipo: exercise
  title: "Ejercicio 7.2 — 100 € durante 30 años al 5 %"
  enunciado: Metes 100 € en una cuenta de inversión que genera un 5 % anual y los dejas ahí treinta años sin tocarlos, reinvirtiendo siempre los intereses. ¿Cuánto dinero tendrás al final?
  pasos:
    - "Aplicamos la fórmula: capital final = 100 × (1,05)^30."
    - "(1,05)^30 ≈ 4,3219, así que el capital final ≈ 432,19 €."
    - Sin trabajar ni aportar nada más, el dinero se ha multiplicado por 4,3 gracias al tiempo.
    - "A 40 años, (1,05)^40 ≈ 7,04 → 704 €. Diez años más añaden 272 € adicionales."
    - Aportando 100 € cada año durante 30 años (3.000 € en total), el capital final rondaría los 6.644 €.
- tipo: quiz
  pregunta: "Una persona ahorra 50 € al mes desde los 18 años; otra, 200 € al mes desde los 40. ¿Quién acumula más capital con interés compuesto?"
  opciones:
    - Quien empezó a los 18, aunque haya aportado menos dinero
    - Quien empezó a los 40, porque aporta cuatro veces más cada mes
    - Los dos lo mismo, porque el tipo de interés es idéntico
    - No se puede saber sin conocer el TIN del banco
  correcta: "0"
  explicacion: "El plazo es la variable más poderosa del ahorro: con interés compuesto los intereses generan intereses año tras año, y eso pesa más que cuadruplicar la aportación mensual."
- tipo: section
  title: El coste real de un préstamo
  subtitle: TIN, TAE y por qué la ley obliga a publicar la segunda
- tipo: terms
  title: Dos porcentajes que no miden lo mismo
  terms:
    - t: TIN, Tipo de Interés Nominal
      d: Porcentaje anual que el banco aplica al capital prestado. Si pides 10.000 € a un TIN del 6 %, pagas 600 € de intereses en un año. Es el dato que se anuncia en grande.
    - t: TAE, Tasa Anual Equivalente
      d: "Coste real total del préstamo: incluye el TIN, las comisiones de apertura, estudio o cancelación, y el plazo de pago. Es la cifra que de verdad permite comparar dos ofertas."
- tipo: concept
  title: El préstamo más barato en TIN puede ser el más caro
  ...
  pull: Si una oferta solo te enseña el TIN y cuesta encontrar la TAE, ya tienes una pista.
- tipo: figure
  src: eco-4eso/07/banco-espana-fachada.jpg
  alt: Fachada del edificio sede del Banco de España en la Plaza de Cibeles de Madrid, con su esquina chaflán y su cúpula.
  title: Quien escribe las reglas
  caption: De la sede del Banco de España sale la Circular 5/2012, que obliga a las entidades a publicar la TAE junto al TIN.
  credit: "Foto: Luis García, CC BY-SA 2.5 vía Wikimedia Commons"
- tipo: concept
  eyebrow: Vuelve al caso
  title: El interés compuesto también juega en tu contra
  body: "El cerebro humano no entiende bien los crecimientos exponenciales: ve un 2 % mensual y le parece pequeño, sin calcular que compone más del 24 % anual. Una tarjeta al 24 % de TAE duplica el saldo en unos tres años si solo se paga el mínimo. La regla operativa es simple: si no puedes pagar el total cada mes, no compres con la tarjeta."
  pull: El interés compuesto es tu mejor aliado cuando ahorras y tu peor enemigo cuando debes.
- tipo: quiz
  pregunta: "Dos préstamos anuncian el mismo TIN del 5 %. Uno cobra un 1 % de comisión de apertura y el otro, un 3 %. ¿Cómo decides cuál es más barato?"
  opciones:
    - Comparando la TAE, que ya incluye intereses, comisiones y plazo
    - Comparando el TIN, que es el interés que de verdad se paga
    - Cuestan lo mismo, porque el TIN es idéntico en los dos
    - Mirando solo el plazo de devolución que ofrece cada banco
  correcta: "0"
  explicacion: El TIN ignora las comisiones, así que dos préstamos con el mismo TIN pueden costar muy distinto. La TAE resume todo el coste en una sola cifra comparable.
- tipo: section
  title: Las seis fuentes de financiación
  subtitle: De dónde sale el dinero que un proyecto todavía no tiene
- tipo: list
  title: Seis vías para financiar un proyecto
  ordered: true
  items:
    - "Ahorro propio: la más barata y la que conserva todo el control, pero limitada. Deja siempre un colchón de 3 a 6 meses de gastos."
    - "Family and friends: dinero rápido, flexible y barato, pero pone en juego una relación personal. Formalízalo por escrito."
    - "Crédito bancario y microcréditos ICO: de 3.000 a 30.000 €, con avales o un plan de empresa sólido."
    - "Crowdfunding: muchas aportaciones pequeñas por plataforma. Además de dinero, valida el mercado."
    - "Ayudas públicas: Tarifa Plana, ENISA, Kit Digital. Mejores condiciones que la banca, procesos largos."
    - "Business angels: capital, contactos y mentoría a cambio de un porcentaje de la empresa."
- tipo: split
  title: "Crowdfunding: cuatro variantes"
  left:
    h: Sin devolución de dinero
    items:
  ...
  right:
    h: Con contrapartida financiera
    items:
...
- tipo: split
  title: Dinero público y dinero con experiencia
  left:
    h: Ayudas públicas
    items:
...
- tipo: table
  title: Ahorro propio, banco o crowdfunding
  head:
    - Fuente
    - Ventajas
    - Inconvenientes
  ...
  caption: "La elección no es solo de coste: cada fuente cambia el tipo de proyecto que sale del proceso."
- tipo: caso
  eyebrow: "Caso real"
  title: "Verkami: 12.000 proyectos y una revista que pidió 18.000 €"
  contexto: "Verkami se fundó en Barcelona en 2010 como plataforma de micromecenazgo cultural. En 2014 la revista satírica Orgullo y Satisfacción pidió allí 18.000 € para arrancar."
  datos:
    - "Más de 12.000 proyectos financiados, por unos 42 millones de euros."
    - "La revista recaudó más de 96.000 € en pocas semanas."
    - "Más de 3.500 personas aportaron dinero antes de ver el número 1."
  pregunta: "Además del dinero, ¿qué información te da una campaña de crowdfunding antes de producir?"
- tipo: recap
  eyebrow: "Repasa"
