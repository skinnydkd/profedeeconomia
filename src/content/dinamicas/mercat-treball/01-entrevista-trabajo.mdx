...
unidades_relacionadas:
  ...
  - { asignatura: "edmn-2bach", unidad: 8, nota: "La gestión de los recursos humanos: reclutamiento y selección." }
  - { asignatura: "gpe-bach", unidad: 5, nota: "Las áreas de la empresa: recursos humanos." }
